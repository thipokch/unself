...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-constructor">SettingsAppearanceEvent.setThemeMode</span> constructor 
    <a href="https://dart.dev/null-safety" class="feature feature-null-safety" title="Supports the null safety language feature.">Null safety</a>
</h1></div>

    <section class="multi-line-signature">
      const
      <span class="name ">SettingsAppearanceEvent.setThemeMode</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="setThemeMode-param-themeMode">{<span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/material/ThemeMode.html">ThemeMode</a></span> <span class="parameter-name">themeMode</span>}</span></li>
</ol>)
    </section>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">const factory SettingsAppearanceEvent.setThemeMode({
  required ThemeMode themeMode,
}) = _SetThemeMode;</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">SettingsAppearanceEvent.setThemeMode const constructor</li>
</ol>
