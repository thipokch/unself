...
<span class="name ">mapOrNull</span>&lt;<wbr><span class="type-parameter">TResult extends Object?</span>&gt;(<wbr><ol class="parameter-list"><li><span class="parameter" id="mapOrNull-param-setThemeMode">{<span class="type-annotation">TResult?</span> <span class="parameter-name">setThemeMode</span>(<ol class="parameter-list"><li><span class="parameter" id="param-value"><span class="type-annotation">_SetThemeMode</span> <span class="parameter-name">value</span></span></li>
</ol>
)?}</span></li>
</ol>)
