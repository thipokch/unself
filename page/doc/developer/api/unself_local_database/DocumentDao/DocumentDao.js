  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="DocumentDao" class="callable">
          <span class="name"><a href="../unself_local_database/DocumentDao/DocumentDao.constructor">DocumentDao</a></span><span class="signature">(<span class="parameter" id="-param-db"><span class="type-annotation"><a href="../unself_local_database/LocalDatabase">LocalDatabase</a></span> <span class="parameter-name">db</span></span>)</span>
        </dt>
        <dd>
