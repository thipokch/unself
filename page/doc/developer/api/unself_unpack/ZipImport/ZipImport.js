...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ZipImport</span> class 
...
<section class="desc markdown">
  <p><a href="../unself_unpack/ZipImport">ZipImport</a> unpacks archive files and collect metadata.</p>
</section>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ZipImport" class="callable">
          <span class="name"><a href="../unself_unpack/ZipImport/ZipImport.constructor">ZipImport</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_unpack/ZipImport/open">open</a></span><span class="signature">(<wbr><span class="parameter" id="open-param-object"><span class="type-annotation"><a href="https://pub.dev/documentation/cross_file/0.3.3+4/cross_file/XFile-class.html">XFile</a></span> <span class="parameter-name">object</span></span>)
...
<dd>
  <a href="../unself_unpack/ZipImport/open">open</a> opens the given <a href="https://pub.dev/documentation/cross_file/0.3.3+4/cross_file/XFile-class.html">XFile</a> and returns a list of supported
and importable identifier <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a> for the given <code>object</code>.
...
<dd>
  <a href="../unself_unpack/ZipImport/unpack">unpack</a> unpacks the opened <a href="https://pub.dev/documentation/cross_file/0.3.3+4/cross_file/XFile-class.html">XFile</a> object the given <code>mappings</code> and
returns a <a href="https://api.flutter.dev/flutter/dart-async/FutureOr-class.html">FutureOr</a> of <code>Map&lt;String, Object?&gt;</code>.
  <div class="features"><span class="feature">override</span></div>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ZipImport class</li>
</ol>
