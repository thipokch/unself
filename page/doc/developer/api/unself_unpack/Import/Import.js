...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">Import&lt;<wbr><span class="type-parameter">T</span>, <span class="type-parameter">O</span>&gt;</span> class 
...
<section class="desc markdown">
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="Import" class="callable">
          <span class="name"><a href="../unself_unpack/Import/Import.constructor">Import</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_unpack/Import/open">open</a></span><span class="signature">(<wbr><span class="parameter" id="open-param-object"><span class="type-annotation">T</span> <span class="parameter-name">object</span></span>)
...
<dd>
  <a href="../unself_unpack/Import/open">open</a> returns the supported list of identifier <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a> for the
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_unpack/Import/unpack">unpack</a></span><span class="signature">(<wbr><span class="parameter" id="unpack-param-options"><span class="type-annotation">O?</span> <span class="parameter-name">options</span></span>)
...
<dd>
  <a href="../unself_unpack/Import/unpack">unpack</a> unpacks opened object the given <code>options</code> and
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">Import<span class="signature">&lt;<wbr><span class="type-parameter">T</span>, <span class="type-parameter">O</span>&gt;</span> abstract class</li>
</ol>
