...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">normalizeWith</span> method 
...
<span class="name ">normalizeWith</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="normalizeWith-param-schema"><span class="type-annotation">JsonSchema</span> <span class="parameter-name">schema</span>, </span></li>
<li><span class="parameter" id="normalizeWith-param-json"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">json</span></span></li>
</ol>)
...
<section class="desc markdown">
  <p>Normalizes the given JSON object using the specified schema object.</p>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Map&lt;String, List&gt; normalizeWith(
  JsonSchema schema,
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">normalizeWith method</li>
</ol>
