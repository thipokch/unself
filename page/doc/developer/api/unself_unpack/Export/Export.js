...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">Export&lt;<wbr><span class="type-parameter">T</span>, <span class="type-parameter">O</span>&gt;</span> class 
...
<section class="desc markdown">
  <p>An interface for <a href="../unself_unpack/Export">Export</a></p>
</section>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="Export" class="callable">
          <span class="name"><a href="../unself_unpack/Export/Export.constructor">Export</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_unpack/Export/open">open</a></span><span class="signature">(<wbr><span class="parameter" id="open-param-object"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/Object-class.html">Object</a>?</span>&gt;</span></span> <span class="parameter-name">object</span></span>)
...
<dd>
  <a href="../unself_unpack/Export/open">open</a> returns the supported list of identifier <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a> for the
given <code>object</code>.
  ...
  <span class="name"><a href="../unself_unpack/Export/pack">pack</a></span><span class="signature">(<wbr><span class="parameter" id="pack-param-options"><span class="type-annotation">O?</span> <span class="parameter-name">options</span></span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/FutureOr-class.html">FutureOr</a><span class="signature">&lt;<wbr><span class="type-parameter">T</span>&gt;</span></span>
  </span>
  

</dt>
<dd>
  <a href="../unself_unpack/Export/pack">pack</a> packs opened object the given <code>options</code> and
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">Export<span class="signature">&lt;<wbr><span class="type-parameter">T</span>, <span class="type-parameter">O</span>&gt;</span> abstract class</li>
</ol>
