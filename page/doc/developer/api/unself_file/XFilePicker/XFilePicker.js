...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">XFilePicker</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="XFilePicker" class="callable">
          <span class="name"><a href="../unself_file/XFilePicker/XFilePicker.constructor">XFilePicker</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_file/XFilePicker/instance">instance</a></span>
  <span class="signature">→ <a href="https://pub.dev/documentation/file_picker/5.2.5/file_picker/FilePicker-class.html">FilePicker</a></span> 
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">XFilePicker class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_file/XFilePicker#constructors">Constructors</a></li>
          <li><a href="../unself_file/XFilePicker/XFilePicker.constructor">XFilePicker</a></li>


        <li class="section-title inherited">
          <a href="../unself_file/XFilePicker#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title inherited"><a href="../unself_file/XFilePicker#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../unself_file/XFilePicker#operators">Operators</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/operator_equals.html">operator ==</a></li>


        <li class="section-title"><a href="../unself_file/XFilePicker#static-properties">Static properties</a></li>
          <li><a href="../unself_file/XFilePicker/instance">instance</a></li>
