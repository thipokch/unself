...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
        ...
        <h1>
          <span class="kind-enum">CollectionType</span>
          enum 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="CollectionType" class="callable">
          <span class="name"><a href="../unself_model/CollectionType/CollectionType.constructor">CollectionType</a></span><span class="signature">()</span>
        </dt>
        <dd>
    ...
    <section class="summary offset-anchor" id="values">
      ...
      <dl class="properties">
          <dt id="node" class="constant">
    <span class="name ">node</span>
  <span class="signature">→ const <a href="../unself_model/CollectionType">CollectionType</a></span>
...
<dd class="inherited">
  ...
  <section class="summary offset-anchor" id="constants">
    ...
    <span class="name "><a href="../unself_model/CollectionType/values-constant">values</a></span>
  <span class="signature">→ const <a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unself_model/CollectionType">CollectionType</a></span>&gt;</span></span>
...
<dd>
  A constant List of the values in this enum, in order of their declaration.
    ...
    <div>
      <span class="signature"><code>[node, edge]</code></span>
    </div>
</dd>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">CollectionType enum</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_model/CollectionType#constructors">Constructors</a></li>
          <li><a href="../unself_model/CollectionType/CollectionType.constructor">CollectionType</a></li>

        <li class="section-title"><a href="../unself_model/CollectionType#values">Values</a></li>
          <li><a href="../unself_model/CollectionType#node">node</a></li>
          <li><a href="../unself_model/CollectionType#edge">edge</a></li>

        <li class="section-title inherited">
          <a href="../unself_model/CollectionType#instance-properties">Properties</a>
        </li>
        ...
        <li class="section-title inherited"><a href="../unself_model/CollectionType#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../unself_model/CollectionType#operators">Operators</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/operator_equals.html">operator ==</a></li>




        <li class="section-title"><a href="../unself_model/CollectionType#constants">Constants</a></li>
          <li><a href="../unself_model/CollectionType/values-constant">values</a></li>
</ol>
