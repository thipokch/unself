...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ArchiveFormat</span> class 
...
<section class="desc markdown">
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        ...
        <dt id="ArchiveFormat.fromJson" class="callable">
          <span class="name"><a href="../unself_model/ArchiveFormat/ArchiveFormat.fromJson">ArchiveFormat.fromJson</a></span><span class="signature">(<span class="parameter" id="fromJson-param-data"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">data</span></span>)</span>
        </dt>
        <dd>
          Creates a <a href="../unself_model/ArchiveFormat">ArchiveFormat</a> from Json map
            <div class="constructor-modifier features">factory</div>
        </dd>
    </dl>
  </section>
  ...
  <span class="name"><a href="../unself_model/ArchiveFormat/app">app</a></span>
  <span class="signature">→ <a href="../unself_model/App">App</a></span> 

</dt>
<dd class="inherited">
  <a href="../unself_model/ArchiveFormat/app">app</a> is the <a href="../unself_model/App">App</a> the <a href="../unself_model/ArchiveFormat">ArchiveFormat</a> is for.
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>

</dd>

        <dt id="constraint" class="property inherited">
  <span class="name"><a href="../unself_model/ArchiveFormat/constraint">constraint</a></span>
...
<dd class="inherited">
  <a href="../unself_model/ArchiveFormat/constraint">constraint</a> is the constraint version of the <a href="../unself_model/App">App</a>.
See <a href="https://pub.dev/documentation/pub_semver/2.1.3/pub_semver/VersionConstraint-class.html">VersionConstraint</a> from pub_semver for more information.
  ...
  <span class="name"><a href="../unself_model/ArchiveFormat/copyWith">copyWith</a></span>
  <span class="signature">→ \$ArchiveFormatCopyWith<span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unself_model/ArchiveFormat">ArchiveFormat</a></span>&gt;</span></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_model/ArchiveFormat/created">created</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/DateTime-class.html">DateTime</a></span> 

</dt>
<dd class="inherited">
  <a href="../unself_model/ArchiveFormat/created">created</a> is the date and time when the <a href="../unself_model/ArchiveFormat">ArchiveFormat</a> was created inside unself app.
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>

</dd>

        <dt id="extra" class="property inherited">
  <span class="name"><a href="../unself_model/ArchiveFormat/extra">extra</a></span>
...
<dd class="inherited">
  <a href="../unself_model/ArchiveFormat/extra">extra</a> is a map of additional properties.
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>

</dd>

        <dt id="format" class="property inherited">
  <span class="name"><a href="../unself_model/ArchiveFormat/format">format</a></span>
  <span class="signature">→ <a href="../unself_model/ArchiveFileFormat">ArchiveFileFormat</a></span> 

</dt>
<dd class="inherited">
  <a href="../unself_model/ArchiveFormat/format">format</a> is the format of the <a href="../unself_model/ArchiveFormat">ArchiveFormat</a>.
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_model/ArchiveFormat/id">id</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 

</dt>
<dd class="inherited">
  <a href="../unself_model/ArchiveFormat/id">id</a> is unself unique identifier for the ArchiveFormat.
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>

</dd>

        <dt id="mappings" class="property inherited">
  <span class="name"><a href="../unself_model/ArchiveFormat/mappings">mappings</a></span>
...
<dd class="inherited">
  <code>entries</code> is a list of <code>ArchiveFormatEntry</code>s.
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_model/ArchiveFormat/updated">updated</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/DateTime-class.html">DateTime</a></span> 

</dt>
<dd class="inherited">
  <a href="../unself_model/ArchiveFormat/updated">updated</a> is the date and time when the <a href="../unself_model/ArchiveFormat">ArchiveFormat</a> was last updated inside unself app.
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>

</dd>

        <dt id="version" class="property inherited">
  <span class="name"><a href="../unself_model/ArchiveFormat/version">version</a></span>
  <span class="signature">→ <a href="https://pub.dev/documentation/pub_semver/2.1.3/pub_semver/Version-class.html">Version</a></span> 

</dt>
<dd class="inherited">
  <a href="../unself_model/ArchiveFormat/version">version</a> is the revision version of the <a href="../unself_model/ArchiveFormat">ArchiveFormat</a>.
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_model/ArchiveFormat/toJson">toJson</a></span><span class="signature">(<wbr>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ArchiveFormat class</li>
</ol>
