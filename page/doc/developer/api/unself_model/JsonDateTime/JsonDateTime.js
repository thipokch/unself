  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="JsonDateTime" class="callable">
          <span class="name"><a href="../unself_model/JsonDateTime/JsonDateTime.constructor">JsonDateTime</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_model/JsonDateTime/fromJson">fromJson</a></span><span class="signature">(<wbr><span class="parameter" id="fromJson-param-_"><span class="type-annotation">dynamic</span> <span class="parameter-name">_</span></span>)
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_model/JsonDateTime/toJson">toJson</a></span><span class="signature">(<wbr><span class="parameter" id="toJson-param-_"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/DateTime-class.html">DateTime</a></span> <span class="parameter-name">_</span></span>)
    <span class="returntype parameter">→ dynamic</span>
  </span>
