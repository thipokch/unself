...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">IJsonSchemaRef</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="IJsonSchemaRef" class="callable">
          <span class="name"><a href="../unself_model/IJsonSchemaRef/IJsonSchemaRef.constructor">IJsonSchemaRef</a></span><span class="signature">()</span>
        </dt>
        <dd>
          
            <div class="constructor-modifier features">const</div>
        </dd>
        <dt id="IJsonSchemaRef.fromJson" class="callable">
          <span class="name"><a href="../unself_model/IJsonSchemaRef/IJsonSchemaRef.fromJson">IJsonSchemaRef.fromJson</a></span><span class="signature">(<span class="parameter" id="fromJson-param-json"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">json</span></span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_model/IJsonSchema/toJson">toJson</a></span><span class="signature">(<wbr>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">IJsonSchemaRef abstract class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_model/IJsonSchemaRef#constructors">Constructors</a></li>
          <li><a href="../unself_model/IJsonSchemaRef/IJsonSchemaRef.constructor">IJsonSchemaRef</a></li>
          <li><a href="../unself_model/IJsonSchemaRef/IJsonSchemaRef.fromJson">fromJson</a></li>


        <li class="section-title inherited">
          <a href="../unself_model/IJsonSchemaRef#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title inherited"><a href="../unself_model/IJsonSchemaRef#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li class="inherited"><a href="../unself_model/IJsonSchema/toJson">toJson</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../unself_model/IJsonSchemaRef#operators">Operators</a></li>
