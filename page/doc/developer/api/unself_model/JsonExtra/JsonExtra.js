...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">JsonExtra</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="JsonExtra" class="callable">
          <span class="name"><a href="../unself_model/JsonExtra/JsonExtra.constructor">JsonExtra</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_model/JsonExtra/fromJson">fromJson</a></span><span class="signature">(<wbr><span class="parameter" id="fromJson-param-_"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a>?</span> <span class="parameter-name">_</span></span>)
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_model/JsonExtra/toJson">toJson</a></span><span class="signature">(<wbr><span class="parameter" id="toJson-param-_"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">_</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">JsonExtra class</li>
</ol>
