...
<section class="desc markdown">
  <p><a href="../../unself_model/Base/created">created</a> is the date and time when the inheriting model was created inside unself app.</p>
</section>

        
<section class="summary source-code" id="source">
  <h2><span>Implementation</span></h2>
  <pre class="language-dart"><code class="language-dart">final DateTime created;</code></pre>
</section>
