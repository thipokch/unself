...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">Node</span> class 
...
<section class="desc markdown">
  ...
  <span class="name"><a href="../unself_model/Node/archiveId">archiveId</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 

</dt>
<dd>
  <a href="../unself_model/Node/archiveId">archiveId</a> is unself unique identifier for the archive the model belongs to.
  <div class="features"><span class="feature">final</span></div>

</dd>

        <dt id="created" class="property">
  <span class="name"><a href="../unself_model/Node/created">created</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/DateTime-class.html">DateTime</a></span> 

</dt>
<dd>
  <a href="../unself_model/Node/created">created</a> is the date and time when the inheriting model was created inside unself app.
  <div class="features"><span class="feature">final</span></div>

</dd>

        <dt id="extra" class="property">
  <span class="name"><a href="../unself_model/Node/extra">extra</a></span>
...
<dd>
  <a href="../unself_model/Node/extra">extra</a> is a map of additional properties.
  <div class="features"><span class="feature">final</span></div>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_model/Node/id">id</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 

</dt>
<dd>
  <a href="../unself_model/Node/id">id</a> is unself unique identifier for each inheriting model.
  <div class="features"><span class="feature">final</span></div>

</dd>

        <dt id="labels" class="property">
  <span class="name"><a href="../unself_model/Node/labels">labels</a></span>
...
<dd>
  <a href="../unself_model/Node/labels">labels</a> is a list of labels assigned to the model.
  <div class="features"><span class="feature">final</span></div>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_model/Node/updated">updated</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/DateTime-class.html">DateTime</a></span> 

</dt>
<dd>
  <a href="../unself_model/Node/updated">updated</a> is the date and time when the inheriting model was last updated inside unself app.
  <div class="features"><span class="feature">final</span></div>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">Node abstract class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title">
          <a href="../unself_model/Node#instance-properties">Properties</a>
        </li>
          <li><a href="../unself_model/Node/archiveId">archiveId</a></li>
          <li><a href="../unself_model/Node/created">created</a></li>
          <li><a href="../unself_model/Node/extra">extra</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li><a href="../unself_model/Node/id">id</a></li>
          <li><a href="../unself_model/Node/labels">labels</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li><a href="../unself_model/Node/updated">updated</a></li>

        <li class="section-title inherited"><a href="../unself_model/Node#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../unself_model/Node#operators">Operators</a></li>
