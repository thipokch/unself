...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-constructor">JsonRefValue.valueFrom</span> constructor 
  ...
  <div>
    <ol class="annotation-list">
        <li>@<a href="https://pub.dev/documentation/freezed_annotation/2.2.0/freezed_annotation/FreezedUnionValue-class.html">FreezedUnionValue</a>('JsonRefValue.valueFrom')</li>
    </ol>
  </div>const
      <span class="name ">JsonRefValue.valueFrom</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="valueFrom-param-name"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">name</span></span></li>
</ol>)
    </section>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">@FreezedUnionValue('JsonRefValue.valueFrom')
const factory JsonRefValue.valueFrom(String name) = ValueFrom;</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">JsonRefValue.valueFrom const constructor</li>
</ol>
