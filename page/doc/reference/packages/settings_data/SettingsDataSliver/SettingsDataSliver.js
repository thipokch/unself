...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">SettingsDataSliver</span> class 
...
<p>Add what it does</p>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="SettingsDataSliver" class="callable">
          <span class="name"><a href="../settings_data/SettingsDataSliver/SettingsDataSliver.constructor">SettingsDataSliver</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-onReset"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-ui/VoidCallback.html">VoidCallback</a>?</span> <span class="parameter-name">onReset</span>}</span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../settings_data/SettingsDataSliver/onReset">onReset</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../settings_data/SettingsDataSliver/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<dd class="inherited">
  ...
  <span class="name"><a href="../settings_data/SettingsDataSliver/children">children</a></span><span class="signature">(<wbr>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">SettingsDataSliver class</li>
</ol>
    ...
    <ol>
      <li class="section-title"><a href="../settings_data/settings_data#classes">Classes</a></li>
        <li><a href="../settings_data/SettingsDataPage/SettingsDataPage">SettingsDataPage</a></li>
        <li><a href="../settings_data/SettingsDataSliver/SettingsDataSliver">SettingsDataSliver</a></li>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../settings_data/SettingsDataSliver/SettingsDataSliver#constructors">Constructors</a></li>
          <li><a href="../settings_data/SettingsDataSliver/SettingsDataSliver.constructor">SettingsDataSliver</a></li>


        <li class="section-title">
          <a href="../settings_data/SettingsDataSliver/SettingsDataSliver#instance-properties">Properties</a>
        </li>
        ...
        <li class="section-title"><a href="../settings_data/SettingsDataSliver/SettingsDataSliver#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../settings_data/SettingsDataSliver/SettingsDataSliver#operators">Operators</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/operator_equals.html">operator ==</a></li>



        <li class="section-title"><a href="../settings_data/SettingsDataSliver/SettingsDataSliver#static-methods">Static methods</a></li>
