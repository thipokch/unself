...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">SettingsAppearanceView</span> class 
...
<section class="desc markdown">
  <p>View of the SettingsAppearancePage.</p>
<p>Add what it does</p>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="SettingsAppearanceView" class="callable">
          <span class="name"><a href="../settings_appearance/SettingsAppearanceView/SettingsAppearanceView.constructor">SettingsAppearanceView</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>}</span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <section class="summary offset-anchor" id="static-methods">
    ...
    <dl class="callables">
        <dt id="children" class="callable">
  <span class="name"><a href="../settings_appearance/SettingsAppearanceView/children">children</a></span><span class="signature">(<wbr><span class="parameter" id="children-param-bloc">{<span>required</span> <span class="type-annotation"><a href="../settings_appearance/SettingsAppearanceBloc/SettingsAppearanceBloc">SettingsAppearanceBloc</a></span> <span class="parameter-name">bloc</span>, </span><span class="parameter" id="children-param-state"><span>required</span> <span class="type-annotation"><a href="../settings_appearance/SettingsAppearanceState/SettingsAppearanceState">SettingsAppearanceState</a></span> <span class="parameter-name">state</span>}</span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span>&gt;</span></span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">SettingsAppearanceView class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../settings_appearance/SettingsAppearanceView/SettingsAppearanceView#constructors">Constructors</a></li>
        ...
        <li class="section-title inherited">
          <a href="../settings_appearance/SettingsAppearanceView/SettingsAppearanceView#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../settings_appearance/SettingsAppearanceView/SettingsAppearanceView#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../settings_appearance/SettingsAppearanceView/SettingsAppearanceView#operators">Operators</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/operator_equals.html">operator ==</a></li>



        <li class="section-title"><a href="../settings_appearance/SettingsAppearanceView/SettingsAppearanceView#static-methods">Static methods</a></li>
