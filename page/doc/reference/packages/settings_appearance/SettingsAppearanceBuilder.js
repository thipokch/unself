...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-typedef">SettingsAppearanceBuilder</span> typedef 
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">typedef SettingsAppearanceBuilder
    = BlocBuilder&lt;SettingsAppearanceBloc, SettingsAppearanceState&gt;;</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">SettingsAppearanceBuilder typedef</li>
</ol>
