...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">HeadingSection</span> class 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_component/HeadingSection/label">label</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_component/HeadingSection/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">HeadingSection class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_component/HeadingSection/HeadingSection#constructors">Constructors</a></li>
          <li><a href="../unself_component/HeadingSection/HeadingSection.constructor">HeadingSection</a></li>


        <li class="section-title">
          <a href="../unself_component/HeadingSection/HeadingSection#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li><a href="../unself_component/HeadingSection/label">label</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../unself_component/HeadingSection/HeadingSection#instance-methods">Methods</a></li>
          <li><a href="../unself_component/HeadingSection/build">build</a></li>
        ...
        <li class="section-title inherited"><a href="../unself_component/HeadingSection/HeadingSection#operators">Operators</a></li>
