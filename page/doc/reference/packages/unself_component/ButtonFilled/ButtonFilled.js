...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ButtonFilled</span> class 
  ...
  <dd>
    <ul class="gt-separated dark clazz-relationships">
      <li><a href="https://api.flutter.dev/flutter/dart-core/Object-class.html">Object</a></li>
        ...
        <li><a href="https://api.flutter.dev/flutter/material/ElevatedButton-class.html">ElevatedButton</a></li>
      <li>ButtonFilled</li>
    </ul>
  </dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_component/ButtonFilled/defaultStyleOf">defaultStyleOf</a></span><span class="signature">(<wbr><span class="parameter" id="defaultStyleOf-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<dd class="inherited">
  ...
  <span class="name"><a href="https://api.flutter.dev/flutter/material/ElevatedButton/themeStyleOf.html">themeStyleOf</a></span><span class="signature">(<wbr><span class="parameter" id="themeStyleOf-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/material/ButtonStyle-class.html">ButtonStyle</a>?</span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ButtonFilled class</li>
</ol>
