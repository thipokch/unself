...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ButtonElevation</span> class 
  ...
  <dd>
    <ul class="gt-separated dark clazz-relationships">
      <li><a href="https://api.flutter.dev/flutter/dart-core/Object-class.html">Object</a></li>
        <li><a href="https://api.flutter.dev/flutter/material/MaterialStateProperty-class.html">MaterialStateProperty</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/double-class.html">double</a></span>&gt;</span></li>
      <li>ButtonElevation</li>
    </ul>
  </dd>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ButtonElevation" class="callable">
          <span class="name"><a href="../unself_component/ButtonElevation/ButtonElevation.constructor">ButtonElevation</a></span><span class="signature">(<span class="parameter" id="-param-elevation"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/double-class.html">double</a></span> <span class="parameter-name">elevation</span></span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../unself_component/ButtonElevation/elevation">elevation</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_component/ButtonElevation/resolve">resolve</a></span><span class="signature">(<wbr><span class="parameter" id="resolve-param-states"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Set-class.html">Set</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/material/MaterialState.html">MaterialState</a></span>&gt;</span></span> <span class="parameter-name">states</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ButtonElevation class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_component/ButtonElevation/ButtonElevation#constructors">Constructors</a></li>
          <li><a href="../unself_component/ButtonElevation/ButtonElevation.constructor">ButtonElevation</a></li>


        <li class="section-title">
          <a href="../unself_component/ButtonElevation/ButtonElevation#instance-properties">Properties</a>
        </li>
          <li><a href="../unself_component/ButtonElevation/elevation">elevation</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../unself_component/ButtonElevation/ButtonElevation#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../unself_component/ButtonElevation/ButtonElevation#operators">Operators</a></li>
