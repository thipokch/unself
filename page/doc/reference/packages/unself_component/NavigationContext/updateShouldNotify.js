...
<span class="name ">updateShouldNotify</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="updateShouldNotify-param-oldWidget"><span>covariant</span> <span class="type-annotation"><a href="../../unself_component/NavigationContext/NavigationContext">NavigationContext</a></span> <span class="parameter-name">oldWidget</span></span></li>
</ol>)
