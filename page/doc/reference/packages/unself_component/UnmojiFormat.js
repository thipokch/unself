...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
        ...
        <h1>
          <span class="kind-enum">UnmojiFormat</span>
          enum 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="UnmojiFormat" class="callable">
          <span class="name"><a href="../unself_component/UnmojiFormat/UnmojiFormat.constructor">UnmojiFormat</a></span><span class="signature">()</span>
        </dt>
        <dd>
    ...
    <section class="summary offset-anchor" id="values">
      ...
      <dl class="properties">
          <dt id="svg" class="constant">
    <span class="name ">svg</span>
  <span class="signature">→ const <a href="../unself_component/UnmojiFormat">UnmojiFormat</a></span>
...
<dd>
  <p>PNG form assets</p>
          ...
          <dt id="networkSvg" class="constant">
    <span class="name ">networkSvg</span>
  <span class="signature">→ const <a href="../unself_component/UnmojiFormat">UnmojiFormat</a></span>
  

</dt>
<dd>
  <p>SVG form Network</p>
...
<dd class="inherited">
  ...
  <section class="summary offset-anchor" id="constants">
    ...
    <span class="name "><a href="../unself_component/UnmojiFormat/values-constant">values</a></span>
  <span class="signature">→ const <a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unself_component/UnmojiFormat">UnmojiFormat</a></span>&gt;</span></span>
...
<dd>
  A constant List of the values in this enum, in order of their declaration.
    ...
    <div>
      <span class="signature"><code>[svg, webp, networkSvg]</code></span>
    </div>
</dd>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">UnmojiFormat enum</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_component/UnmojiFormat#constructors">Constructors</a></li>
          <li><a href="../unself_component/UnmojiFormat/UnmojiFormat.constructor">UnmojiFormat</a></li>

        <li class="section-title"><a href="../unself_component/UnmojiFormat#values">Values</a></li>
          <li><a href="../unself_component/UnmojiFormat#svg">svg</a></li>
          <li><a href="../unself_component/UnmojiFormat#webp">webp</a></li>
          <li><a href="../unself_component/UnmojiFormat#networkSvg">networkSvg</a></li>

        <li class="section-title inherited">
          <a href="../unself_component/UnmojiFormat#instance-properties">Properties</a>
        </li>
        ...
        <li class="section-title inherited"><a href="../unself_component/UnmojiFormat#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../unself_component/UnmojiFormat#operators">Operators</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/operator_equals.html">operator ==</a></li>




        <li class="section-title"><a href="../unself_component/UnmojiFormat#constants">Constants</a></li>
          <li><a href="../unself_component/UnmojiFormat/values-constant">values</a></li>
</ol>
