...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ListItemBuilder</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ListItemBuilder" class="callable">
          <span class="name"><a href="../unself_component/ListItemBuilder/ListItemBuilder.constructor">ListItemBuilder</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <section class="summary offset-anchor" id="static-methods">
    ...
    <dl class="callables">
        <dt id="section" class="callable">
  <span class="name"><a href="../unself_component/ListItemBuilder/section">section</a></span><span class="signature">(<wbr><span class="parameter" id="section-param-text"><span class="type-annotation">dynamic</span> <span class="parameter-name">text</span></span>)
...
<dd>
        ...
        <dt id="tile" class="callable">
  <span class="name"><a href="../unself_component/ListItemBuilder/tile">tile</a></span><span class="signature">(<wbr><span class="parameter" id="tile-param-entry"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/MapEntry-class.html">MapEntry</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">(<a href="https://api.flutter.dev/flutter/dart-async/FutureOr-class.html">FutureOr</a><span class="signature">&lt;<wbr><span class="type-parameter">void</span>&gt;</span> Function<span class="signature">()</span>?)</span>&gt;</span></span> <span class="parameter-name">entry</span></span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ListItemBuilder abstract class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_component/ListItemBuilder/ListItemBuilder#constructors">Constructors</a></li>
          <li><a href="../unself_component/ListItemBuilder/ListItemBuilder.constructor">ListItemBuilder</a></li>


        <li class="section-title inherited">
          <a href="../unself_component/ListItemBuilder/ListItemBuilder#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title inherited"><a href="../unself_component/ListItemBuilder/ListItemBuilder#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../unself_component/ListItemBuilder/ListItemBuilder#operators">Operators</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/operator_equals.html">operator ==</a></li>



        <li class="section-title"><a href="../unself_component/ListItemBuilder/ListItemBuilder#static-methods">Static methods</a></li>
