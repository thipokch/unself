...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">CardTextEdit</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="CardTextEdit" class="callable">
          <span class="name"><a href="../unself_component/CardTextEdit/CardTextEdit.constructor">CardTextEdit</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-initialText"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a>?</span> <span class="parameter-name">initialText</span>, </span><span class="parameter" id="-param-onChanged"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/ValueChanged.html">ValueChanged</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>&gt;</span>?</span> <span class="parameter-name">onChanged</span>, </span><span class="parameter" id="-param-onTap"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-ui/VoidCallback.html">VoidCallback</a>?</span> <span class="parameter-name">onTap</span>, </span><span class="parameter" id="-param-autoFocus"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/bool-class.html">bool</a>?</span> <span class="parameter-name">autoFocus</span>}</span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../unself_component/CardTextEdit/autoFocus">autoFocus</a></span>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
        ...
        <dt id="initialText" class="property">
  <span class="name"><a href="../unself_component/CardTextEdit/initialText">initialText</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_component/CardTextEdit/onChanged">onChanged</a></span>
...
<dd>
  ...
  <span class="name"><a href="../unself_component/CardTextEdit/onTap">onTap</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_component/CardTextEdit/createState">createState</a></span><span class="signature">(<wbr>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/widgets/State-class.html">State</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unself_component/CardTextEdit/CardTextEdit">CardTextEdit</a></span>&gt;</span></span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">CardTextEdit class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_component/CardTextEdit/CardTextEdit#constructors">Constructors</a></li>
          <li><a href="../unself_component/CardTextEdit/CardTextEdit.constructor">CardTextEdit</a></li>


        <li class="section-title">
          <a href="../unself_component/CardTextEdit/CardTextEdit#instance-properties">Properties</a>
        </li>
        ...
        <li class="section-title"><a href="../unself_component/CardTextEdit/CardTextEdit#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../unself_component/CardTextEdit/CardTextEdit#operators">Operators</a></li>
