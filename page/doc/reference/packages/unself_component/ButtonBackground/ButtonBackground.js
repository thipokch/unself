  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ButtonBackground" class="callable">
          <span class="name"><a href="../unself_component/ButtonBackground/ButtonBackground.constructor">ButtonBackground</a></span><span class="signature">(<span class="parameter" id="-param-primary"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-ui/Color-class.html">Color</a>?</span> <span class="parameter-name">primary</span>, </span><span class="parameter" id="-param-onSurface"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-ui/Color-class.html">Color</a>?</span> <span class="parameter-name">onSurface</span></span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_component/ButtonBackground/onSurface">onSurface</a></span>
...
<dd>
  ...
  <span class="name"><a href="../unself_component/ButtonBackground/primary">primary</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-ui/Color-class.html">Color</a>?</span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_component/ButtonBackground/resolve">resolve</a></span><span class="signature">(<wbr><span class="parameter" id="resolve-param-states"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Set-class.html">Set</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/material/MaterialState.html">MaterialState</a></span>&gt;</span></span> <span class="parameter-name">states</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_component/ButtonBackground/ButtonBackground#constructors">Constructors</a></li>
          <li><a href="../unself_component/ButtonBackground/ButtonBackground.constructor">ButtonBackground</a></li>


        <li class="section-title">
          <a href="../unself_component/ButtonBackground/ButtonBackground#instance-properties">Properties</a>
        </li>
        ...
        <li class="section-title"><a href="../unself_component/ButtonBackground/ButtonBackground#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../unself_component/ButtonBackground/ButtonBackground#operators">Operators</a></li>
