...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-constructor">ChipText</span> constructor 
    <a href="https://dart.dev/null-safety" class="feature feature-null-safety" title="Supports the null safety language feature.">Null safety</a>
</h1></div>

    <section class="multi-line-signature">
      const
      <span class="name ">ChipText</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span></li>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">const ChipText({
  Key? key,
  required this.text,
  this.onSelected,
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ChipText const constructor</li>
</ol>
    ...
    <ol>
        ...
        <li class="section-title"><a href="../../unself_component/ChipText/ChipText#constructors">Constructors</a></li>
          <li><a href="../../unself_component/ChipText/ChipText.constructor">ChipText</a></li>


        <li class="section-title">
          <a href="../../unself_component/ChipText/ChipText#instance-properties">Properties</a>
        </li>
        ...
        <li class="section-title"><a href="../../unself_component/ChipText/ChipText#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../../unself_component/ChipText/ChipText#operators">Operators</a></li>
