...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-typedef">UnTransitionPage</span> typedef 
...
<span class="name ">UnTransitionPage</span> = <a href="https://api.flutter.dev/flutter/cupertino/CupertinoPage-class.html">CupertinoPage</a>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">typedef UnTransitionPage = CupertinoPage;</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">UnTransitionPage typedef</li>
</ol>
