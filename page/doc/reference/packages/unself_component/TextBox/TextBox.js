...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">TextBox</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="TextBox" class="callable">
          <span class="name"><a href="../unself_component/TextBox/TextBox.constructor">TextBox</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-hintText"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a>?</span> <span class="parameter-name">hintText</span>}</span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
        ...
        <dt id="hintText" class="property">
  <span class="name"><a href="../unself_component/TextBox/hintText">hintText</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_component/TextBox/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">TextBox class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_component/TextBox/TextBox#constructors">Constructors</a></li>
          <li><a href="../unself_component/TextBox/TextBox.constructor">TextBox</a></li>


        <li class="section-title">
          <a href="../unself_component/TextBox/TextBox#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li><a href="../unself_component/TextBox/hintText">hintText</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../unself_component/TextBox/TextBox#instance-methods">Methods</a></li>
          <li><a href="../unself_component/TextBox/build">build</a></li>
        ...
        <li class="section-title inherited"><a href="../unself_component/TextBox/TextBox#operators">Operators</a></li>
