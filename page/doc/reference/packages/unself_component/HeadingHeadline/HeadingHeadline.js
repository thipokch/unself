...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">HeadingHeadline</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="HeadingHeadline" class="callable">
          <span class="name"><a href="../unself_component/HeadingHeadline/HeadingHeadline.constructor">HeadingHeadline</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-label"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">label</span>}</span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_component/HeadingHeadline/label">label</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_component/HeadingHeadline/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">HeadingHeadline class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_component/HeadingHeadline/HeadingHeadline#constructors">Constructors</a></li>
          <li><a href="../unself_component/HeadingHeadline/HeadingHeadline.constructor">HeadingHeadline</a></li>


        <li class="section-title">
          <a href="../unself_component/HeadingHeadline/HeadingHeadline#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li><a href="../unself_component/HeadingHeadline/label">label</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../unself_component/HeadingHeadline/HeadingHeadline#instance-methods">Methods</a></li>
          <li><a href="../unself_component/HeadingHeadline/build">build</a></li>
        ...
        <li class="section-title inherited"><a href="../unself_component/HeadingHeadline/HeadingHeadline#operators">Operators</a></li>
