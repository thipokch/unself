...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">removeOffsetChangedListener</span> method 
...
<span class="name ">removeOffsetChangedListener</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="removeOffsetChangedListener-param-listener"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-ui/VoidCallback.html">VoidCallback</a></span> <span class="parameter-name">listener</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">void removeOffsetChangedListener(VoidCallback listener) =&gt;
    _offsetNotifier.removeListener(listener);</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">removeOffsetChangedListener method</li>
</ol>
