...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">Unmoji</span> class 
...
<section class="desc markdown">
  <p>returns an image of an emoji</p>
<p>The format of the emoji image it can be <a href="../unself_component/UnmojiFormat">UnmojiFormat.webp</a>
72*72 png or <a href="../unself_component/UnmojiFormat">UnmojiFormat.svg</a> svg by default.</p>
</section>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="Unmoji" class="callable">
          <span class="name"><a href="../unself_component/Unmoji/Unmoji.constructor">Unmoji</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-emoji"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">emoji</span>, </span><span class="parameter" id="-param-height"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/double-class.html">double</a>?</span> <span class="parameter-name">height</span>, </span><span class="parameter" id="-param-width"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/double-class.html">double</a>?</span> <span class="parameter-name">width</span>, </span><span class="parameter" id="-param-twemojiFormat"><span class="type-annotation"><a href="../unself_component/UnmojiFormat">UnmojiFormat</a></span> <span class="parameter-name">twemojiFormat</span> = <span class="default-value">UnmojiFormat.webp</span>, </span><span class="parameter" id="-param-fit"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/painting/BoxFit.html">BoxFit</a>?</span> <span class="parameter-name">fit</span>}</span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../unself_component/Unmoji/emoji">emoji</a></span>
...
<dd>
  ...
  <div class="features"><span class="feature">final</span></div>
        ...
        <dt id="fit" class="property">
  <span class="name"><a href="../unself_component/Unmoji/fit">fit</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/painting/BoxFit.html">BoxFit</a>?</span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_component/Unmoji/height">height</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_component/Unmoji/twemojiFormat">twemojiFormat</a></span>
  <span class="signature">→ <a href="../unself_component/UnmojiFormat">UnmojiFormat</a></span> 

</dt>
<dd>
  The format of the emoji image it can be <a href="../unself_component/UnmojiFormat">UnmojiFormat.webp</a>
72*72 png or <a href="../unself_component/UnmojiFormat">UnmojiFormat.svg</a> svg by default.
  <div class="features"><span class="feature">final</span></div>

</dd>

        <dt id="unicode" class="property">
  <span class="name"><a href="../unself_component/Unmoji/unicode">unicode</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 
...
<dd>
  ...
  <span class="name"><a href="../unself_component/Unmoji/width">width</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/double-class.html">double</a>?</span> 
...
<dd>
  ...
  <span class="name"><a href="../unself_component/Unmoji/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">Unmoji class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_component/Unmoji/Unmoji#constructors">Constructors</a></li>
          <li><a href="../unself_component/Unmoji/Unmoji.constructor">Unmoji</a></li>


        <li class="section-title">
          <a href="../unself_component/Unmoji/Unmoji#instance-properties">Properties</a>
        </li>
        ...
        <li class="section-title"><a href="../unself_component/Unmoji/Unmoji#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../unself_component/Unmoji/Unmoji#operators">Operators</a></li>
