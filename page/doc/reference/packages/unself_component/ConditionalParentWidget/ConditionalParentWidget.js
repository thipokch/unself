...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ConditionalParentWidget</span> class 
...
<section class="desc markdown">
  <p>Conditionally wrap a subtree with a parent widget without breaking the code tree.</p>
<p><a href="../unself_component/ConditionalParentWidget/condition">condition</a>: the condition depending on which the subtree <a href="../unself_component/ConditionalParentWidget/child">child</a> is wrapped with the parent.
<a href="../unself_component/ConditionalParentWidget/child">child</a>: The subtree that should always be build.
<a href="../unself_component/ConditionalParentWidget/conditionalBuilder">conditionalBuilder</a>: builds the parent with the subtree <a href="../unself_component/ConditionalParentWidget/child">child</a>.</p>
<hr>
<p>Usage:</p>
<pre class="language-dart"><code class="language-dart">return ConditionalParentWidget(
...
<hr>
<p>Instead of:</p>
<pre class="language-dart"><code class="language-dart">Widget child = Widget1(
  child: Widget2(
    child: Widget3(),
  ),
);
...
return shouldIncludeParent ? SomeParentWidget(child: child) : child;
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ConditionalParentWidget" class="callable">
          <span class="name"><a href="../unself_component/ConditionalParentWidget/ConditionalParentWidget.constructor">ConditionalParentWidget</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-condition"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/bool-class.html">bool</a></span> <span class="parameter-name">condition</span>, </span><span class="parameter" id="-param-child"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> <span class="parameter-name">child</span>, </span><span class="parameter" id="-param-conditionalBuilder"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> <span class="parameter-name">conditionalBuilder</span>(<span class="parameter" id="param-child"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> <span class="parameter-name">child</span></span>)}</span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../unself_component/ConditionalParentWidget/child">child</a></span>
...
<dd>
  ...
  <div class="features"><span class="feature">final</span></div>
        ...
        <dt id="condition" class="property">
  <span class="name"><a href="../unself_component/ConditionalParentWidget/condition">condition</a></span>
...
<dd>
  ...
  <div class="features"><span class="feature">final</span></div>
        ...
        <dt id="conditionalBuilder" class="property">
  <span class="name"><a href="../unself_component/ConditionalParentWidget/conditionalBuilder">conditionalBuilder</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a> Function<span class="signature">(<span class="parameter" id="param-child"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> <span class="parameter-name">child</span></span>)</span></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_component/ConditionalParentWidget/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ConditionalParentWidget class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_component/ConditionalParentWidget/ConditionalParentWidget#constructors">Constructors</a></li>
          <li><a href="../unself_component/ConditionalParentWidget/ConditionalParentWidget.constructor">ConditionalParentWidget</a></li>


        <li class="section-title">
          <a href="../unself_component/ConditionalParentWidget/ConditionalParentWidget#instance-properties">Properties</a>
        </li>
        ...
        <li class="section-title"><a href="../unself_component/ConditionalParentWidget/ConditionalParentWidget#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../unself_component/ConditionalParentWidget/ConditionalParentWidget#operators">Operators</a></li>
