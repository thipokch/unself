...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">DocumentDao</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="DocumentDao" class="callable">
          <span class="name"><a href="../unself_local_database/DocumentDao/DocumentDao.constructor">DocumentDao</a></span><span class="signature">(<span class="parameter" id="-param-db"><span class="type-annotation"><a href="../unself_local_database/LocalDatabase/LocalDatabase">LocalDatabase</a></span> <span class="parameter-name">db</span></span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">inherited</span></div>
        ...
        <dt id="saveRecord" class="callable">
  <span class="name"><a href="../unself_local_database/DocumentDao/saveRecord">saveRecord</a></span><span class="signature">(<wbr>)
    <span class="returntype parameter">→ void</span>
  </span>
...
<dd>
  <a href="../unself_local_database/DocumentDao/saveRecord">saveRecord</a> upserts the provided <a href="https://api.flutter.dev/flutter/dart-core/Record-class.html">Record</a> model.
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">DocumentDao class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_local_database/DocumentDao/DocumentDao#constructors">Constructors</a></li>
          <li><a href="../unself_local_database/DocumentDao/DocumentDao.constructor">DocumentDao</a></li>


        <li class="section-title inherited">
          <a href="../unself_local_database/DocumentDao/DocumentDao#instance-properties">Properties</a>
        </li>
        ...
        <li class="section-title"><a href="../unself_local_database/DocumentDao/DocumentDao#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../unself_local_database/DocumentDao/DocumentDao#operators">Operators</a></li>
