...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">CollectionDao</span> class 
  ...
  <dd>
    <ul class="gt-separated dark clazz-relationships">
      <li><a href="https://api.flutter.dev/flutter/dart-core/Object-class.html">Object</a></li>
        ...
        <li><a href="https://pub.dev/documentation/drift/2.4.2/drift/DatabaseAccessor-class.html">DatabaseAccessor</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unself_local_database/LocalDatabase/LocalDatabase">LocalDatabase</a></span>&gt;</span></li>
      <li>CollectionDao</li>
    </ul>
  </dd>
        ...
        <dd><ul class="comma-separated clazz-relationships">
          <li><a href="https://pub.dev/documentation/drift/2.4.2/drift/OldDbFieldInDatabaseAccessor.html">OldDbFieldInDatabaseAccessor</a></li>
        </ul></dd>
  ...
  <dd>
    <ul class="annotation-list clazz-relationships">
        <li>@<a href="https://pub.dev/documentation/drift/2.4.2/drift/DriftAccessor-class.html">DriftAccessor</a>()</li>
    </ul>
  </dd>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="CollectionDao" class="callable">
          <span class="name"><a href="../unself_local_database/CollectionDao/CollectionDao.constructor">CollectionDao</a></span><span class="signature">(<span class="parameter" id="-param-db"><span class="type-annotation"><a href="../unself_local_database/LocalDatabase/LocalDatabase">LocalDatabase</a></span> <span class="parameter-name">db</span></span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="https://pub.dev/documentation/drift/2.4.2/drift/DatabaseAccessor/attachedDatabase.html">attachedDatabase</a></span>
  <span class="signature">→ <a href="../unself_local_database/LocalDatabase/LocalDatabase">LocalDatabase</a></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_local_database/CollectionDao/collection">collection</a></span>
  <span class="signature">→ <a href="../unself_local_database/\$CollectionTable/\$CollectionTable">\$CollectionTable</a></span> 
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
        ...
        <dt id="field" class="property">
  <span class="name"><a href="../unself_local_database/CollectionDao/field">field</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="https://pub.dev/documentation/drift/2.4.2/drift/DatabaseConnectionUser/options.html">options</a></span>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">inherited</span></div>
        ...
        <dt id="deleteCollection" class="callable">
  <span class="name"><a href="../unself_local_database/CollectionDao/deleteCollection">deleteCollection</a></span><span class="signature">(<wbr><span class="parameter" id="deleteCollection-param-name"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">name</span></span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a></span>
  </span>
  

</dt>
<dd>
  <a href="../unself_local_database/CollectionDao/deleteCollection">deleteCollection</a> deletes the provided <a href="../unself_local_database/Collection/Collection">Collection</a> model.
...
already ready.
  ...
  <span class="name"><a href="../unself_local_database/CollectionDao/getCollectionByName">getCollectionByName</a></span><span class="signature">&lt;<wbr><span class="type-parameter">D</span>&gt;</span><span class="signature">(<wbr><span class="parameter" id="getCollectionByName-param-name"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">name</span></span>)
    <span class="returntype parameter">→ <a href="../unself_local_database/CollectionOrm/CollectionOrm">CollectionOrm</a><span class="signature">&lt;<wbr><span class="type-parameter">D</span>&gt;</span></span>
  </span>
  

</dt>
<dd>
  <a href="../unself_local_database/CollectionDao/getCollectionByName">getCollectionByName</a> finds a single <a href="../unself_local_database/Collection/Collection">Collection</a> by its name (case insensitive).
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">inherited</span></div>
        ...
        <dt id="saveCollection" class="callable">
  <span class="name"><a href="../unself_local_database/CollectionDao/saveCollection">saveCollection</a></span><span class="signature">(<wbr><span class="parameter" id="saveCollection-param-collection"><span class="type-annotation"><a href="../unself_local_database/CollectionData/CollectionData">CollectionData</a></span> <span class="parameter-name">collection</span>, </span><span class="parameter" id="saveCollection-param-fields"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unself_local_database/FieldData/FieldData">FieldData</a></span>&gt;</span></span> <span class="parameter-name">fields</span></span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a></span>
  </span>
...
<dd>
  <a href="../unself_local_database/CollectionDao/saveCollection">saveCollection</a> upserts the provided <a href="../unself_local_database/CollectionData/CollectionData">CollectionData</a> model and updates
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">CollectionDao class</li>
</ol>
