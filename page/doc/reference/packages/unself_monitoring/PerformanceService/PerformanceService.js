...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">PerformanceService</span> class 
...
<section class="desc markdown">
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="PerformanceService" class="callable">
          <span class="name"><a href="../unself_monitoring/PerformanceService/PerformanceService.constructor">PerformanceService</a></span><span class="signature">(<span class="parameter" id="-param-performance">{<span>required</span> <span class="type-annotation"><a href="https://pub.dev/documentation/firebase_performance/0.9.0+10/firebase_performance/FirebasePerformance-class.html">FirebasePerformance</a></span> <span class="parameter-name">performance</span>}</span>)</span>
        </dt>
        <dd>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">PerformanceService class</li>
</ol>
