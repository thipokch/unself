...
<section class="desc markdown">
  <p><a href="../unself_monitoring/InfoService/InfoService">InfoService</a> description</p>
</section>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="InfoService" class="callable">
          <span class="name"><a href="../unself_monitoring/InfoService/InfoService.constructor">InfoService</a></span><span class="signature">(<span class="parameter" id="-param-analytic">{<span class="type-annotation"><a href="../unself_monitoring/AnalyticService/AnalyticService">AnalyticService</a>?</span> <span class="parameter-name">analytic</span>}</span>)</span>
        </dt>
        <dd>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_monitoring/InfoService/InfoService#constructors">Constructors</a></li>
          <li><a href="../unself_monitoring/InfoService/InfoService.constructor">InfoService</a></li>


        <li class="section-title">
          <a href="../unself_monitoring/InfoService/InfoService#instance-properties">Properties</a>
        </li>
        ...
        <li class="section-title inherited"><a href="../unself_monitoring/InfoService/InfoService#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../unself_monitoring/InfoService/InfoService#operators">Operators</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/operator_equals.html">operator ==</a></li>


        <li class="section-title"><a href="../unself_monitoring/InfoService/InfoService#static-properties">Static properties</a></li>
