...
<h1><span class="kind-constructor">InfoService</span> constructor 
    ...
    <section class="multi-line-signature">
      const
      <span class="name ">InfoService</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="-param-analytic">{<span class="type-annotation"><a href="../../unself_monitoring/AnalyticService/AnalyticService">AnalyticService</a>?</span> <span class="parameter-name">analytic</span>}</span></li>
</ol>)
    </section>
