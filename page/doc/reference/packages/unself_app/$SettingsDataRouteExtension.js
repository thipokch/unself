...
<div id="dartdoc-main-content" class="main-content">
    <div>
<h1><span class="kind-class">\$SettingsDataRouteExtension</span> extension 
  ...
  <span class="name"><a href="../unself_app/\$SettingsDataRouteExtension/location">location</a></span>
...
<dd>
  ...
  <span class="name"><a href="../unself_app/\$SettingsDataRouteExtension/go">go</a></span><span class="signature">(<wbr><span class="parameter" id="go-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">\$SettingsDataRouteExtension extension</li>
</ol>
...
<div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"> <a href="../unself_app/\$SettingsDataRouteExtension#instance-properties">Properties</a></li>
          <li><a href="../unself_app/\$SettingsDataRouteExtension/location">location</a></li>

        <li class="section-title"><a href="../unself_app/\$SettingsDataRouteExtension#instance-methods">Methods</a></li>
          <li><a href="../unself_app/\$SettingsDataRouteExtension/go">go</a></li>
          <li><a href="../unself_app/\$SettingsDataRouteExtension/push">push</a></li>
