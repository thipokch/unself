...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-property">navigator</span> property 
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">static final navigator = GlobalKey&lt;NavigatorState&gt;(debugLabel: 'AppShell');</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">navigator property</li>
</ol>
    ...
    <ol>
        ...
        <li class="section-title">
          <a href="../../unself_app/AppShell/AppShell#instance-properties">Properties</a>
        </li>
        ...
        <li class="section-title"><a href="../../unself_app/AppShell/AppShell#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../../unself_app/AppShell/AppShell#operators">Operators</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/operator_equals.html">operator ==</a></li>


        <li class="section-title"><a href="../../unself_app/AppShell/AppShell#static-properties">Static properties</a></li>
