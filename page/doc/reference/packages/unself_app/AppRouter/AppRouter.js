...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">AppRouter</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="AppRouter" class="callable">
          <span class="name"><a href="../unself_app/AppRouter/AppRouter.constructor">AppRouter</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <section class="summary offset-anchor" id="static-properties">
    ...
    <dl class="properties">
        <dt id="defaultLocation" class="property">
  <span class="name"><a href="../unself_app/AppRouter/defaultLocation">defaultLocation</a></span>
...
<dd>
  ...
  <div class="features"><span class="feature">final</span></div>
        ...
        <dt id="defaultNavigator" class="property">
  <span class="name"><a href="../unself_app/AppRouter/defaultNavigator">defaultNavigator</a></span>
...
<dd>
  ...
  <div class="features"><span class="feature">final</span></div>
        ...
        <dt id="defaultRoutes" class="property">
  <span class="name"><a href="../unself_app/AppRouter/defaultRoutes">defaultRoutes</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://pub.dev/documentation/go_router/6.0.1/go_router/RouteBase-class.html">RouteBase</a></span>&gt;</span></span> 
...
<dd>
  ...
  <span class="name"><a href="../unself_app/AppRouter/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-observers">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/widgets/NavigatorObserver-class.html">NavigatorObserver</a></span>&gt;</span>?</span> <span class="parameter-name">observers</span>}</span>)
    <span class="returntype parameter">→ <a href="https://pub.dev/documentation/go_router/6.0.1/go_router/GoRouter-class.html">GoRouter</a></span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">AppRouter abstract class</li>
</ol>
