...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-top-level-property">\$unpackRoutes</span> top-level property 
...
<section class="multi-line-signature">
  ...
  <span class="name ">\$unpackRoutes</span>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">GoRoute get \$unpackRoutes =&gt; GoRouteData.\$route(
      path: '/unpack',
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">\$unpackRoutes property</li>
</ol>
