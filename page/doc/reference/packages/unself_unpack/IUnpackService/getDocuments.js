...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">getDocuments</span> abstract method 
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">FutureOr&lt;List&lt;Document&gt;&gt; getDocuments({required Collection collection});</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li><a href="../../unself_unpack/IUnpackService/IUnpackService">IUnpackService</a></li>
  <li class="self-crumb">getDocuments abstract method</li>
</ol>
    ...
    <ol>
        ...
        <li class="section-title"><a href="../../unself_unpack/IUnpackService/IUnpackService#constructors">Constructors</a></li>
          <li><a href="../../unself_unpack/IUnpackService/IUnpackService.constructor">IUnpackService</a></li>


        <li class="section-title inherited">
          <a href="../../unself_unpack/IUnpackService/IUnpackService#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../../unself_unpack/IUnpackService/IUnpackService#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../../unself_unpack/IUnpackService/IUnpackService#operators">Operators</a></li>
