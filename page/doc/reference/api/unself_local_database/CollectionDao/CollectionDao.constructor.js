...
<h1><span class="kind-constructor">CollectionDao</span> constructor 
    ...
    <section class="multi-line-signature">
      ...
      <span class="name ">CollectionDao</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="-param-db"><span class="type-annotation"><a href="../../unself_local_database/LocalDatabase">LocalDatabase</a></span> <span class="parameter-name">db</span></span></li>
</ol>)
    </section>
