  ...
  <dd>
    <ul class="gt-separated dark clazz-relationships">
      <li><a href="https://api.flutter.dev/flutter/dart-core/Object-class.html">Object</a></li>
        ...
        <li><a href="https://pub.dev/documentation/drift/2.4.2/drift/DatabaseAccessor-class.html">DatabaseAccessor</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unself_local_database/LocalDatabase">LocalDatabase</a></span>&gt;</span></li>
      <li>CollectionDao</li>
    </ul>
  </dd>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="CollectionDao" class="callable">
          <span class="name"><a href="../unself_local_database/CollectionDao/CollectionDao.constructor">CollectionDao</a></span><span class="signature">(<span class="parameter" id="-param-db"><span class="type-annotation"><a href="../unself_local_database/LocalDatabase">LocalDatabase</a></span> <span class="parameter-name">db</span></span>)</span>
        </dt>
        <dd>
...
<dd>
  <a href="../unself_local_database/CollectionDao/deleteCollection">deleteCollection</a> deletes the provided <a href="../unself_local_database/Collection">Collection</a> model.
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_local_database/CollectionDao/saveCollection">saveCollection</a></span><span class="signature">(<wbr><span class="parameter" id="saveCollection-param-collection"><span class="type-annotation"><a href="../unself_local_database/CollectionData">CollectionData</a></span> <span class="parameter-name">collection</span>, </span><span class="parameter" id="saveCollection-param-fields"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unself_local_database/FieldData">FieldData</a></span>&gt;</span></span> <span class="parameter-name">fields</span></span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a></span>
  </span>
...
<dd>
  <a href="../unself_local_database/CollectionDao/saveCollection">saveCollection</a> upserts the provided <a href="../unself_local_database/CollectionData">CollectionData</a> model and updates
