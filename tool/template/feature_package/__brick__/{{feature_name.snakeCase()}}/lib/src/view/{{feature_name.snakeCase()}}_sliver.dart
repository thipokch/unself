...
/// {@template {{feature_name.snakeCase()}}_sliver}
/// Sliver of the {{feature_name.pascalCase()}}Page.
///
/// Add what it does
/// {@endtemplate}
class {{feature_name.pascalCase()}}Sliver {{#isBloc}}extends StatelessWidget{{/isBloc}}{{#isCubit}}extends StatelessWidget{{/isCubit}}{{#isProvider}}extends StatelessWidget{{/isProvider}}{{#isNone}}extends StatelessWidget{{/isNone}}{{#isRiverpod}}extends ConsumerWidget{{/isRiverpod}} {
  /// {@macro {{feature_name.snakeCase()}}_sliver}
  const {{feature_name.pascalCase()}}Sliver({super.key});
{{#isBloc}}
  @override
