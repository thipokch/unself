...
mixin _$Node {
  ...
  String get specSlug =>
      throw _privateConstructorUsedError; // required List<String> labels,
  @JsonEmptyMap()
...
// required List<String> labels,
  ...
  @override
  String toString() {
    return 'Node(id: $id, specSlug: $specSlug, properties: $properties)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, specSlug,
...
abstract class _Node extends Node {
  const factory _Node(
      ...
      @JsonEmptyMap() final Map<String, dynamic> properties}) = _$_Node;
  ...
  @override
  String get specSlug;
  @override // required List<String> labels,
  @JsonEmptyMap()
  Map<String, dynamic> get properties;
  @override
  @JsonKey(ignore: true)
