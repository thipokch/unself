...
abstract class _$UnDatabase extends GeneratedDatabase {
  ...
  late final UnpackStateDao unpackStateDao = UnpackStateDao(this as UnDatabase);
  late final UnpackSpecDao unpackSpecDao = UnpackSpecDao(this as UnDatabase);
  @override
