...
class XFilePicker {
  static final FilePicker instance = FilePickerWeb.platform;
}
...
class FilePickerWeb extends FilePicker {
  ...
  Future<FilePickerResult?> pickFiles({
    ...
    void changeEventListener(e) {
      ...
      final List<XPlatformFile> pickedFiles = [];
      ...
      void addPickedFile(
        ...
        pickedFiles.add(XPlatformFile(
          name: file.name,
          path: path,
          size: bytes != null ? bytes.length : file.size,
          bytes: bytes,
          readStream: readStream,
          objectUrl: Url.createObjectUrlFromBlob(file),
        ));
