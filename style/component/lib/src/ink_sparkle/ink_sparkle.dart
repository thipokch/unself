...
import 'package:unself_style/unself_style.dart' show UnEasing, UnDurations;
...
/// {@tool snippet}
///
/// For typical use, pass the [kIsWeb ? null : InkSparklePatch.splashFactory] to the `splashFactory`
...
/// ```
/// {@end-tool}
class InkSparklePatch extends InteractiveInkFeature {
  ...
  InkSparklePatch({
    ...
    _radiusScale = TweenSequence<double>(
      <TweenSequenceItem<double>>[
        TweenSequenceItem<double>(
          tween: CurveTween(curve: UnEasing.fastOutSlowIn),
          weight: 75,
        ),
        TweenSequenceItem<double>(
  ...
  static const Duration _animationDuration = UnDurations.dalayed;
  ...
  ///
  /// For examples on how the function is used, see [InkSparklePatch] and [paintInkCircle].
  ...
  ///
  /// For examples on how the function is used, see [InkSparklePatch].
  void _clipCanvas({
    required Canvas canvas,
...
class FragmentShaderManager {
  ...
  /// Creates an [FragmentShaderManager] with an [InkSparklePatch] effect.
