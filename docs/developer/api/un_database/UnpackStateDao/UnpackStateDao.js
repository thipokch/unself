...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">UnpackStateDao</span> class 
  ...
  <dd>
    <ul class="gt-separated dark clazz-relationships">
      <li><a href="https://api.flutter.dev/flutter/dart-core/Object-class.html">Object</a></li>
        ...
        <li><a href="https://pub.dev/documentation/drift/2.6.0/drift/DatabaseAccessor-class.html">DatabaseAccessor</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../un_database/UnDatabase">UnDatabase</a></span>&gt;</span></li>
      <li>UnpackStateDao</li>
    </ul>
  </dd>
  ...
  <dd>
    <ul class="annotation-list clazz-relationships">
        <li>@<a href="https://pub.dev/documentation/drift/2.6.0/drift/DriftAccessor-class.html">DriftAccessor</a>(tables: [UnpackState])</li>
    </ul>
  </dd>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="UnpackStateDao" class="callable">
          <span class="name"><a href="../un_database/UnpackStateDao/UnpackStateDao.constructor">UnpackStateDao</a></span><span class="signature">(<span class="parameter" id="-param-attachedDatabase"><span class="type-annotation"><a href="../un_database/UnDatabase">UnDatabase</a></span> <span class="parameter-name">attachedDatabase</span></span>)</span>
        </dt>
        <dd>
  ...
  <span class="signature">→ <a href="../un_database/UnDatabase">UnDatabase</a></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_database/UnpackStateDao/count">count</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_database/UnpackStateDao/isEmpty">isEmpty</a></span>
...
and SQL.
  ...
  <span class="name"><a href="../un_database/UnpackStateDao/unpackSpec">unpackSpec</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_database/UnpackStateDao/unpackState">unpackState</a></span>
...
already ready.
  ...
  <span class="name"><a href="../un_database/UnpackStateDao/get">get</a></span><span class="signature">(<wbr><span class="parameter" id="get-param-id"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">id</span></span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../un_database/UnpackStateData">UnpackStateData</a></span>&gt;</span></span>
  </span>
...
<dd>
  ...
  <span class="name"><a href="../un_database/UnpackStateDao/getAll">getAll</a></span><span class="signature">(<wbr>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../un_database/UnpackStateData">UnpackStateData</a></span>&gt;</span></span>&gt;</span></span>
  </span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_database/UnpackStateDao/put">put</a></span><span class="signature">(<wbr><span class="parameter" id="put-param-entity"><span class="type-annotation"><a href="https://pub.dev/documentation/drift/2.6.0/drift/Insertable-class.html">Insertable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../un_database/UnpackStateData">UnpackStateData</a></span>&gt;</span></span> <span class="parameter-name">entity</span></span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../un_database/UnpackStateData">UnpackStateData</a></span>&gt;</span></span>
  </span>
...
clause on that table and then use <a href="https://pub.dev/documentation/drift/2.6.0/drift/UpdateStatement/write.html">UpdateStatement.write</a>.
  ...
  <span class="name"><a href="../un_database/UnpackStateDao/watchAll">watchAll</a></span><span class="signature">(<wbr>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/Stream-class.html">Stream</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../un_database/UnpackStateData">UnpackStateData</a></span>&gt;</span></span>&gt;</span></span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">UnpackStateDao class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_database/UnpackStateDao#constructors">Constructors</a></li>
          <li><a href="../un_database/UnpackStateDao/UnpackStateDao.constructor">UnpackStateDao</a></li>


        <li class="section-title">
          <a href="../un_database/UnpackStateDao#instance-properties">Properties</a>
        </li>
          ...
          <li><a href="../un_database/UnpackStateDao/count">count</a></li>
          ...
          <li><a href="../un_database/UnpackStateDao/isEmpty">isEmpty</a></li>
          ...
          <li class="inherited"><a href="../un_database/UnpackStateDao/unpackSpec">unpackSpec</a></li>
          <li class="inherited"><a href="../un_database/UnpackStateDao/unpackState">unpackState</a></li>

        <li class="section-title"><a href="../un_database/UnpackStateDao#instance-methods">Methods</a></li>
          ...
          <li><a href="../un_database/UnpackStateDao/get">get</a></li>
          <li><a href="../un_database/UnpackStateDao/getAll">getAll</a></li>
          ...
          <li><a href="../un_database/UnpackStateDao/put">put</a></li>
          ...
          <li><a href="../un_database/UnpackStateDao/watchAll">watchAll</a></li>

        <li class="section-title inherited"><a href="../un_database/UnpackStateDao#operators">Operators</a></li>
