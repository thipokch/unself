...
<h1><span class="kind-constructor">UnpackSpecDao</span> constructor 
    ...
    <section class="multi-line-signature">
      ...
      <span class="name ">UnpackSpecDao</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="-param-attachedDatabase"><span class="type-annotation"><a href="../../un_database/UnDatabase">UnDatabase</a></span> <span class="parameter-name">attachedDatabase</span></span></li>
</ol>)
    </section>
