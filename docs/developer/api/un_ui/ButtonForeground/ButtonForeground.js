...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ButtonForeground</span> class 
  ...
  <dd>
    <ul class="gt-separated dark clazz-relationships">
      <li><a href="https://api.flutter.dev/flutter/dart-core/Object-class.html">Object</a></li>
        <li><a href="https://api.flutter.dev/flutter/material/MaterialStateProperty-class.html">MaterialStateProperty</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-ui/Color-class.html">Color</a>?</span>&gt;</span></li>
  ...
  <dd>
    <ul class="comma-separated clazz-relationships">
        <li><a href="https://api.flutter.dev/flutter/foundation/Diagnosticable-mixin.html">Diagnosticable</a></li>
    </ul>
  </dd>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ButtonForeground" class="callable">
          <span class="name"><a href="../un_ui/ButtonForeground/ButtonForeground.constructor">ButtonForeground</a></span><span class="signature">(<span class="parameter" id="-param-onPrimary"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-ui/Color-class.html">Color</a>?</span> <span class="parameter-name">onPrimary</span>, </span><span class="parameter" id="-param-onSurface"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-ui/Color-class.html">Color</a>?</span> <span class="parameter-name">onSurface</span></span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
        ...
        <dt id="onPrimary" class="property">
  <span class="name"><a href="../un_ui/ButtonForeground/onPrimary">onPrimary</a></span>
...
<dd>
  ...
  <div class="features"><span class="feature">final</span></div>
        ...
        <dt id="onSurface" class="property">
  <span class="name"><a href="../un_ui/ButtonForeground/onSurface">onSurface</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-ui/Color-class.html">Color</a>?</span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="https://api.flutter.dev/flutter/foundation/Diagnosticable/debugFillProperties.html">debugFillProperties</a></span><span class="signature">(<wbr><span class="parameter" id="debugFillProperties-param-properties"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/DiagnosticPropertiesBuilder-class.html">DiagnosticPropertiesBuilder</a></span> <span class="parameter-name">properties</span></span>)
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/ButtonForeground/resolve">resolve</a></span><span class="signature">(<wbr><span class="parameter" id="resolve-param-states"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Set-class.html">Set</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/material/MaterialState.html">MaterialState</a></span>&gt;</span></span> <span class="parameter-name">states</span></span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-ui/Color-class.html">Color</a>?</span>
  </span>
  

</dt>
<dd>
  Returns a value of type <code>T</code> that depends on <code>states</code>.
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ButtonForeground class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_ui/ButtonForeground#constructors">Constructors</a></li>
          <li><a href="../un_ui/ButtonForeground/ButtonForeground.constructor">ButtonForeground</a></li>


        <li class="section-title">
          <a href="../un_ui/ButtonForeground#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li><a href="../un_ui/ButtonForeground/onPrimary">onPrimary</a></li>
          <li><a href="../un_ui/ButtonForeground/onSurface">onSurface</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../un_ui/ButtonForeground#instance-methods">Methods</a></li>
          ...
          <li><a href="../un_ui/ButtonForeground/resolve">resolve</a></li>
        ...
        <li class="section-title inherited"><a href="../un_ui/ButtonForeground#operators">Operators</a></li>
