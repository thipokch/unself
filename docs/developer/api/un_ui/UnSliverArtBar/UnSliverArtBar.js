...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">UnSliverArtBar</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="UnSliverArtBar" class="callable">
          <span class="name"><a href="../un_ui/UnSliverArtBar/UnSliverArtBar.constructor">UnSliverArtBar</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-emoji"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> <span class="parameter-name">emoji</span>, </span><span class="parameter" id="-param-name"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> <span class="parameter-name">name</span>, </span><span class="parameter" id="-param-description"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">description</span>, </span><span class="parameter" id="-param-action"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">action</span>, </span><span class="parameter" id="-param-background"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">background</span>, </span><span class="parameter" id="-param-leading"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">leading</span>, </span><span class="parameter" id="-param-trailing"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">trailing</span>, </span><span class="parameter" id="-param-isImmersive"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/bool-class.html">bool</a></span> <span class="parameter-name">isImmersive</span> = <span class="default-value">false</span>}</span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../un_ui/UnSliverArtBar/action">action</a></span>
...
<dd>
  ...
  <div class="features"><span class="feature">final</span></div>
        ...
        <dt id="background" class="property">
  <span class="name"><a href="../un_ui/UnSliverArtBar/background">background</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> 
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnSliverArtBar/description">description</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> 
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnSliverArtBar/emoji">emoji</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/UnSliverArtBar/isImmersive">isImmersive</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/UnSliverArtBar/leading">leading</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> 
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnSliverArtBar/name">name</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/UnSliverArtBar/trailing">trailing</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/UnSliverArtBar/createState">createState</a></span><span class="signature">(<wbr>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/widgets/State-class.html">State</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../un_ui/UnSliverArtBar">UnSliverArtBar</a></span>&gt;</span></span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">UnSliverArtBar class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_ui/UnSliverArtBar#constructors">Constructors</a></li>
          <li><a href="../un_ui/UnSliverArtBar/UnSliverArtBar.constructor">UnSliverArtBar</a></li>


        <li class="section-title">
          <a href="../un_ui/UnSliverArtBar#instance-properties">Properties</a>
        </li>
          <li><a href="../un_ui/UnSliverArtBar/action">action</a></li>
          <li><a href="../un_ui/UnSliverArtBar/background">background</a></li>
          <li><a href="../un_ui/UnSliverArtBar/description">description</a></li>
          <li><a href="../un_ui/UnSliverArtBar/emoji">emoji</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li><a href="../un_ui/UnSliverArtBar/isImmersive">isImmersive</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li><a href="../un_ui/UnSliverArtBar/leading">leading</a></li>
          <li><a href="../un_ui/UnSliverArtBar/name">name</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li><a href="../un_ui/UnSliverArtBar/trailing">trailing</a></li>

        <li class="section-title"><a href="../un_ui/UnSliverArtBar#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/StatefulWidget/createElement.html">createElement</a></li>
          <li><a href="../un_ui/UnSliverArtBar/createState">createState</a></li>
        ...
        <li class="section-title inherited"><a href="../un_ui/UnSliverArtBar#operators">Operators</a></li>
