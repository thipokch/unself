...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">UnCupertinoContextMenu</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="UnCupertinoContextMenu" class="callable">
          <span class="name"><a href="../un_ui/UnCupertinoContextMenu/UnCupertinoContextMenu.constructor">UnCupertinoContextMenu</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-actions"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span>&gt;</span></span> <span class="parameter-name">actions</span>, </span><span class="parameter" id="-param-onTap"><span class="type-annotation">dynamic</span> <span class="parameter-name">onTap</span>()?, </span><span class="parameter" id="-param-child"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> <span class="parameter-name">child</span>, </span><span class="parameter" id="-param-previewBuilder"><span class="type-annotation"><a href="../un_ui/ContextMenuPreviewBuilder">ContextMenuPreviewBuilder</a>?</span> <span class="parameter-name">previewBuilder</span>}</span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../un_ui/UnCupertinoContextMenu/actions">actions</a></span>
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnCupertinoContextMenu/child">child</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/UnCupertinoContextMenu/onTap">onTap</a></span>
  <span class="signature">→ (dynamic Function<span class="signature">()</span>?)</span> 
...
<dd>
  ...
  <div class="features"><span class="feature">final</span></div>
        ...
        <dt id="previewBuilder" class="property">
  <span class="name"><a href="../un_ui/UnCupertinoContextMenu/previewBuilder">previewBuilder</a></span>
  <span class="signature">→ <a href="../un_ui/ContextMenuPreviewBuilder">ContextMenuPreviewBuilder</a>?</span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/UnCupertinoContextMenu/createState">createState</a></span><span class="signature">(<wbr>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/widgets/State-class.html">State</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../un_ui/UnCupertinoContextMenu">UnCupertinoContextMenu</a></span>&gt;</span></span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">UnCupertinoContextMenu class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_ui/UnCupertinoContextMenu#constructors">Constructors</a></li>
          <li><a href="../un_ui/UnCupertinoContextMenu/UnCupertinoContextMenu.constructor">UnCupertinoContextMenu</a></li>


        <li class="section-title">
          <a href="../un_ui/UnCupertinoContextMenu#instance-properties">Properties</a>
        </li>
          <li><a href="../un_ui/UnCupertinoContextMenu/actions">actions</a></li>
          <li><a href="../un_ui/UnCupertinoContextMenu/child">child</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li><a href="../un_ui/UnCupertinoContextMenu/onTap">onTap</a></li>
          <li><a href="../un_ui/UnCupertinoContextMenu/previewBuilder">previewBuilder</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../un_ui/UnCupertinoContextMenu#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/StatefulWidget/createElement.html">createElement</a></li>
          <li><a href="../un_ui/UnCupertinoContextMenu/createState">createState</a></li>
        ...
        <li class="section-title inherited"><a href="../un_ui/UnCupertinoContextMenu#operators">Operators</a></li>
