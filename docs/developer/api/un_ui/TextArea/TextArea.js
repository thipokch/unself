...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">TextArea</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="TextArea" class="callable">
          <span class="name"><a href="../un_ui/TextArea/TextArea.constructor">TextArea</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-onChanged"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/ValueChanged.html">ValueChanged</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>&gt;</span>?</span> <span class="parameter-name">onChanged</span>, </span><span class="parameter" id="-param-onTap"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/gestures/GestureTapCallback.html">GestureTapCallback</a>?</span> <span class="parameter-name">onTap</span>, </span><span class="parameter" id="-param-autofocus"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/bool-class.html">bool</a>?</span> <span class="parameter-name">autofocus</span>, </span><span class="parameter" id="-param-controller"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/TextEditingController-class.html">TextEditingController</a>?</span> <span class="parameter-name">controller</span>}</span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../un_ui/TextArea/autofocus">autofocus</a></span>
...
<dd>
  ...
  <span class="name"><a href="../un_ui/TextArea/controller">controller</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/TextArea/onChanged">onChanged</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/foundation/ValueChanged.html">ValueChanged</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>&gt;</span>?</span> 
...
<dd>
  ...
  <span class="name"><a href="../un_ui/TextArea/onTap">onTap</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/TextArea/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">TextArea class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_ui/TextArea#constructors">Constructors</a></li>
          <li><a href="../un_ui/TextArea/TextArea.constructor">TextArea</a></li>


        <li class="section-title">
          <a href="../un_ui/TextArea#instance-properties">Properties</a>
        </li>
          <li><a href="../un_ui/TextArea/autofocus">autofocus</a></li>
          <li><a href="../un_ui/TextArea/controller">controller</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li><a href="../un_ui/TextArea/onChanged">onChanged</a></li>
          <li><a href="../un_ui/TextArea/onTap">onTap</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../un_ui/TextArea#instance-methods">Methods</a></li>
          <li><a href="../un_ui/TextArea/build">build</a></li>
        ...
        <li class="section-title inherited"><a href="../un_ui/TextArea#operators">Operators</a></li>
