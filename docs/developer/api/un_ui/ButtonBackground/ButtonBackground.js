...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ButtonBackground</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ButtonBackground" class="callable">
          <span class="name"><a href="../un_ui/ButtonBackground/ButtonBackground.constructor">ButtonBackground</a></span><span class="signature">(<span class="parameter" id="-param-primary"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-ui/Color-class.html">Color</a>?</span> <span class="parameter-name">primary</span>, </span><span class="parameter" id="-param-onSurface"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-ui/Color-class.html">Color</a>?</span> <span class="parameter-name">onSurface</span></span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/ButtonBackground/onSurface">onSurface</a></span>
...
<dd>
  ...
  <div class="features"><span class="feature">final</span></div>
        ...
        <dt id="primary" class="property">
  <span class="name"><a href="../un_ui/ButtonBackground/primary">primary</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-ui/Color-class.html">Color</a>?</span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/ButtonBackground/resolve">resolve</a></span><span class="signature">(<wbr><span class="parameter" id="resolve-param-states"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Set-class.html">Set</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/material/MaterialState.html">MaterialState</a></span>&gt;</span></span> <span class="parameter-name">states</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ButtonBackground class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_ui/ButtonBackground#constructors">Constructors</a></li>
          <li><a href="../un_ui/ButtonBackground/ButtonBackground.constructor">ButtonBackground</a></li>


        <li class="section-title">
          <a href="../un_ui/ButtonBackground#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li><a href="../un_ui/ButtonBackground/onSurface">onSurface</a></li>
          <li><a href="../un_ui/ButtonBackground/primary">primary</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../un_ui/ButtonBackground#instance-methods">Methods</a></li>
          ...
          <li><a href="../un_ui/ButtonBackground/resolve">resolve</a></li>
        ...
        <li class="section-title inherited"><a href="../un_ui/ButtonBackground#operators">Operators</a></li>
