...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">UnArtPage</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="UnArtPage" class="callable">
          <span class="name"><a href="../un_ui/UnArtPage/UnArtPage.constructor">UnArtPage</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-emoji"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> <span class="parameter-name">emoji</span>, </span><span class="parameter" id="-param-name"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> <span class="parameter-name">name</span>, </span><span class="parameter" id="-param-description"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">description</span>, </span><span class="parameter" id="-param-action"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">action</span>, </span><span class="parameter" id="-param-background"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">background</span>, </span><span class="parameter" id="-param-slivers"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span>&gt;</span></span> <span class="parameter-name">slivers</span>, </span><span class="parameter" id="-param-leading"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">leading</span>, </span><span class="parameter" id="-param-trailing"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">trailing</span>}</span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../un_ui/UnArtPage/action">action</a></span>
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnArtPage/background">background</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> 
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnArtPage/description">description</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> 
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnArtPage/emoji">emoji</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/UnArtPage/leading">leading</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> 
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnArtPage/name">name</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> 
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
        ...
        <dt id="slivers" class="property">
  <span class="name"><a href="../un_ui/UnArtPage/slivers">slivers</a></span>
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnArtPage/trailing">trailing</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> 
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnArtPage/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">UnArtPage class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_ui/UnArtPage#constructors">Constructors</a></li>
          <li><a href="../un_ui/UnArtPage/UnArtPage.constructor">UnArtPage</a></li>


        <li class="section-title">
          <a href="../un_ui/UnArtPage#instance-properties">Properties</a>
        </li>
          <li><a href="../un_ui/UnArtPage/action">action</a></li>
          <li><a href="../un_ui/UnArtPage/background">background</a></li>
          <li><a href="../un_ui/UnArtPage/description">description</a></li>
          <li><a href="../un_ui/UnArtPage/emoji">emoji</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li><a href="../un_ui/UnArtPage/leading">leading</a></li>
          <li><a href="../un_ui/UnArtPage/name">name</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li><a href="../un_ui/UnArtPage/slivers">slivers</a></li>
          <li><a href="../un_ui/UnArtPage/trailing">trailing</a></li>

        <li class="section-title"><a href="../un_ui/UnArtPage#instance-methods">Methods</a></li>
          <li><a href="../un_ui/UnArtPage/build">build</a></li>
        ...
        <li class="section-title inherited"><a href="../un_ui/UnArtPage#operators">Operators</a></li>
