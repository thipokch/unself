...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">UnScaffold</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="UnScaffold" class="callable">
          <span class="name"><a href="../un_ui/UnScaffold/UnScaffold.constructor">UnScaffold</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-slivers"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span>&gt;</span></span> <span class="parameter-name">slivers</span>, </span><span class="parameter" id="-param-controller"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/ScrollController-class.html">ScrollController</a>?</span> <span class="parameter-name">controller</span>, </span><span class="parameter" id="-param-physics"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/ScrollPhysics-class.html">ScrollPhysics</a>?</span> <span class="parameter-name">physics</span>}</span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../un_ui/UnScaffold/controller">controller</a></span>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">final</span><span class="feature">inherited</span></div>
        ...
        <dt id="physics" class="property">
  <span class="name"><a href="../un_ui/UnScaffold/physics">physics</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/ScrollPhysics-class.html">ScrollPhysics</a>?</span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/UnScaffold/slivers">slivers</a></span>
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnScaffold/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">UnScaffold class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_ui/UnScaffold#constructors">Constructors</a></li>
          <li><a href="../un_ui/UnScaffold/UnScaffold.constructor">UnScaffold</a></li>


        <li class="section-title">
          <a href="../un_ui/UnScaffold#instance-properties">Properties</a>
        </li>
          <li><a href="../un_ui/UnScaffold/controller">controller</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li><a href="../un_ui/UnScaffold/physics">physics</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li><a href="../un_ui/UnScaffold/slivers">slivers</a></li>

        <li class="section-title"><a href="../un_ui/UnScaffold#instance-methods">Methods</a></li>
          <li><a href="../un_ui/UnScaffold/build">build</a></li>
        ...
        <li class="section-title inherited"><a href="../un_ui/UnScaffold#operators">Operators</a></li>
