...
<span class="name ">updateShouldNotify</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="updateShouldNotify-param-oldWidget"><span>covariant</span> <span class="type-annotation"><a href="../../un_ui/NavigationContext">NavigationContext</a></span> <span class="parameter-name">oldWidget</span></span></li>
</ol>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">updateShouldNotify method</li>
    ...
    <ol>
        ...
        <li class="section-title"><a href="../../un_ui/NavigationContext#constructors">Constructors</a></li>
          <li><a href="../../un_ui/NavigationContext/NavigationContext.constructor">NavigationContext</a></li>


        <li class="section-title">
          <a href="../../un_ui/NavigationContext#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/ProxyWidget/child.html">child</a></li>
          <li><a href="../../un_ui/NavigationContext/exit">exit</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../../un_ui/NavigationContext#instance-methods">Methods</a></li>
          ...
          <li><a href="../../un_ui/NavigationContext/updateShouldNotify">updateShouldNotify</a></li>

        <li class="section-title inherited"><a href="../../un_ui/NavigationContext#operators">Operators</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/operator_equals.html">operator ==</a></li>



        <li class="section-title"><a href="../../un_ui/NavigationContext#static-methods">Static methods</a></li>
          <li><a href="../../un_ui/NavigationContext/of">of</a></li>
