...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">FloatContainer</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="FloatContainer" class="callable">
          <span class="name"><a href="../un_ui/FloatContainer/FloatContainer.constructor">FloatContainer</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-child"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">child</span>, </span><span class="parameter" id="-param-padding"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/painting/EdgeInsets-class.html">EdgeInsets</a>?</span> <span class="parameter-name">padding</span>}</span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../un_ui/FloatContainer/child">child</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/FloatContainer/padding">padding</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/FloatContainer/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">FloatContainer class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_ui/FloatContainer#constructors">Constructors</a></li>
          <li><a href="../un_ui/FloatContainer/FloatContainer.constructor">FloatContainer</a></li>


        <li class="section-title">
          <a href="../un_ui/FloatContainer#instance-properties">Properties</a>
        </li>
          <li><a href="../un_ui/FloatContainer/child">child</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li><a href="../un_ui/FloatContainer/padding">padding</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../un_ui/FloatContainer#instance-methods">Methods</a></li>
          <li><a href="../un_ui/FloatContainer/build">build</a></li>
        ...
        <li class="section-title inherited"><a href="../un_ui/FloatContainer#operators">Operators</a></li>
