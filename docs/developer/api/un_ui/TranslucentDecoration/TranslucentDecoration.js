  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="TranslucentDecoration" class="callable">
          <span class="name"><a href="../un_ui/TranslucentDecoration/TranslucentDecoration.constructor">TranslucentDecoration</a></span><span class="signature">(<span class="parameter" id="-param-color">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-ui/Color-class.html">Color</a>?</span> <span class="parameter-name">color</span>, </span><span class="parameter" id="-param-image"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/painting/DecorationImage-class.html">DecorationImage</a>?</span> <span class="parameter-name">image</span>, </span><span class="parameter" id="-param-border"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/painting/BoxBorder-class.html">BoxBorder</a>?</span> <span class="parameter-name">border</span>, </span><span class="parameter" id="-param-borderRadius"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/painting/BorderRadiusGeometry-class.html">BorderRadiusGeometry</a>?</span> <span class="parameter-name">borderRadius</span>, </span><span class="parameter" id="-param-boxShadow"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/painting/BoxShadow-class.html">BoxShadow</a></span>&gt;</span>?</span> <span class="parameter-name">boxShadow</span>, </span><span class="parameter" id="-param-gradient"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/painting/Gradient-class.html">Gradient</a>?</span> <span class="parameter-name">gradient</span>, </span><span class="parameter" id="-param-backgroundBlendMode"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-ui/BlendMode.html">BlendMode</a>?</span> <span class="parameter-name">backgroundBlendMode</span>, </span><span class="parameter" id="-param-shape"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/painting/BoxShape.html">BoxShape</a></span> <span class="parameter-name">shape</span> = <span class="default-value">BoxShape.rectangle</span>}</span>)</span>
        </dt>
        <dd>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_ui/TranslucentDecoration#constructors">Constructors</a></li>
          <li><a href="../un_ui/TranslucentDecoration/TranslucentDecoration.constructor">TranslucentDecoration</a></li>


        <li class="section-title inherited">
          <a href="../un_ui/TranslucentDecoration#instance-properties">Properties</a>
        </li>
        ...
        <li class="section-title"><a href="../un_ui/TranslucentDecoration#instance-methods">Methods</a></li>
          ...
          <li><a href="../un_ui/TranslucentDecoration/hitTest">hitTest</a></li>
        ...
        <li class="section-title inherited"><a href="../un_ui/TranslucentDecoration#operators">Operators</a></li>
