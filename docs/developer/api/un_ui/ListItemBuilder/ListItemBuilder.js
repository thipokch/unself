  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ListItemBuilder" class="callable">
          <span class="name"><a href="../un_ui/ListItemBuilder/ListItemBuilder.constructor">ListItemBuilder</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/ListItemBuilder/section">section</a></span><span class="signature">(<wbr><span class="parameter" id="section-param-text"><span class="type-annotation">dynamic</span> <span class="parameter-name">text</span></span>)
...
<dd>
  ...
  <span class="name"><a href="../un_ui/ListItemBuilder/tile">tile</a></span><span class="signature">(<wbr><span class="parameter" id="tile-param-entry"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/MapEntry-class.html">MapEntry</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">(<a href="https://api.flutter.dev/flutter/dart-async/FutureOr-class.html">FutureOr</a><span class="signature">&lt;<wbr><span class="type-parameter">void</span>&gt;</span> Function<span class="signature">()</span>?)</span>&gt;</span></span> <span class="parameter-name">entry</span></span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span>
  </span>
