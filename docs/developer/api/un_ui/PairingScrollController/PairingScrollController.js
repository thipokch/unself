  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="PairingScrollController" class="callable">
          <span class="name"><a href="../un_ui/PairingScrollController/PairingScrollController.constructor">PairingScrollController</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-group"><span>required</span> <span class="type-annotation"><a href="../un_ui/PairingScrollControllerGroup">PairingScrollControllerGroup</a></span> <span class="parameter-name">group</span>, </span><span class="parameter" id="-param-child"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> <span class="parameter-name">child</span>}</span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/PairingScrollController/group">group</a></span>
  <span class="signature">→ <a href="../un_ui/PairingScrollControllerGroup">PairingScrollControllerGroup</a></span> 
...
children.
  ...
  <span class="name"><a href="../un_ui/PairingScrollController/debugFillProperties">debugFillProperties</a></span><span class="signature">(<wbr><span class="parameter" id="debugFillProperties-param-properties"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/DiagnosticPropertiesBuilder-class.html">DiagnosticPropertiesBuilder</a></span> <span class="parameter-name">properties</span></span>)
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/PairingScrollController/updateShouldNotify">updateShouldNotify</a></span><span class="signature">(<wbr><span class="parameter" id="updateShouldNotify-param-oldWidget"><span>covariant</span> <span class="type-annotation"><a href="../un_ui/PairingScrollController">PairingScrollController</a></span> <span class="parameter-name">oldWidget</span></span>)
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/PairingScrollController/of">of</a></span><span class="signature">(<wbr><span class="parameter" id="of-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
    <span class="returntype parameter">→ <a href="../un_ui/PairingScrollControllerGroup">PairingScrollControllerGroup</a>?</span>
  </span>
