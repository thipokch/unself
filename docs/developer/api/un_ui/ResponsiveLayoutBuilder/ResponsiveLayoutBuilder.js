...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ResponsiveLayoutBuilder</span> class 
...
various responsive breakpoints.</p>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ResponsiveLayoutBuilder" class="callable">
          <span class="name"><a href="../un_ui/ResponsiveLayoutBuilder/ResponsiveLayoutBuilder.constructor">ResponsiveLayoutBuilder</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-small"><span>required</span> <span class="type-annotation"><a href="../un_ui/ResponsiveLayoutWidgetBuilder">ResponsiveLayoutWidgetBuilder</a></span> <span class="parameter-name">small</span>, </span><span class="parameter" id="-param-large"><span>required</span> <span class="type-annotation"><a href="../un_ui/ResponsiveLayoutWidgetBuilder">ResponsiveLayoutWidgetBuilder</a></span> <span class="parameter-name">large</span>, </span><span class="parameter" id="-param-medium"><span class="type-annotation"><a href="../un_ui/ResponsiveLayoutWidgetBuilder">ResponsiveLayoutWidgetBuilder</a>?</span> <span class="parameter-name">medium</span>, </span><span class="parameter" id="-param-xLarge"><span class="type-annotation"><a href="../un_ui/ResponsiveLayoutWidgetBuilder">ResponsiveLayoutWidgetBuilder</a>?</span> <span class="parameter-name">xLarge</span>, </span><span class="parameter" id="-param-child"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">child</span>}</span>)</span>
        </dt>
        <dd>
...
various responsive breakpoints.
  ...
  <span class="name"><a href="../un_ui/ResponsiveLayoutBuilder/child">child</a></span>
...
to the <code>small</code>, <code>large</code> and <code>xLarge</code>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/ResponsiveLayoutBuilder/large">large</a></span>
  <span class="signature">→ <a href="../un_ui/ResponsiveLayoutWidgetBuilder">ResponsiveLayoutWidgetBuilder</a></span> 

</dt>
<dd>
  <a href="../un_ui/ResponsiveLayoutWidgetBuilder">ResponsiveLayoutWidgetBuilder</a> for large layout.
  <div class="features"><span class="feature">final</span></div>

</dd>

        <dt id="medium" class="property">
  <span class="name"><a href="../un_ui/ResponsiveLayoutBuilder/medium">medium</a></span>
  <span class="signature">→ <a href="../un_ui/ResponsiveLayoutWidgetBuilder">ResponsiveLayoutWidgetBuilder</a>?</span> 

</dt>
<dd>
  <a href="../un_ui/ResponsiveLayoutWidgetBuilder">ResponsiveLayoutWidgetBuilder</a> for medium layout.
  <div class="features"><span class="feature">final</span></div>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
        ...
        <dt id="small" class="property">
  <span class="name"><a href="../un_ui/ResponsiveLayoutBuilder/small">small</a></span>
  <span class="signature">→ <a href="../un_ui/ResponsiveLayoutWidgetBuilder">ResponsiveLayoutWidgetBuilder</a></span> 

</dt>
<dd>
  <a href="../un_ui/ResponsiveLayoutWidgetBuilder">ResponsiveLayoutWidgetBuilder</a> for small layout.
  <div class="features"><span class="feature">final</span></div>

</dd>

        <dt id="xLarge" class="property">
  <span class="name"><a href="../un_ui/ResponsiveLayoutBuilder/xLarge">xLarge</a></span>
  <span class="signature">→ <a href="../un_ui/ResponsiveLayoutWidgetBuilder">ResponsiveLayoutWidgetBuilder</a>?</span> 

</dt>
<dd>
  <a href="../un_ui/ResponsiveLayoutWidgetBuilder">ResponsiveLayoutWidgetBuilder</a> for xLarge layout.
  <div class="features"><span class="feature">final</span></div>
  ...
  <span class="name"><a href="../un_ui/ResponsiveLayoutBuilder/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ResponsiveLayoutBuilder class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_ui/ResponsiveLayoutBuilder#constructors">Constructors</a></li>
          <li><a href="../un_ui/ResponsiveLayoutBuilder/ResponsiveLayoutBuilder.constructor">ResponsiveLayoutBuilder</a></li>


        <li class="section-title">
          <a href="../un_ui/ResponsiveLayoutBuilder#instance-properties">Properties</a>
        </li>
          <li><a href="../un_ui/ResponsiveLayoutBuilder/child">child</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li><a href="../un_ui/ResponsiveLayoutBuilder/large">large</a></li>
          <li><a href="../un_ui/ResponsiveLayoutBuilder/medium">medium</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li><a href="../un_ui/ResponsiveLayoutBuilder/small">small</a></li>
          <li><a href="../un_ui/ResponsiveLayoutBuilder/xLarge">xLarge</a></li>

        <li class="section-title"><a href="../un_ui/ResponsiveLayoutBuilder#instance-methods">Methods</a></li>
          <li><a href="../un_ui/ResponsiveLayoutBuilder/build">build</a></li>
        ...
        <li class="section-title inherited"><a href="../un_ui/ResponsiveLayoutBuilder#operators">Operators</a></li>
