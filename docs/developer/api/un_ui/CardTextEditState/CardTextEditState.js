  ...
  <dd>
    <ul class="gt-separated dark clazz-relationships">
      <li><a href="https://api.flutter.dev/flutter/dart-core/Object-class.html">Object</a></li>
        <li><a href="https://api.flutter.dev/flutter/widgets/State-class.html">State</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../un_ui/CardTextEdit">CardTextEdit</a></span>&gt;</span></li>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="CardTextEditState" class="callable">
          <span class="name"><a href="../un_ui/CardTextEditState/CardTextEditState.constructor">CardTextEditState</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/CardTextEditState/controller">controller</a></span>
...
<dd class="inherited">
  ...
  <span class="signature">→ <a href="../un_ui/CardTextEdit">CardTextEdit</a></span> 
...
removed via <a href="https://api.flutter.dev/flutter/widgets/State/deactivate.html">deactivate</a>.
  ...
  <span class="name"><a href="../un_ui/CardTextEditState/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<dd class="inherited">
  ...
  <span class="name"><a href="https://api.flutter.dev/flutter/widgets/State/didUpdateWidget.html">didUpdateWidget</a></span><span class="signature">(<wbr><span class="parameter" id="didUpdateWidget-param-oldWidget"><span>covariant</span> <span class="type-annotation"><a href="../un_ui/CardTextEdit">CardTextEdit</a></span> <span class="parameter-name">oldWidget</span></span>)
    <span class="returntype parameter">→ void</span>
  </span>
