...
<h1><span class="kind-class">ButtonAction</span> class 
  ...
  <span class="name"><a href="../un_ui/ButtonAction/action">action</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/ButtonAction/onPressed">onPressed</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/ButtonAction/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_ui/ButtonAction#constructors">Constructors</a></li>
          <li><a href="../un_ui/ButtonAction/ButtonAction.constructor">ButtonAction</a></li>


        <li class="section-title">
          <a href="../un_ui/ButtonAction#instance-properties">Properties</a>
        </li>
          <li><a href="../un_ui/ButtonAction/action">action</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li><a href="../un_ui/ButtonAction/onPressed">onPressed</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../un_ui/ButtonAction#instance-methods">Methods</a></li>
          <li><a href="../un_ui/ButtonAction/build">build</a></li>
        ...
        <li class="section-title inherited"><a href="../un_ui/ButtonAction#operators">Operators</a></li>
