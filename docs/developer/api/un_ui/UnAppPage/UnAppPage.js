...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">UnAppPage</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="UnAppPage" class="callable">
          <span class="name"><a href="../un_ui/UnAppPage/UnAppPage.constructor">UnAppPage</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-name"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> <span class="parameter-name">name</span>, </span><span class="parameter" id="-param-description"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">description</span>, </span><span class="parameter" id="-param-slivers"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span>&gt;</span></span> <span class="parameter-name">slivers</span>, </span><span class="parameter" id="-param-implyLeading"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/bool-class.html">bool</a></span> <span class="parameter-name">implyLeading</span> = <span class="default-value">true</span>, </span><span class="parameter" id="-param-leading"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">leading</span>, </span><span class="parameter" id="-param-trailing"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">trailing</span>, </span><span class="parameter" id="-param-isImmersive"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/bool-class.html">bool</a></span> <span class="parameter-name">isImmersive</span> = <span class="default-value">false</span>}</span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../un_ui/UnAppPage/description">description</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/UnAppPage/implyLeading">implyLeading</a></span>
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnAppPage/isImmersive">isImmersive</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/bool-class.html">bool</a></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/UnAppPage/leading">leading</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> 
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnAppPage/name">name</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/UnAppPage/slivers">slivers</a></span>
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnAppPage/trailing">trailing</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> 
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnAppPage/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">UnAppPage class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_ui/UnAppPage#constructors">Constructors</a></li>
          <li><a href="../un_ui/UnAppPage/UnAppPage.constructor">UnAppPage</a></li>


        <li class="section-title">
          <a href="../un_ui/UnAppPage#instance-properties">Properties</a>
        </li>
          <li><a href="../un_ui/UnAppPage/description">description</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li><a href="../un_ui/UnAppPage/implyLeading">implyLeading</a></li>
          <li><a href="../un_ui/UnAppPage/isImmersive">isImmersive</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li><a href="../un_ui/UnAppPage/leading">leading</a></li>
          <li><a href="../un_ui/UnAppPage/name">name</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li><a href="../un_ui/UnAppPage/slivers">slivers</a></li>
          <li><a href="../un_ui/UnAppPage/trailing">trailing</a></li>

        <li class="section-title"><a href="../un_ui/UnAppPage#instance-methods">Methods</a></li>
          <li><a href="../un_ui/UnAppPage/build">build</a></li>
        ...
        <li class="section-title inherited"><a href="../un_ui/UnAppPage#operators">Operators</a></li>
