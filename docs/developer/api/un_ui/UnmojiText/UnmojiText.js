...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">UnmojiText</span> class 
...
<section class="desc markdown">
  <p>returns a widget with rendered text with twitter emojis</p>
</section>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="UnmojiText" class="callable">
          <span class="name"><a href="../un_ui/UnmojiText/UnmojiText.constructor">UnmojiText</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-text"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">text</span>, </span><span class="parameter" id="-param-style"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/painting/TextStyle-class.html">TextStyle</a>?</span> <span class="parameter-name">style</span>, </span><span class="parameter" id="-param-maxLines"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/int-class.html">int</a>?</span> <span class="parameter-name">maxLines</span>, </span><span class="parameter" id="-param-emojiFontMultiplier"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/double-class.html">double</a></span> <span class="parameter-name">emojiFontMultiplier</span> = <span class="default-value">1.0</span>, </span><span class="parameter" id="-param-twemojiFormat"><span class="type-annotation"><a href="../un_ui/UnmojiFormat">UnmojiFormat</a></span> <span class="parameter-name">twemojiFormat</span> = <span class="default-value">UnmojiFormat.svg</span>}</span>)</span>
        </dt>
        <dd>
    ...
    <section class="summary offset-anchor" id="instance-properties">
      ...
      <dl class="properties">
        <dt id="emojiFontMultiplier" class="property">
  <span class="name"><a href="../un_ui/UnmojiText/emojiFontMultiplier">emojiFontMultiplier</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/UnmojiText/maxLines">maxLines</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/int-class.html">int</a>?</span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/UnmojiText/style">style</a></span>
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnmojiText/text">text</a></span>
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnmojiText/twemojiFormat">twemojiFormat</a></span>
  <span class="signature">→ <a href="../un_ui/UnmojiFormat">UnmojiFormat</a></span> 

</dt>
<dd>
  The format of the emoji image it can be <a href="../un_ui/UnmojiFormat">UnmojiFormat.webp</a>
72*72 png or <a href="../un_ui/UnmojiFormat">UnmojiFormat.svg</a> svg by default.
  <div class="features"><span class="feature">final</span></div>
  ...
  <span class="name"><a href="../un_ui/UnmojiText/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">UnmojiText class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_ui/UnmojiText#constructors">Constructors</a></li>
          <li><a href="../un_ui/UnmojiText/UnmojiText.constructor">UnmojiText</a></li>


        <li class="section-title">
          <a href="../un_ui/UnmojiText#instance-properties">Properties</a>
        </li>
          <li><a href="../un_ui/UnmojiText/emojiFontMultiplier">emojiFontMultiplier</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li><a href="../un_ui/UnmojiText/maxLines">maxLines</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li><a href="../un_ui/UnmojiText/style">style</a></li>
          <li><a href="../un_ui/UnmojiText/text">text</a></li>
          <li><a href="../un_ui/UnmojiText/twemojiFormat">twemojiFormat</a></li>

        <li class="section-title"><a href="../un_ui/UnmojiText#instance-methods">Methods</a></li>
          <li><a href="../un_ui/UnmojiText/build">build</a></li>
        ...
        <li class="section-title inherited"><a href="../un_ui/UnmojiText#operators">Operators</a></li>
