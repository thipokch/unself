...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">UnSliverAppBar</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="UnSliverAppBar" class="callable">
          <span class="name"><a href="../un_ui/UnSliverAppBar/UnSliverAppBar.constructor">UnSliverAppBar</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>, </span><span class="parameter" id="-param-emoji"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a>?</span> <span class="parameter-name">emoji</span>, </span><span class="parameter" id="-param-title"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> <span class="parameter-name">title</span>, </span><span class="parameter" id="-param-description"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">description</span>, </span><span class="parameter" id="-param-implyLeading"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/bool-class.html">bool</a></span> <span class="parameter-name">implyLeading</span> = <span class="default-value">true</span>, </span><span class="parameter" id="-param-leading"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">leading</span>, </span><span class="parameter" id="-param-trailing"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> <span class="parameter-name">trailing</span>, </span><span class="parameter" id="-param-isImmersive"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/bool-class.html">bool</a></span> <span class="parameter-name">isImmersive</span> = <span class="default-value">false</span>, </span><span class="parameter" id="-param-isCollapseCentered"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/bool-class.html">bool</a></span> <span class="parameter-name">isCollapseCentered</span> = <span class="default-value">true</span>}</span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../un_ui/UnSliverAppBar/description">description</a></span>
...
<dd>
  ...
  <div class="features"><span class="feature">final</span></div>
        ...
        <dt id="emoji" class="property">
  <span class="name"><a href="../un_ui/UnSliverAppBar/emoji">emoji</a></span>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
        ...
        <dt id="implyLeading" class="property">
  <span class="name"><a href="../un_ui/UnSliverAppBar/implyLeading">implyLeading</a></span>
...
<dd>
  ...
  <div class="features"><span class="feature">final</span></div>
        ...
        <dt id="isCollapseCentered" class="property">
  <span class="name"><a href="../un_ui/UnSliverAppBar/isCollapseCentered">isCollapseCentered</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/bool-class.html">bool</a></span> 
...
<dd>
  ...
  <div class="features"><span class="feature">final</span></div>
        ...
        <dt id="isImmersive" class="property">
  <span class="name"><a href="../un_ui/UnSliverAppBar/isImmersive">isImmersive</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/bool-class.html">bool</a></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/UnSliverAppBar/leading">leading</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/UnSliverAppBar/title">title</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> 
...
<dd>
  ...
  <span class="name"><a href="../un_ui/UnSliverAppBar/trailing">trailing</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a>?</span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_ui/UnSliverAppBar/createState">createState</a></span><span class="signature">(<wbr>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/widgets/State-class.html">State</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../un_ui/UnSliverAppBar">UnSliverAppBar</a></span>&gt;</span></span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">UnSliverAppBar class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_ui/UnSliverAppBar#constructors">Constructors</a></li>
          <li><a href="../un_ui/UnSliverAppBar/UnSliverAppBar.constructor">UnSliverAppBar</a></li>


        <li class="section-title">
          <a href="../un_ui/UnSliverAppBar#instance-properties">Properties</a>
        </li>
          <li><a href="../un_ui/UnSliverAppBar/description">description</a></li>
          <li><a href="../un_ui/UnSliverAppBar/emoji">emoji</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li><a href="../un_ui/UnSliverAppBar/implyLeading">implyLeading</a></li>
          <li><a href="../un_ui/UnSliverAppBar/isCollapseCentered">isCollapseCentered</a></li>
          <li><a href="../un_ui/UnSliverAppBar/isImmersive">isImmersive</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li><a href="../un_ui/UnSliverAppBar/leading">leading</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li><a href="../un_ui/UnSliverAppBar/title">title</a></li>
          <li><a href="../un_ui/UnSliverAppBar/trailing">trailing</a></li>

        <li class="section-title"><a href="../un_ui/UnSliverAppBar#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/StatefulWidget/createElement.html">createElement</a></li>
          <li><a href="../un_ui/UnSliverAppBar/createState">createState</a></li>
        ...
        <li class="section-title inherited"><a href="../un_ui/UnSliverAppBar#operators">Operators</a></li>
