  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="AppInfoView" class="callable">
          <span class="name"><a href="../un_app_info/AppInfoView/AppInfoView.constructor">AppInfoView</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>}</span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_app_info/AppInfoView/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_app_info/AppInfoView#constructors">Constructors</a></li>
          <li><a href="../un_app_info/AppInfoView/AppInfoView.constructor">AppInfoView</a></li>


        <li class="section-title inherited">
          <a href="../un_app_info/AppInfoView#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../un_app_info/AppInfoView#instance-methods">Methods</a></li>
          <li><a href="../un_app_info/AppInfoView/build">build</a></li>
        ...
        <li class="section-title inherited"><a href="../un_app_info/AppInfoView#operators">Operators</a></li>
