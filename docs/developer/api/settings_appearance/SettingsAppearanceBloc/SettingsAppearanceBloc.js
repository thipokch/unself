  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="SettingsAppearanceBloc" class="callable">
          <span class="name"><a href="../settings_appearance/SettingsAppearanceBloc/SettingsAppearanceBloc.constructor">SettingsAppearanceBloc</a></span><span class="signature">(<span class="parameter" id="-param-analyticService">{<span>required</span> <span class="type-annotation">AnalyticService?</span> <span class="parameter-name">analyticService</span>, </span><span class="parameter" id="-param-userRepository"><span>required</span> <span class="type-annotation">UserRepository</span> <span class="parameter-name">userRepository</span>}</span>)</span>
        </dt>
        <dd>
