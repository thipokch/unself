...
<li><span class="parameter" id="-param-userRepository"><span>required</span> <span class="type-annotation">UserRepository</span> <span class="parameter-name">userRepository</span>}</span></li>
</ol>)
    </section>
