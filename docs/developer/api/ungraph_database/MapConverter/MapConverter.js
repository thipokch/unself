  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="MapConverter" class="callable">
          <span class="name"><a href="../ungraph_database/MapConverter/MapConverter.constructor">MapConverter</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_database/MapConverter/fromSql">fromSql</a></span><span class="signature">(<wbr><span class="parameter" id="fromSql-param-fromDb"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">fromDb</span></span>)
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_database/MapConverter/toSql">toSql</a></span><span class="signature">(<wbr><span class="parameter" id="toSql-param-value"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">T</span>&gt;</span></span> <span class="parameter-name">value</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../ungraph_database/MapConverter#constructors">Constructors</a></li>
          <li><a href="../ungraph_database/MapConverter/MapConverter.constructor">MapConverter</a></li>


        <li class="section-title inherited">
          <a href="../ungraph_database/MapConverter#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../ungraph_database/MapConverter#instance-methods">Methods</a></li>
          <li><a href="../ungraph_database/MapConverter/fromSql">fromSql</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li><a href="../ungraph_database/MapConverter/toSql">toSql</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../ungraph_database/MapConverter#operators">Operators</a></li>
