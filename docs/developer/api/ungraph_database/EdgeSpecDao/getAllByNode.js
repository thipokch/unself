...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">getAllByNode</span> method 
...
<span class="name ">getAllByNode</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="getAllByNode-param-slug"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">slug</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Future&lt;List&lt;String&gt;&gt; getAllByNode(String slug) {
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">getAllByNode method</li>
</ol>
