...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-property">nodeSpec</span> property 
...
<section class="multi-line-signature">
  ...
  <span class="returntype"><a href="../../ungraph_database/\$NodeSpecTable">\$NodeSpecTable</a></span>
  <span class="name ">nodeSpec</span>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">\$NodeSpecTable get nodeSpec =&gt; attachedDatabase.nodeSpec;</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">nodeSpec property</li>
</ol>
