...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">putAll</span> method 
...
<span class="name ">putAll</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="putAll-param-entities"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Iterable-class.html">Iterable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://pub.dev/documentation/drift/2.6.0/drift/Insertable-class.html">Insertable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../../ungraph_database/EdgeSpecData">EdgeSpecData</a></span>&gt;</span></span>&gt;</span></span> <span class="parameter-name">entities</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Future&lt;void&gt; putAll(Iterable&lt;Insertable&lt;EdgeSpecData&gt;&gt; entities) =&gt;
    batch((batch) =&gt; batch.insertAll(edgeSpec, entities,
        mode: InsertMode.insertOrReplace));</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">putAll method</li>
</ol>


    <h5>EdgeSpecDao class</h5>
    <ol>
