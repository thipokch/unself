...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">putIfAbsent</span> method 
...
<span class="returntype"><a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../../ungraph_database/NodeSpecData">NodeSpecData</a></span>&gt;</span></span>
<span class="name ">putIfAbsent</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="putIfAbsent-param-entity"><span class="type-annotation"><a href="https://pub.dev/documentation/drift/2.6.0/drift/Insertable-class.html">Insertable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../../ungraph_database/NodeSpecData">NodeSpecData</a></span>&gt;</span></span> <span class="parameter-name">entity</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Future&lt;NodeSpecData&gt; putIfAbsent(Insertable&lt;NodeSpecData&gt; entity) =&gt;
    into(nodeSpec).insertReturning(entity, mode: InsertMode.insertOrIgnore);</code></pre>
</section>
