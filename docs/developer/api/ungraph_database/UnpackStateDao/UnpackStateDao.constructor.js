...
<h1><span class="kind-constructor">UnpackStateDao</span> constructor 
    ...
    <section class="multi-line-signature">
      ...
      <span class="name ">UnpackStateDao</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="-param-attachedDatabase"><span class="type-annotation"><a href="../../ungraph_database/UngraphDatabase">UngraphDatabase</a></span> <span class="parameter-name">attachedDatabase</span></span></li>
</ol>)
    </section>
