...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">\$UnpackSpecTable</span> class 
  ...
  <dd>
    <ul class="comma-separated clazz-relationships">
        <li><a href="https://pub.dev/documentation/drift/2.6.0/drift/TableInfo-mixin.html">TableInfo</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../ungraph_database/\$UnpackSpecTable">\$UnpackSpecTable</a></span>, <span class="type-parameter"><a href="../ungraph_database/UnpackSpecData">UnpackSpecData</a></span>&gt;</span></li>
    </ul>
  </dd>
  ...
  <span class="name"><a href="../ungraph_database/\$UnpackSpecTable/\$columns">\$columns</a></span>
...
<dd>
  ...
  <span class="name"><a href="../ungraph_database/\$UnpackSpecTable/\$primaryKey">\$primaryKey</a></span>
...
been specified.
  ...
  <span class="name"><a href="../ungraph_database/\$UnpackSpecTable/actualTableName">actualTableName</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 

</dt>
<dd>
  The name of the table in the database. Unlike <a href="../ungraph_database/\$UnpackSpecTable/aliasedName">aliasedName</a>, this can not
be aliased.
  <div class="features"><span class="feature">read-only</span><span class="feature">override</span></div>
  ...
  <span class="name"><a href="../ungraph_database/\$UnpackSpecTable/aliasedName">aliasedName</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 
...
<a href="https://pub.dev/documentation/drift/2.6.0/drift/TableInfo-mixin.html">TableInfo</a> and <code>Tbl</code> and can thus just return their instance.
  ...
  <span class="name"><a href="../ungraph_database/\$UnpackSpecTable/attachedDatabase">attachedDatabase</a></span>
...
<dd class="inherited">
  Gets all <a href="../ungraph_database/\$UnpackSpecTable/\$columns">\$columns</a> in this table or view, indexed by their (non-escaped)
name.
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_database/\$UnpackSpecTable/fileSpec">fileSpec</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_database/\$UnpackSpecTable/id">id</a></span>
  <span class="signature">→ <a href="https://pub.dev/documentation/drift/2.6.0/drift/GeneratedColumn-class.html">GeneratedColumn</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>&gt;</span></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_database/\$UnpackSpecTable/modules">modules</a></span>
  <span class="signature">→ <a href="https://pub.dev/documentation/drift/2.6.0/drift/GeneratedColumn-class.html">GeneratedColumn</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>&gt;</span></span> 
...
<dd>
  ...
  <span class="name"><a href="../ungraph_database/\$UnpackSpecTable/name">name</a></span>
  <span class="signature">→ <a href="https://pub.dev/documentation/drift/2.6.0/drift/GeneratedColumn-class.html">GeneratedColumn</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>&gt;</span></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_database/\$UnpackSpecTable/retrieveSpec">retrieveSpec</a></span>
  <span class="signature">→ <a href="https://pub.dev/documentation/drift/2.6.0/drift/GeneratedColumn-class.html">GeneratedColumn</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>&gt;</span></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_database/\$UnpackSpecTable/slug">slug</a></span>
  <span class="signature">→ <a href="https://pub.dev/documentation/drift/2.6.0/drift/GeneratedColumn-class.html">GeneratedColumn</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>&gt;</span></span> 
...
Example (inside the body of a table class):
  ...
  <span class="name"><a href="../ungraph_database/\$UnpackSpecTable/createAlias">createAlias</a></span><span class="signature">(<wbr><span class="parameter" id="createAlias-param-alias"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">alias</span></span>)
    <span class="returntype parameter">→ <a href="../ungraph_database/\$UnpackSpecTable">\$UnpackSpecTable</a></span>
  </span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_database/\$UnpackSpecTable/map">map</a></span><span class="signature">(<wbr><span class="parameter" id="map-param-data"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">data</span>, </span><span class="parameter" id="map-param-tablePrefix">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a>?</span> <span class="parameter-name">tablePrefix</span>}</span>)
    <span class="returntype parameter">→ <a href="../ungraph_database/UnpackSpecData">UnpackSpecData</a></span>
  </span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_database/\$UnpackSpecTable/validateIntegrity">validateIntegrity</a></span><span class="signature">(<wbr><span class="parameter" id="validateIntegrity-param-instance"><span class="type-annotation"><a href="https://pub.dev/documentation/drift/2.6.0/drift/Insertable-class.html">Insertable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../ungraph_database/UnpackSpecData">UnpackSpecData</a></span>&gt;</span></span> <span class="parameter-name">instance</span>, </span><span class="parameter" id="validateIntegrity-param-isInserting">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/bool-class.html">bool</a></span> <span class="parameter-name">isInserting</span> = <span class="default-value">false</span>}</span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">\$UnpackSpecTable class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../ungraph_database/\$UnpackSpecTable#constructors">Constructors</a></li>
          <li><a href="../ungraph_database/\$UnpackSpecTable/\$UnpackSpecTable.constructor">\$UnpackSpecTable</a></li>


        <li class="section-title">
          <a href="../ungraph_database/\$UnpackSpecTable#instance-properties">Properties</a>
        </li>
          <li><a href="../ungraph_database/\$UnpackSpecTable/\$columns">\$columns</a></li>
          <li><a href="../ungraph_database/\$UnpackSpecTable/\$primaryKey">\$primaryKey</a></li>
          <li><a href="../ungraph_database/\$UnpackSpecTable/actualTableName">actualTableName</a></li>
          <li><a href="../ungraph_database/\$UnpackSpecTable/aliasedName">aliasedName</a></li>
          <li class="inherited"><a href="https://pub.dev/documentation/drift/2.6.0/drift/TableInfo/asDslTable.html">asDslTable</a></li>
          <li><a href="../ungraph_database/\$UnpackSpecTable/attachedDatabase">attachedDatabase</a></li>
          ...
          <li><a href="../ungraph_database/\$UnpackSpecTable/fileSpec">fileSpec</a></li>
          <li class="inherited"><a href="https://pub.dev/documentation/drift/2.6.0/drift/TableInfo/hashCode.html">hashCode</a></li>
          <li><a href="../ungraph_database/\$UnpackSpecTable/id">id</a></li>
          <li class="inherited"><a href="https://pub.dev/documentation/drift/2.6.0/drift/Table/isStrict.html">isStrict</a></li>
          <li><a href="../ungraph_database/\$UnpackSpecTable/modules">modules</a></li>
          <li><a href="../ungraph_database/\$UnpackSpecTable/name">name</a></li>
          <li class="inherited"><a href="https://pub.dev/documentation/drift/2.6.0/drift/TableInfo/primaryKey.html">primaryKey</a></li>
          <li><a href="../ungraph_database/\$UnpackSpecTable/retrieveSpec">retrieveSpec</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li><a href="../ungraph_database/\$UnpackSpecTable/slug">slug</a></li>
        ...
        <li class="section-title"><a href="../ungraph_database/\$UnpackSpecTable#instance-methods">Methods</a></li>
          ...
          <li><a href="../ungraph_database/\$UnpackSpecTable/createAlias">createAlias</a></li>
          ...
          <li><a href="../ungraph_database/\$UnpackSpecTable/map">map</a></li>
          ...
          <li><a href="../ungraph_database/\$UnpackSpecTable/validateIntegrity">validateIntegrity</a></li>

        <li class="section-title inherited"><a href="../ungraph_database/\$UnpackSpecTable#operators">Operators</a></li>
