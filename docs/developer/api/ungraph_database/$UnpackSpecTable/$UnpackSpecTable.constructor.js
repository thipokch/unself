...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-constructor">\$UnpackSpecTable</span> constructor 
    <a href="https://dart.dev/null-safety" class="feature feature-null-safety" title="Supports the null safety language feature.">Null safety</a>
</h1></div>

    <section class="multi-line-signature">
      
      <span class="name ">\$UnpackSpecTable</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="-param-attachedDatabase"><span class="type-annotation"><a href="https://pub.dev/documentation/drift/2.6.0/drift/GeneratedDatabase-class.html">GeneratedDatabase</a></span> <span class="parameter-name">attachedDatabase</span>, </span></li>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">\$UnpackSpecTable(this.attachedDatabase, [this._alias]);</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">\$UnpackSpecTable constructor</li>
</ol>
