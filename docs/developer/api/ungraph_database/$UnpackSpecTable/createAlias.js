...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">createAlias</span> method 
...
<span class="returntype"><a href="../../ungraph_database/\$UnpackSpecTable">\$UnpackSpecTable</a></span>
<span class="name ">createAlias</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="createAlias-param-alias"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">alias</span></span></li>
</ol>)
...
<section class="desc markdown">
  <p>Creates an alias of this table or view that will write the name <code>alias</code>
when used in a query.</p>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">createAlias method</li>
</ol>
