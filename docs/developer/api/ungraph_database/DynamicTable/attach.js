...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">attach</span> method 
...
<span class="name ">attach</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="attach-param-database"><span class="type-annotation"><a href="../../ungraph_database/UngraphDatabase">UngraphDatabase</a></span> <span class="parameter-name">database</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">void attach(UngraphDatabase database) =&gt; this._attachedDatabase = database;</code></pre>
</section>
