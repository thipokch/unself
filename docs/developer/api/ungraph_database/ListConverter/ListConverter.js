  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ListConverter" class="callable">
          <span class="name"><a href="../ungraph_database/ListConverter/ListConverter.constructor">ListConverter</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_database/ListConverter/fromSql">fromSql</a></span><span class="signature">(<wbr><span class="parameter" id="fromSql-param-fromDb"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">fromDb</span></span>)
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_database/ListConverter/toSql">toSql</a></span><span class="signature">(<wbr><span class="parameter" id="toSql-param-value"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter">T</span>&gt;</span></span> <span class="parameter-name">value</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../ungraph_database/ListConverter#constructors">Constructors</a></li>
          <li><a href="../ungraph_database/ListConverter/ListConverter.constructor">ListConverter</a></li>


        <li class="section-title inherited">
          <a href="../ungraph_database/ListConverter#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../ungraph_database/ListConverter#instance-methods">Methods</a></li>
          <li><a href="../ungraph_database/ListConverter/fromSql">fromSql</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li><a href="../ungraph_database/ListConverter/toSql">toSql</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../ungraph_database/ListConverter#operators">Operators</a></li>
