...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-constructor">EdgeDao</span> constructor 
    <a href="https://dart.dev/null-safety" class="feature feature-null-safety" title="Supports the null safety language feature.">Null safety</a>
</h1></div>

    <section class="multi-line-signature">
      
      <span class="name ">EdgeDao</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="-param-table"><span class="type-annotation"><a href="../../ungraph_database/EdgeTable">EdgeTable</a></span> <span class="parameter-name">table</span>, </span></li>
<li><span class="parameter" id="-param-db">[<span class="type-annotation"><a href="../../ungraph_database/UngraphDatabase">UngraphDatabase</a>?</span> <span class="parameter-name">db</span>]</span></li>
</ol>)
    </section>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">EdgeDao(this.table, [UngraphDatabase? db])
    : super(db ?? table.attachedDatabase);</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">EdgeDao constructor</li>
</ol>
