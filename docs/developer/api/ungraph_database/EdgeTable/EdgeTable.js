...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">EdgeTable</span> class 
  ...
  <dd>
    <ul class="gt-separated dark clazz-relationships">
      <li><a href="https://api.flutter.dev/flutter/dart-core/Object-class.html">Object</a></li>
        ...
        <li><a href="../ungraph_database/DynamicTable">DynamicTable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../ungraph_database/EdgeData">EdgeData</a></span>&gt;</span></li>
      <li>EdgeTable</li>
    </ul>
  </dd>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="EdgeTable" class="callable">
          <span class="name"><a href="../ungraph_database/EdgeTable/EdgeTable.constructor">EdgeTable</a></span><span class="signature">(<span class="parameter" id="-param-specId"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">specId</span>, </span><span class="parameter" id="-param-specSlug"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">specSlug</span>, </span><span class="parameter" id="-param-\$columns"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://pub.dev/documentation/drift/2.6.0/drift/GeneratedColumn-class.html">GeneratedColumn</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/Object-class.html">Object</a></span>&gt;</span></span>&gt;</span></span> <span class="parameter-name">\$columns</span>, </span><span class="parameter" id="-param-alias">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a>?</span> <span class="parameter-name">alias</span>, </span><span class="parameter" id="-param-attachedDatabase"><span class="type-annotation"><a href="../ungraph_database/UngraphDatabase">UngraphDatabase</a>?</span> <span class="parameter-name">attachedDatabase</span>}</span>)</span>
        </dt>
        <dd>
    ...
    <section class="summary offset-anchor" id="instance-properties">
      ...
      <dl class="properties">
        <dt id="\$columns" class="property inherited">
  <span class="name"><a href="../ungraph_database/DynamicTable/\$columns">\$columns</a></span>
...
been specified.
  ...
  <span class="name"><a href="../ungraph_database/EdgeTable/actualTableName">actualTableName</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 

</dt>
<dd>
  The name of the table in the database. Unlike <a href="../ungraph_database/DynamicTable/aliasedName">aliasedName</a>, this can not
be aliased.
  <div class="features"><span class="feature">read-only</span><span class="feature">override</span></div>

</dd>

        <dt id="aliasedName" class="property inherited">
  <span class="name"><a href="../ungraph_database/DynamicTable/aliasedName">aliasedName</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 
...
<dd class="inherited">
  ...
  <span class="signature">→ <a href="../ungraph_database/DynamicTable">DynamicTable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../ungraph_database/EdgeData">EdgeData</a></span>&gt;</span></span> 
...
<a href="https://pub.dev/documentation/drift/2.6.0/drift/TableInfo-mixin.html">TableInfo</a> and <code>Tbl</code> and can thus just return their instance.
  ...
  <span class="name"><a href="../ungraph_database/DynamicTable/attachedDatabase">attachedDatabase</a></span>
...
<dd class="inherited">
  Gets all <a href="../ungraph_database/DynamicTable/\$columns">\$columns</a> in this table or view, indexed by their (non-escaped)
name.
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_database/EdgeTable/specId">specId</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 
...
<dd>
  ...
  <div class="features"><span class="feature">final</span></div>
        ...
        <dt id="specSlug" class="property">
  <span class="name"><a href="../ungraph_database/EdgeTable/specSlug">specSlug</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 
...
statement. This is intended to be used by generated code only.
  ...
  <span class="name"><a href="../ungraph_database/DynamicTable/attach">attach</a></span><span class="signature">(<wbr><span class="parameter" id="attach-param-database"><span class="type-annotation"><a href="../ungraph_database/UngraphDatabase">UngraphDatabase</a></span> <span class="parameter-name">database</span></span>)
...
Example (inside the body of a table class):
  ...
  <span class="name"><a href="../ungraph_database/EdgeTable/createAlias">createAlias</a></span><span class="signature">(<wbr><span class="parameter" id="createAlias-param-alias"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">alias</span></span>)
    <span class="returntype parameter">→ <a href="../ungraph_database/EdgeTable">EdgeTable</a></span>
  </span>
...
when used in a query.
  <div class="features"><span class="feature">override</span></div>
        ...
        <dt id="createTable" class="callable inherited">
  <span class="name"><a href="../ungraph_database/DynamicTable/createTable">createTable</a></span><span class="signature">(<wbr>)
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_database/EdgeTable/map">map</a></span><span class="signature">(<wbr><span class="parameter" id="map-param-data"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">data</span>, </span><span class="parameter" id="map-param-tablePrefix">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a>?</span> <span class="parameter-name">tablePrefix</span>}</span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/FutureOr-class.html">FutureOr</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../ungraph_database/EdgeData">EdgeData</a></span>&gt;</span></span>
  </span>
...
<dd>
  ...
  <span class="name"><a href="https://pub.dev/documentation/drift/2.6.0/drift/TableInfo/mapFromCompanion.html">mapFromCompanion</a></span><span class="signature">(<wbr><span class="parameter" id="mapFromCompanion-param-companion"><span class="type-annotation"><a href="https://pub.dev/documentation/drift/2.6.0/drift/Insertable-class.html">Insertable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../ungraph_database/EdgeData">EdgeData</a></span>&gt;</span></span> <span class="parameter-name">companion</span>, </span><span class="parameter" id="mapFromCompanion-param-database"><span class="type-annotation"><a href="https://pub.dev/documentation/drift/2.6.0/drift/DatabaseConnectionUser-class.html">DatabaseConnectionUser</a></span> <span class="parameter-name">database</span></span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../ungraph_database/EdgeData">EdgeData</a></span>&gt;</span></span>
  </span>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">inherited</span></div>
        ...
        <dt id="validateIntegrity" class="callable inherited">
  <span class="name"><a href="https://pub.dev/documentation/drift/2.6.0/drift/TableInfo/validateIntegrity.html">validateIntegrity</a></span><span class="signature">(<wbr><span class="parameter" id="validateIntegrity-param-instance"><span class="type-annotation"><a href="https://pub.dev/documentation/drift/2.6.0/drift/Insertable-class.html">Insertable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../ungraph_database/EdgeData">EdgeData</a></span>&gt;</span></span> <span class="parameter-name">instance</span>, </span><span class="parameter" id="validateIntegrity-param-isInserting">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/bool-class.html">bool</a></span> <span class="parameter-name">isInserting</span> = <span class="default-value">false</span>}</span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">EdgeTable class</li>
</ol>
