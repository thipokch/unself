...
<span class="returntype"><a href="https://api.flutter.dev/flutter/dart-async/FutureOr-class.html">FutureOr</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../../ungraph_database/EdgeData">EdgeData</a></span>&gt;</span></span>
...
FutureOr&lt;EdgeData&gt; map(Map&lt;String, dynamic&gt; data, {String? tablePrefix}) =&gt;
    EdgeData(specSlug, data);</code></pre>
</section>
