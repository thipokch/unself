...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">DynamicDao</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="DynamicDao" class="callable">
          <span class="name"><a href="../ungraph_database/DynamicDao/DynamicDao.constructor">DynamicDao</a></span><span class="signature">(<span class="parameter" id="-param-attachedDatabase"><span class="type-annotation"><a href="../ungraph_database/UngraphDatabase">UngraphDatabase</a></span> <span class="parameter-name">attachedDatabase</span></span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_database/DynamicDao/table">table</a></span>
  <span class="signature">→ <a href="../ungraph_database/DynamicTable">DynamicTable</a></span> 
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">DynamicDao abstract class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../ungraph_database/DynamicDao#constructors">Constructors</a></li>
          <li><a href="../ungraph_database/DynamicDao/DynamicDao.constructor">DynamicDao</a></li>


        <li class="section-title">
          <a href="../ungraph_database/DynamicDao#instance-properties">Properties</a>
        </li>
          ...
          <li><a href="../ungraph_database/DynamicDao/table">table</a></li>
        ...
        <li class="section-title"><a href="../ungraph_database/DynamicDao#instance-methods">Methods</a></li>
          ...
          <li><a href="../ungraph_database/DynamicDao/createTable">createTable</a></li>
        ...
        <li class="section-title inherited"><a href="../ungraph_database/DynamicDao#operators">Operators</a></li>
