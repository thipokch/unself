...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">createTable</span> method 
...
<span class="name ">createTable</span>(<wbr>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Future&lt;void&gt; createTable() async =&gt;
    // ignore: invalid_use_of_visible_for_testing_member, invalid_use_of_protected_member
    await attachedDatabase.createMigrator().createTable(table);</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">createTable method</li>
</ol>
