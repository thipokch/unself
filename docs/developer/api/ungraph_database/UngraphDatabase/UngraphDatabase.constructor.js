...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-constructor">UngraphDatabase</span> constructor 
    <a href="https://dart.dev/null-safety" class="feature feature-null-safety" title="Supports the null safety language feature.">Null safety</a>
</h1></div>

    <section class="multi-line-signature">
      
      <span class="name ">UngraphDatabase</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="-param-qe">[<span class="type-annotation"><a href="https://pub.dev/documentation/drift/2.6.0/backends/QueryExecutor-class.html">QueryExecutor</a>?</span> <span class="parameter-name">qe</span>]</span></li>
</ol>)
    </section>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">UngraphDatabase([QueryExecutor? qe]) : super(qe ?? connect().executor);</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">UngraphDatabase constructor</li>
</ol>
