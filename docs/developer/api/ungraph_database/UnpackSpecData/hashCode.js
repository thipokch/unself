...
that affects <a href="../../ungraph_database/UnpackSpecData/operator_equals">operator ==</a> comparisons.</p>
...
the same way as the default <a href="../../ungraph_database/UnpackSpecData/operator_equals">operator ==</a> implementation only considers objects
...
<p>If <a href="../../ungraph_database/UnpackSpecData/operator_equals">operator ==</a> is overridden to use the object state instead,
...
according to <a href="../../ungraph_database/UnpackSpecData/operator_equals">operator ==</a>.
...
<p>If a subclass overrides <a href="../../ungraph_database/UnpackSpecData/hashCode">hashCode</a>, it should override the
<a href="../../ungraph_database/UnpackSpecData/operator_equals">operator ==</a> operator as well to maintain consistency.</p>
</section>
...
int get hashCode =&gt;
    Object.hash(id, slug, name, fileSpec, retrieveSpec, modules);</code></pre>
</section>
