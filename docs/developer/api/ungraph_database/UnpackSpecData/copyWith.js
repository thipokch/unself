...
<li><span class="parameter" id="copyWith-param-fileSpec"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a>?</span> <span class="parameter-name">fileSpec</span>, </span></li>
<li><span class="parameter" id="copyWith-param-retrieveSpec"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a>?</span> <span class="parameter-name">retrieveSpec</span>, </span></li>
<li><span class="parameter" id="copyWith-param-modules"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a>?</span> <span class="parameter-name">modules</span>}</span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">UnpackSpecData copyWith(
        {String? id,
        String? slug,
        String? name,
        String? fileSpec,
