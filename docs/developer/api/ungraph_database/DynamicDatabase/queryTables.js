...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">queryTables</span> method 
...
<span class="returntype"><a href="https://pub.dev/documentation/drift/2.6.0/drift/Selectable-class.html">Selectable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>&gt;</span></span>
<span class="name ">queryTables</span>(<wbr>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Selectable&lt;String&gt; queryTables() {
  return customSelect(
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">queryTables method</li>
</ol>
