...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">realTables</span> method 
...
<span class="name ">realTables</span>(<wbr>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Future&lt;Iterable&lt;String&gt;&gt; realTables() =&gt; queryTables().get();</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">realTables method</li>
</ol>
