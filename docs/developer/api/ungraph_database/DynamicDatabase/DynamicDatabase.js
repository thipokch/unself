...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">DynamicDatabase</span> class 
  ...
  <dd>
    <ul class="annotation-list clazz-relationships">
        <li>@<a href="https://pub.dev/documentation/drift/2.6.0/drift/DriftAccessor-class.html">DriftAccessor</a>(queries: DynamicDatabase.query)</li>
    </ul>
  </dd>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="DynamicDatabase" class="callable">
          <span class="name"><a href="../ungraph_database/DynamicDatabase/DynamicDatabase.constructor">DynamicDatabase</a></span><span class="signature">(<span class="parameter" id="-param-attachedDatabase"><span class="type-annotation"><a href="../ungraph_database/UngraphDatabase">UngraphDatabase</a></span> <span class="parameter-name">attachedDatabase</span></span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
        ...
        <dt id="staticTables" class="property">
  <span class="name"><a href="../ungraph_database/DynamicDatabase/staticTables">staticTables</a></span>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">inherited</span></div>
        ...
        <dt id="queryTables" class="callable inherited">
  <span class="name"><a href="../ungraph_database/DynamicDatabase/queryTables">queryTables</a></span><span class="signature">(<wbr>)
    <span class="returntype parameter">→ <a href="https://pub.dev/documentation/drift/2.6.0/drift/Selectable-class.html">Selectable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>&gt;</span></span>
  </span>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">inherited</span></div>
        ...
        <dt id="realTables" class="callable">
  <span class="name"><a href="../ungraph_database/DynamicDatabase/realTables">realTables</a></span><span class="signature">(<wbr>)
...
<code>table</code>'s columns.
  <div class="features"><span class="feature">inherited</span></div>
        ...
        <dt id="tables" class="callable">
  <span class="name"><a href="../ungraph_database/DynamicDatabase/tables">tables</a></span><span class="signature">(<wbr>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/Iterable-class.html">Iterable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>&gt;</span></span>&gt;</span></span>
  </span>
...
<dd class="inherited">
  ...
  <section class="summary offset-anchor" id="constants">
    ...
    <dl class="properties">
        <dt id="query" class="constant">
    <span class="name "><a href="../ungraph_database/DynamicDatabase/query-constant">query</a></span>
...
<dd>
    ...
    <div>
      <span class="signature"><code>{'queryTables' : '''
SELECT 
    name
FROM 
    sqlite_master
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">DynamicDatabase class</li>
</ol>
