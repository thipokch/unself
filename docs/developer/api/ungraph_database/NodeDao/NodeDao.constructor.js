...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-constructor">NodeDao</span> constructor 
    <a href="https://dart.dev/null-safety" class="feature feature-null-safety" title="Supports the null safety language feature.">Null safety</a>
</h1></div>

    <section class="multi-line-signature">
      
      <span class="name ">NodeDao</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="-param-table"><span class="type-annotation"><a href="../../ungraph_database/NodeTable">NodeTable</a></span> <span class="parameter-name">table</span>, </span></li>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">NodeDao(this.table, [UngraphDatabase? db])
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">NodeDao constructor</li>
</ol>
