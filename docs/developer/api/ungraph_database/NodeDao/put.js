...
<span class="returntype"><a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../../ungraph_database/NodeData">NodeData</a></span>&gt;</span></span>
<span class="name ">put</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="put-param-entity"><span class="type-annotation"><a href="https://pub.dev/documentation/drift/2.6.0/drift/Insertable-class.html">Insertable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../../ungraph_database/NodeData">NodeData</a></span>&gt;</span></span> <span class="parameter-name">entity</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Future&lt;NodeData&gt; put(Insertable&lt;NodeData&gt; entity) =&gt;
    into(table).insertReturning(entity, mode: InsertMode.insertOrReplace);</code></pre>
</section>
