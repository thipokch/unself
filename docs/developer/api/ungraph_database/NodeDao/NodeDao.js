...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">NodeDao</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="NodeDao" class="callable">
          <span class="name"><a href="../ungraph_database/NodeDao/NodeDao.constructor">NodeDao</a></span><span class="signature">(<span class="parameter" id="-param-table"><span class="type-annotation"><a href="../ungraph_database/NodeTable">NodeTable</a></span> <span class="parameter-name">table</span>, </span><span class="parameter" id="-param-db">[<span class="type-annotation"><a href="../ungraph_database/UngraphDatabase">UngraphDatabase</a>?</span> <span class="parameter-name">db</span>]</span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
        ...
        <dt id="table" class="property">
  <span class="name"><a href="../ungraph_database/NodeDao/table">table</a></span>
  <span class="signature">→ <a href="../ungraph_database/NodeTable">NodeTable</a></span> 
...
method should not be used directly.
  ...
  <span class="name"><a href="../ungraph_database/DynamicDao/createTable">createTable</a></span><span class="signature">(<wbr>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter">void</span>&gt;</span></span>
  </span>
...
already ready.
  ...
  <span class="name"><a href="../ungraph_database/NodeDao/getAll">getAll</a></span><span class="signature">(<wbr>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../ungraph_database/NodeData">NodeData</a></span>&gt;</span></span>&gt;</span></span>
  </span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_database/NodeDao/put">put</a></span><span class="signature">(<wbr><span class="parameter" id="put-param-entity"><span class="type-annotation"><a href="https://pub.dev/documentation/drift/2.6.0/drift/Insertable-class.html">Insertable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../ungraph_database/NodeData">NodeData</a></span>&gt;</span></span> <span class="parameter-name">entity</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">NodeDao class</li>
</ol>
