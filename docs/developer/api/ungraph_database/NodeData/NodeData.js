...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">NodeData</span> class 
  ...
  <dd>
    <ul class="gt-separated dark clazz-relationships">
      <li><a href="https://api.flutter.dev/flutter/dart-core/Object-class.html">Object</a></li>
        ...
        <li><a href="../ungraph_database/DynamicData">DynamicData</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../ungraph_database/NodeData">NodeData</a></span>&gt;</span></li>
      <li>NodeData</li>
    </ul>
  </dd>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="NodeData" class="callable">
          <span class="name"><a href="../ungraph_database/NodeData/NodeData.constructor">NodeData</a></span><span class="signature">(<span class="parameter" id="-param-specSlug"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">specSlug</span>, </span><span class="parameter" id="-param-data"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">data</span></span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_database/NodeData/specSlug">specSlug</a></span>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">inherited</span></div>
        ...
        <dt id="toColumns" class="callable inherited">
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">NodeData class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../ungraph_database/NodeData#constructors">Constructors</a></li>
          <li><a href="../ungraph_database/NodeData/NodeData.constructor">NodeData</a></li>


        <li class="section-title">
          <a href="../ungraph_database/NodeData#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="../ungraph_database/DynamicData/data">data</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li><a href="../ungraph_database/NodeData/specSlug">specSlug</a></li>

        <li class="section-title inherited"><a href="../ungraph_database/NodeData#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../ungraph_database/NodeData#operators">Operators</a></li>
