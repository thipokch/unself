...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ITransform&lt;<wbr><span class="type-parameter">I</span>, <span class="type-parameter">O</span>&gt;</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ITransform" class="callable">
          <span class="name"><a href="../unpack/ITransform/ITransform.constructor">ITransform</a></span><span class="signature">(<span class="parameter" id="-param-spec"><span class="type-annotation">TransformSpec</span> <span class="parameter-name">spec</span></span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unpack/ITransform/spec">spec</a></span>
  <span class="signature">→ TransformSpec</span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unpack/ITransform/transform">transform</a></span><span class="signature">(<wbr><span class="parameter" id="transform-param-data"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">I</span>&gt;</span></span> <span class="parameter-name">data</span></span>)
...
<dd class="inherited">
  ...
  <section class="summary offset-anchor" id="static-methods">
    ...
    <dl class="callables">
        <dt id="tranformer" class="callable">
  <span class="name"><a href="../unpack/ITransform/tranformer">tranformer</a></span><span class="signature">(<wbr><span class="parameter" id="tranformer-param-spec"><span class="type-annotation">TransformSpec</span> <span class="parameter-name">spec</span></span>)
    <span class="returntype parameter">→ <a href="../unpack/ITransform">ITransform</a></span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ITransform<span class="signature">&lt;<wbr><span class="type-parameter">I</span>, <span class="type-parameter">O</span>&gt;</span> abstract class</li>
</ol>
