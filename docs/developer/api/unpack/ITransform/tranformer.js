...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">tranformer</span> static method 
...
<span class="returntype"><a href="../../unpack/ITransform">ITransform</a></span>
<span class="name ">tranformer</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="tranformer-param-spec"><span class="type-annotation">TransformSpec</span> <span class="parameter-name">spec</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">static ITransform tranformer(TransformSpec spec) =&gt; spec.map(
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">tranformer static method</li>
</ol>
