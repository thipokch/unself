...
<span class="name ">normalize</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="normalize-param-entity"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">entity</span>, </span></li>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Map&lt;String, Iterable&gt; normalize(String entity, Map&lt;String, dynamic&gt; json) =&gt;
    normalizeWith(_find(entity), json);</code></pre>
</section>
