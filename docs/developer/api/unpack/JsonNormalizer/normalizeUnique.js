...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">normalizeUnique</span> method 
...
<span class="name ">normalizeUnique</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="normalizeUnique-param-entity"><span class="type-annotation">JsonSchema</span> <span class="parameter-name">entity</span>, </span></li>
<li><span class="parameter" id="normalizeUnique-param-json"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">json</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Map&lt;String, Iterable&gt; normalizeUnique(
  JsonSchema entity,
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">normalizeUnique method</li>
</ol>
