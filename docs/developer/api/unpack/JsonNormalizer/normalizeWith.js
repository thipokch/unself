...
<span class="name ">normalizeWith</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="normalizeWith-param-entity"><span class="type-annotation">JsonSchema</span> <span class="parameter-name">entity</span>, </span></li>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Map&lt;String, Iterable&gt; normalizeWith(
  JsonSchema entity,
