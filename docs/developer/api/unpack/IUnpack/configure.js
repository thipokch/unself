...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">configure</span> abstract method 
...
<span class="name ">configure</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="configure-param-selectedModules"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Iterable-class.html">Iterable</a><span class="signature">&lt;<wbr><span class="type-parameter">ModuleSpec</span>&gt;</span></span> <span class="parameter-name">selectedModules</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">FutureOr&lt;void&gt; configure(Iterable&lt;ModuleSpec&gt; selectedModules);</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">configure abstract method</li>
</ol>
