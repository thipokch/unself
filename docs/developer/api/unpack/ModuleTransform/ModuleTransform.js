...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ModuleTransform</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ModuleTransform" class="callable">
          <span class="name"><a href="../unpack/ModuleTransform/ModuleTransform.constructor">ModuleTransform</a></span><span class="signature">()</span>
        </dt>
        <dd>
        ...
        <dt id="ModuleTransform.fromJson" class="callable">
          <span class="name"><a href="../unpack/ModuleTransform/ModuleTransform.fromJson">ModuleTransform.fromJson</a></span><span class="signature">(<span class="parameter" id="fromJson-param-json"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">json</span></span>)</span>
        </dt>
        <dd>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ModuleTransform abstract class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unpack/ModuleTransform#constructors">Constructors</a></li>
          <li><a href="../unpack/ModuleTransform/ModuleTransform.constructor">ModuleTransform</a></li>
          <li><a href="../unpack/ModuleTransform/ModuleTransform.fromJson">fromJson</a></li>


        <li class="section-title inherited">
          <a href="../unpack/ModuleTransform#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li class="inherited"><a href="../unpack/ModuleState/step">step</a></li>

        <li class="section-title inherited"><a href="../unpack/ModuleTransform#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../unpack/ModuleTransform#operators">Operators</a></li>
