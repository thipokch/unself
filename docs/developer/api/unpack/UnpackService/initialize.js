...
<span class="name ">initialize</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="initialize-param-spec"><span class="type-annotation">UnpackSpec</span> <span class="parameter-name">spec</span></span></li>
</ol>)
...
Future&lt;String&gt; initialize(UnpackSpec spec) async =&gt;
    await _repo.putState(spec.initialState).then((_) =&gt; _.id!);</code></pre>
</section>
