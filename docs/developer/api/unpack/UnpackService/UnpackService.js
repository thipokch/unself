  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="UnpackService" class="callable">
          <span class="name"><a href="../unpack/UnpackService/UnpackService.constructor">UnpackService</a></span><span class="signature">(<span class="parameter" id="-param-repository">{<span>required</span> <span class="type-annotation">UnpackRepository</span> <span class="parameter-name">repository</span>}</span>)</span>
        </dt>
        <dd>
    ...
    <section class="summary offset-anchor" id="instance-properties">
      ...
      <dl class="properties">
        <dt id="activeInstances" class="property">
  <span class="name"><a href="../unpack/UnpackService/activeInstances">activeInstances</a></span>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
        ...
        <dt id="specs" class="property">
  <span class="name"><a href="../unpack/UnpackService/specs">specs</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/Iterable-class.html">Iterable</a><span class="signature">&lt;<wbr><span class="type-parameter">UnpackSpec</span>&gt;</span></span>&gt;</span></span> 
...
<dd>
  ...
  <span class="name"><a href="../unpack/UnpackService/states">states</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-async/Stream-class.html">Stream</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/Iterable-class.html">Iterable</a><span class="signature">&lt;<wbr><span class="type-parameter">UnpackState</span>&gt;</span></span>&gt;</span></span> 
...
<dd>
  ...
  <span class="name"><a href="../unpack/UnpackService/clear">clear</a></span><span class="signature">(<wbr>)
...
<dd>
  ...
  <span class="name"><a href="../unpack/UnpackService/dispose">dispose</a></span><span class="signature">(<wbr><span class="parameter" id="dispose-param-instanceId"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">instanceId</span></span>)
...
<dd>
  ...
  <span class="name"><a href="../unpack/UnpackService/initialize">initialize</a></span><span class="signature">(<wbr><span class="parameter" id="initialize-param-spec"><span class="type-annotation">UnpackSpec</span> <span class="parameter-name">spec</span></span>)
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">inherited</span></div>
        ...
        <dt id="unpacker" class="callable">
  <span class="name"><a href="../unpack/UnpackService/unpacker">unpacker</a></span><span class="signature">(<wbr><span class="parameter" id="unpacker-param-id"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">id</span></span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unpack/IUnpack">IUnpack</a></span>&gt;</span></span>
  </span>
