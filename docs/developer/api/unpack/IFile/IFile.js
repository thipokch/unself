...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">IFile</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="IFile" class="callable">
          <span class="name"><a href="../unpack/IFile/IFile.constructor">IFile</a></span><span class="signature">(<span class="parameter" id="-param-moduleSpec"><span class="type-annotation">ModuleSpec</span> <span class="parameter-name">moduleSpec</span></span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
        ...
        <dt id="moduleSpec" class="property">
  <span class="name"><a href="../unpack/IFile/moduleSpec">moduleSpec</a></span>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">inherited</span></div>
        ...
        <dt id="prepare" class="callable">
  <span class="name"><a href="../unpack/IFile/prepare">prepare</a></span><span class="signature">(<wbr><span class="parameter" id="prepare-param-file"><span class="type-annotation"><a href="https://pub.dev/documentation/cross_file/0.3.3+4/cross_file/XFile-class.html">XFile</a></span> <span class="parameter-name">file</span></span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/FutureOr-class.html">FutureOr</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/Iterable-class.html">Iterable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/int-class.html">int</a></span>&gt;</span></span>&gt;</span></span>&gt;</span></span>
  </span>
...
<dd class="inherited">
  ...
  <section class="summary offset-anchor" id="static-methods">
    ...
    <dl class="callables">
        <dt id="filer" class="callable">
  <span class="name"><a href="../unpack/IFile/filer">filer</a></span><span class="signature">(<wbr><span class="parameter" id="filer-param-moduleSpec"><span class="type-annotation">ModuleSpec</span> <span class="parameter-name">moduleSpec</span>, </span><span class="parameter" id="filer-param-fileSpec"><span class="type-annotation">FileSpec</span> <span class="parameter-name">fileSpec</span></span>)
    <span class="returntype parameter">→ <a href="../unpack/IFile">IFile</a></span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">IFile abstract class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unpack/IFile#constructors">Constructors</a></li>
          <li><a href="../unpack/IFile/IFile.constructor">IFile</a></li>


        <li class="section-title">
          <a href="../unpack/IFile#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li><a href="../unpack/IFile/moduleSpec">moduleSpec</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../unpack/IFile#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li><a href="../unpack/IFile/prepare">prepare</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../unpack/IFile#operators">Operators</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/operator_equals.html">operator ==</a></li>



        <li class="section-title"><a href="../unpack/IFile#static-methods">Static methods</a></li>
          <li><a href="../unpack/IFile/filer">filer</a></li>
