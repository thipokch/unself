...
<li><span class="parameter" id="maybeWhen-param-file"><span class="type-annotation">TResult</span> <span class="parameter-name">file</span>(<ol class="parameter-list"></ol>
)?, </span></li>
<li><span class="parameter" id="maybeWhen-param-extract"><span class="type-annotation">TResult</span> <span class="parameter-name">extract</span>(<ol class="parameter-list"></ol>
)?, </span></li>
<li><span class="parameter" id="maybeWhen-param-transform"><span class="type-annotation">TResult</span> <span class="parameter-name">transform</span>(<ol class="parameter-list"></ol>
)?, </span></li>
<li><span class="parameter" id="maybeWhen-param-load"><span class="type-annotation">TResult</span> <span class="parameter-name">load</span>(<ol class="parameter-list"></ol>
)?, </span></li>
<li><span class="parameter" id="maybeWhen-param-complete"><span class="type-annotation">TResult</span> <span class="parameter-name">complete</span>(<ol class="parameter-list"></ol>
)?, </span></li>
<li><span class="parameter" id="maybeWhen-param-error"><span class="type-annotation">TResult</span> <span class="parameter-name">error</span>(<ol class="parameter-list"></ol>
)?, </span></li>
