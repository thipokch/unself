...
<li><span class="parameter" id="whenOrNull-param-file"><span class="type-annotation">TResult?</span> <span class="parameter-name">file</span>(<ol class="parameter-list"></ol>
)?, </span></li>
<li><span class="parameter" id="whenOrNull-param-extract"><span class="type-annotation">TResult?</span> <span class="parameter-name">extract</span>(<ol class="parameter-list"></ol>
)?, </span></li>
<li><span class="parameter" id="whenOrNull-param-transform"><span class="type-annotation">TResult?</span> <span class="parameter-name">transform</span>(<ol class="parameter-list"></ol>
)?, </span></li>
<li><span class="parameter" id="whenOrNull-param-load"><span class="type-annotation">TResult?</span> <span class="parameter-name">load</span>(<ol class="parameter-list"></ol>
)?, </span></li>
<li><span class="parameter" id="whenOrNull-param-complete"><span class="type-annotation">TResult?</span> <span class="parameter-name">complete</span>(<ol class="parameter-list"></ol>
)?, </span></li>
<li><span class="parameter" id="whenOrNull-param-error"><span class="type-annotation">TResult?</span> <span class="parameter-name">error</span>(<ol class="parameter-list"></ol>
)?}</span></li>
</ol>)
