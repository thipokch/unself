...
<span class="name ">maybeMap</span>&lt;<wbr><span class="type-parameter">TResult extends Object?</span>&gt;(<wbr><ol class="parameter-list"><li><span class="parameter" id="maybeMap-param-initial">{<span class="type-annotation">TResult</span> <span class="parameter-name">initial</span>(<ol class="parameter-list"><li><span class="parameter" id="param-value"><span class="type-annotation"><a href="../../unpack/ModuleInitial">ModuleInitial</a></span> <span class="parameter-name">value</span></span></li>
</ol>
)?, </span></li>
<li><span class="parameter" id="maybeMap-param-file"><span class="type-annotation">TResult</span> <span class="parameter-name">file</span>(<ol class="parameter-list"><li><span class="parameter" id="param-value"><span class="type-annotation"><a href="../../unpack/ModuleFile">ModuleFile</a></span> <span class="parameter-name">value</span></span></li>
</ol>
)?, </span></li>
<li><span class="parameter" id="maybeMap-param-extract"><span class="type-annotation">TResult</span> <span class="parameter-name">extract</span>(<ol class="parameter-list"><li><span class="parameter" id="param-value"><span class="type-annotation"><a href="../../unpack/ModuleExtract">ModuleExtract</a></span> <span class="parameter-name">value</span></span></li>
</ol>
)?, </span></li>
<li><span class="parameter" id="maybeMap-param-transform"><span class="type-annotation">TResult</span> <span class="parameter-name">transform</span>(<ol class="parameter-list"><li><span class="parameter" id="param-value"><span class="type-annotation"><a href="../../unpack/ModuleTransform">ModuleTransform</a></span> <span class="parameter-name">value</span></span></li>
</ol>
)?, </span></li>
<li><span class="parameter" id="maybeMap-param-load"><span class="type-annotation">TResult</span> <span class="parameter-name">load</span>(<ol class="parameter-list"><li><span class="parameter" id="param-value"><span class="type-annotation"><a href="../../unpack/ModuleLoad">ModuleLoad</a></span> <span class="parameter-name">value</span></span></li>
</ol>
)?, </span></li>
<li><span class="parameter" id="maybeMap-param-complete"><span class="type-annotation">TResult</span> <span class="parameter-name">complete</span>(<ol class="parameter-list"><li><span class="parameter" id="param-value"><span class="type-annotation"><a href="../../unpack/ModuleComplete">ModuleComplete</a></span> <span class="parameter-name">value</span></span></li>
</ol>
)?, </span></li>
<li><span class="parameter" id="maybeMap-param-error"><span class="type-annotation">TResult</span> <span class="parameter-name">error</span>(<ol class="parameter-list"><li><span class="parameter" id="param-value"><span class="type-annotation"><a href="../../unpack/ModuleError">ModuleError</a></span> <span class="parameter-name">value</span></span></li>
</ol>
)?, </span></li>
