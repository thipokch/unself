...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">transform</span> method 
...
FutureOr&lt;Map&lt;String, dynamic&gt;&gt; transform(Map&lt;String, dynamic&gt; data) =&gt;
    JsonNormalizer(spec.schema).normalizeWith(spec.schema.first, data);</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">transform method</li>
</ol>
