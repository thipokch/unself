...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ILoad&lt;<wbr><span class="type-parameter">I</span>&gt;</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ILoad" class="callable">
          <span class="name"><a href="../unpack/ILoad/ILoad.constructor">ILoad</a></span><span class="signature">(<span class="parameter" id="-param-spec"><span class="type-annotation">LoadSpec</span> <span class="parameter-name">spec</span></span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unpack/ILoad/spec">spec</a></span>
  <span class="signature">→ LoadSpec</span> 
...
<dd>
  ...
  <span class="name"><a href="../unpack/ILoad/load">load</a></span><span class="signature">(<wbr><span class="parameter" id="load-param-data"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">I</span>&gt;</span></span> <span class="parameter-name">data</span></span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/FutureOr-class.html">FutureOr</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/bool-class.html">bool</a></span>&gt;</span></span>
  </span>
...
<dd class="inherited">
  ...
  <section class="summary offset-anchor" id="static-methods">
    ...
    <dl class="callables">
        <dt id="loader" class="callable">
  <span class="name"><a href="../unpack/ILoad/loader">loader</a></span><span class="signature">(<wbr><span class="parameter" id="loader-param-spec"><span class="type-annotation">LoadSpec</span> <span class="parameter-name">spec</span></span>)
    <span class="returntype parameter">→ <a href="../unpack/ILoad">ILoad</a></span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ILoad<span class="signature">&lt;<wbr><span class="type-parameter">I</span>&gt;</span> abstract class</li>
</ol>
