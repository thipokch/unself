...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">loader</span> static method 
...
<span class="returntype"><a href="../../unpack/ILoad">ILoad</a></span>
<span class="name ">loader</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="loader-param-spec"><span class="type-annotation">LoadSpec</span> <span class="parameter-name">spec</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">static ILoad loader(LoadSpec spec) =&gt; spec.map(
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">loader static method</li>
</ol>
