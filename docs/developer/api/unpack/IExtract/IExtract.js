...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">IExtract&lt;<wbr><span class="type-parameter">O</span>&gt;</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="IExtract" class="callable">
          <span class="name"><a href="../unpack/IExtract/IExtract.constructor">IExtract</a></span><span class="signature">(<span class="parameter" id="-param-spec"><span class="type-annotation">ExtractSpec</span> <span class="parameter-name">spec</span></span>)</span>
        </dt>
        <dd>
...
<dd>
  ...
  <span class="name"><a href="../unpack/IExtract/extract">extract</a></span><span class="signature">(<wbr><span class="parameter" id="extract-param-bytes"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Iterable-class.html">Iterable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/int-class.html">int</a></span>&gt;</span></span> <span class="parameter-name">bytes</span></span>)
...
<dd class="inherited">
  ...
  <section class="summary offset-anchor" id="static-methods">
    ...
    <dl class="callables">
        <dt id="extractor" class="callable">
  <span class="name"><a href="../unpack/IExtract/extractor">extractor</a></span><span class="signature">(<wbr><span class="parameter" id="extractor-param-spec"><span class="type-annotation">ExtractSpec</span> <span class="parameter-name">spec</span></span>)
    <span class="returntype parameter">→ <a href="../unpack/IExtract">IExtract</a></span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">IExtract<span class="signature">&lt;<wbr><span class="type-parameter">O</span>&gt;</span> abstract class</li>
</ol>
