...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ExtractJson</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ExtractJson" class="callable">
          <span class="name"><a href="../unpack/ExtractJson/ExtractJson.constructor">ExtractJson</a></span><span class="signature">(<span class="parameter" id="-param-spec"><span class="type-annotation">ExtractSpec</span> <span class="parameter-name">spec</span></span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unpack/IExtract/spec">spec</a></span>
  <span class="signature">→ ExtractSpec</span> 
...
<dd class="inherited">
  ...
  <section class="summary offset-anchor" id="instance-methods">
    <h2>Methods</h2>
    <dl class="callables">
        <dt id="extract" class="callable">
  <span class="name"><a href="../unpack/ExtractJson/extract">extract</a></span><span class="signature">(<wbr><span class="parameter" id="extract-param-bytes"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Iterable-class.html">Iterable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/int-class.html">int</a></span>&gt;</span></span> <span class="parameter-name">bytes</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ExtractJson class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unpack/ExtractJson#constructors">Constructors</a></li>
          <li><a href="../unpack/ExtractJson/ExtractJson.constructor">ExtractJson</a></li>


        <li class="section-title inherited">
          <a href="../unpack/ExtractJson#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li class="inherited"><a href="../unpack/IExtract/spec">spec</a></li>

        <li class="section-title"><a href="../unpack/ExtractJson#instance-methods">Methods</a></li>
          <li><a href="../unpack/ExtractJson/extract">extract</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../unpack/ExtractJson#operators">Operators</a></li>
