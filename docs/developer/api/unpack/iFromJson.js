...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-typedef">IFromJson&lt;<wbr><span class="type-parameter">I</span>&gt;</span> typedef 
...
<span class="name ">IFromJson</span>&lt;<wbr><span class="type-parameter">I</span>&gt; = <a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/Type-class.html">Type</a></span>, <span class="type-parameter">I Function<span class="signature">(<span class="parameter" id="param-json"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">json</span></span>)</span></span>&gt;</span>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">typedef IFromJson&lt;I&gt; = Map&lt;Type, I Function(Map&lt;String, dynamic&gt; json)&gt;;</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">IFromJson&lt;<wbr><span class="type-parameter">I</span>&gt; typedef</li>
</ol>
