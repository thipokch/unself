...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
        ...
        <h1>
          <span class="kind-enum">ModuleStep</span>
          enum 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ModuleStep" class="callable">
          <span class="name"><a href="../unpack/ModuleStep/ModuleStep.constructor">ModuleStep</a></span><span class="signature">()</span>
        </dt>
        <dd>
  ...
  <span class="signature">→ const <a href="../unpack/ModuleStep">ModuleStep</a></span>
...
<dd>
          ...
          <dt id="transform" class="constant">
...
<dd class="inherited">
  ...
  <section class="summary offset-anchor" id="constants">
    ...
    <span class="name "><a href="../unpack/ModuleStep/values-constant">values</a></span>
  <span class="signature">→ const <a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unpack/ModuleStep">ModuleStep</a></span>&gt;</span></span>
...
<dd>
  A constant List of the values in this enum, in order of their declaration.
    ...
    <div>
      <span class="signature"><code>[initial, file, extract, transform, load, complete, error]</code></span>
    </div>
</dd>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ModuleStep enum</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unpack/ModuleStep#constructors">Constructors</a></li>
          <li><a href="../unpack/ModuleStep/ModuleStep.constructor">ModuleStep</a></li>

        <li class="section-title"><a href="../unpack/ModuleStep#values">Values</a></li>
          <li><a href="../unpack/ModuleStep#initial">initial</a></li>
          <li><a href="../unpack/ModuleStep#file">file</a></li>
          <li><a href="../unpack/ModuleStep#extract">extract</a></li>
          <li><a href="../unpack/ModuleStep#transform">transform</a></li>
          <li><a href="../unpack/ModuleStep#load">load</a></li>
          <li><a href="../unpack/ModuleStep#complete">complete</a></li>
          <li><a href="../unpack/ModuleStep#error">error</a></li>

        <li class="section-title inherited">
          <a href="../unpack/ModuleStep#instance-properties">Properties</a>
        </li>
        ...
        <li class="section-title inherited"><a href="../unpack/ModuleStep#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../unpack/ModuleStep#operators">Operators</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/operator_equals.html">operator ==</a></li>




        <li class="section-title"><a href="../unpack/ModuleStep#constants">Constants</a></li>
          <li><a href="../unpack/ModuleStep/values-constant">values</a></li>
</ol>
