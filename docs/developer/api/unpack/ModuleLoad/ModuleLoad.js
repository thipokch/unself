...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ModuleLoad</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ModuleLoad" class="callable">
          <span class="name"><a href="../unpack/ModuleLoad/ModuleLoad.constructor">ModuleLoad</a></span><span class="signature">()</span>
        </dt>
        <dd>
        ...
        <dt id="ModuleLoad.fromJson" class="callable">
          <span class="name"><a href="../unpack/ModuleLoad/ModuleLoad.fromJson">ModuleLoad.fromJson</a></span><span class="signature">(<span class="parameter" id="fromJson-param-json"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">json</span></span>)</span>
        </dt>
        <dd>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ModuleLoad abstract class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unpack/ModuleLoad#constructors">Constructors</a></li>
          <li><a href="../unpack/ModuleLoad/ModuleLoad.constructor">ModuleLoad</a></li>
          <li><a href="../unpack/ModuleLoad/ModuleLoad.fromJson">fromJson</a></li>


        <li class="section-title inherited">
          <a href="../unpack/ModuleLoad#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li class="inherited"><a href="../unpack/ModuleState/step">step</a></li>

        <li class="section-title inherited"><a href="../unpack/ModuleLoad#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../unpack/ModuleLoad#operators">Operators</a></li>
