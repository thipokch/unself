...
<span class="name ">lerp</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="lerp-param-other"><span>covariant</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/material/ThemeExtension-class.html">ThemeExtension</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../../un_style/CustomColors">CustomColors</a></span>&gt;</span>?</span> <span class="parameter-name">other</span>, </span></li>
