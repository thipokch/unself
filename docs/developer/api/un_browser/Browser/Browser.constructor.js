...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-constructor">Browser</span> constructor 
    <a href="https://dart.dev/null-safety" class="feature feature-null-safety" title="Supports the null safety language feature.">Null safety</a>
</h1></div>

    <section class="multi-line-signature">
      
      <span class="name ">Browser</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="-param-settings">{<span class="type-annotation"><a href="https://pub.dev/documentation/flutter_inappwebview/6.0.0-beta.22/flutter_inappwebview/ChromeSafariBrowserSettings-class.html">ChromeSafariBrowserSettings</a>?</span> <span class="parameter-name">settings</span>, </span></li>
<li><span class="parameter" id="-param-analytics"><span class="type-annotation">AnalyticService?</span> <span class="parameter-name">analytics</span>}</span></li>
</ol>)
    </section>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Browser({
  this.settings,
  this.analytics,
});</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">Browser constructor</li>
</ol>
