...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">XZipDecoder</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="XZipDecoder" class="callable">
          <span class="name"><a href="../unself_file/XZipDecoder/XZipDecoder.constructor">XZipDecoder</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <section class="summary offset-anchor" id="static-methods">
    ...
    <dl class="callables">
        <dt id="decodeXFile" class="callable">
  <span class="name"><a href="../unself_file/XZipDecoder/decodeXFile">decodeXFile</a></span><span class="signature">(<wbr><span class="parameter" id="decodeXFile-param-xFile"><span class="type-annotation"><a href="https://pub.dev/documentation/cross_file/0.3.3+4/cross_file/XFile-class.html">XFile</a></span> <span class="parameter-name">xFile</span>, </span><span class="parameter" id="decodeXFile-param-verify">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/bool-class.html">bool</a></span> <span class="parameter-name">verify</span> = <span class="default-value">false</span>, </span><span class="parameter" id="decodeXFile-param-password"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a>?</span> <span class="parameter-name">password</span>}</span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/FutureOr-class.html">FutureOr</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://pub.dev/documentation/archive/3.3.6/archive_io/Archive-class.html">Archive</a></span>&gt;</span></span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">XZipDecoder class</li>
</ol>
