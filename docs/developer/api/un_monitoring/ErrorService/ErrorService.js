...
<section class="desc markdown">
  <p><a href="../un_monitoring/ErrorService">ErrorService</a> description</p>
</section>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ErrorService" class="callable">
          <span class="name"><a href="../un_monitoring/ErrorService/ErrorService.constructor">ErrorService</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd>
  ...
  <span class="name"><a href="../un_monitoring/ErrorService/recordFlutterError">recordFlutterError</a></span><span class="signature">(<wbr><span class="parameter" id="recordFlutterError-param-flutterErrorDetails"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/FlutterErrorDetails-class.html">FlutterErrorDetails</a></span> <span class="parameter-name">flutterErrorDetails</span></span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter">void</span>&gt;</span></span>
  </span>
...
<dd>
  ...
  <span class="name"><a href="../un_monitoring/ErrorService/recordIsolateError">recordIsolateError</a></span><span class="signature">(<wbr>)
...
<dd>
  ...
  <span class="name"><a href="../un_monitoring/ErrorService/runAppGuarded">runAppGuarded</a></span><span class="signature">(<wbr><span class="parameter" id="runAppGuarded-param-app"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/Widget-class.html">Widget</a></span> <span class="parameter-name">app</span></span>)
    <span class="returntype parameter">→ dynamic</span>
  </span>
