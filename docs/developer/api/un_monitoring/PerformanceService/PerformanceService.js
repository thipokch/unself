...
<section class="desc markdown">
  <p><a href="../un_monitoring/PerformanceService">PerformanceService</a> description</p>
</section>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="PerformanceService" class="callable">
          <span class="name"><a href="../un_monitoring/PerformanceService/PerformanceService.constructor">PerformanceService</a></span><span class="signature">(<span class="parameter" id="-param-performance">{<span>required</span> <span class="type-annotation"><a href="https://pub.dev/documentation/firebase_performance/0.9.0+10/firebase_performance/FirebasePerformance-class.html">FirebasePerformance</a></span> <span class="parameter-name">performance</span>}</span>)</span>
        </dt>
        <dd>
          <a href="../un_monitoring/PerformanceService">PerformanceService</a> description
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_monitoring/PerformanceService#constructors">Constructors</a></li>
          <li><a href="../un_monitoring/PerformanceService/PerformanceService.constructor">PerformanceService</a></li>


        <li class="section-title inherited">
          <a href="../un_monitoring/PerformanceService#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title inherited"><a href="../un_monitoring/PerformanceService#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../un_monitoring/PerformanceService#operators">Operators</a></li>
