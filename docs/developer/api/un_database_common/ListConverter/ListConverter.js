  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ListConverter" class="callable">
          <span class="name"><a href="../un_database_common/ListConverter/ListConverter.constructor">ListConverter</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_database_common/ListConverter/fromSql">fromSql</a></span><span class="signature">(<wbr><span class="parameter" id="fromSql-param-fromDb"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">fromDb</span></span>)
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_database_common/ListConverter/toSql">toSql</a></span><span class="signature">(<wbr><span class="parameter" id="toSql-param-value"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter">T</span>&gt;</span></span> <span class="parameter-name">value</span></span>)
