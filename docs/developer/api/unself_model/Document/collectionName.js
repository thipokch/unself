...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-property">collectionName</span> property 
...
<section class="multi-line-signature">
  ...
  <span class="name ">collectionName</span>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">String get collectionName =&gt; throw _privateConstructorUsedError;</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">collectionName property</li>
</ol>
