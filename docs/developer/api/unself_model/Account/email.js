...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-property">email</span> property 
...
<section class="desc markdown">
  <p><a href="../../unself_model/Account/email">email</a> is the email used by the <a href="../../unself_model/Account">Account</a> on the <a href="../../unself_model/App">App</a>.</p>
</section>


<section class="summary source-code" id="source">
  <h2><span>Implementation</span></h2>
  <pre class="language-dart"><code class="language-dart">String get email =&gt; throw _privateConstructorUsedError;</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">email property</li>
</ol>
