...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-property">isOwner</span> property 
...
<section class="desc markdown">
  <p><a href="../../unself_model/Account/isOwner">isOwner</a> is true if the <a href="../../unself_model/Account">Account</a> is the owner of the <a href="../../unself_model/Archive">Archive</a>.</p>
</section>


<section class="summary source-code" id="source">
  <h2><span>Implementation</span></h2>
  <pre class="language-dart"><code class="language-dart">bool get isOwner =&gt; throw _privateConstructorUsedError;</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">isOwner property</li>
</ol>
