...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-property">format</span> property 
...
<section class="multi-line-signature">
  ...
  <span class="returntype"><a href="../../unself_model/ArchiveFileFormat">ArchiveFileFormat</a></span>
...
<section class="desc markdown">
  <p><a href="../../unself_model/ArchiveFormat/format">format</a> is the format of the <a href="../../unself_model/ArchiveFormat">ArchiveFormat</a>.</p>
</section>


<section class="summary source-code" id="source">
  <h2><span>Implementation</span></h2>
  <pre class="language-dart"><code class="language-dart">ArchiveFileFormat get format =&gt; throw _privateConstructorUsedError;</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">format property</li>
</ol>
