...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-property">fieldMap</span> constant 
    <a href="https://dart.dev/null-safety" class="feature feature-null-safety" title="Supports the null safety language feature.">Null safety</a>
        ...
        <section class="multi-line-signature">
          ...
          const <span class="name ">fieldMap</span>
          

        </section>
        
<section class="desc markdown">
  <p><code>fields</code> is a list of all the fields in the <a href="../../unself_model/Archive">Archive</a> class.</p>
</section>

        
<section class="summary source-code" id="source">
  <h2><span>Implementation</span></h2>
  <pre class="language-dart"><code class="language-dart">static const Map&lt;String, String&gt; fieldMap = _\$\$_ArchiveFieldMap;</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">fieldMap constant</li>
</ol>
