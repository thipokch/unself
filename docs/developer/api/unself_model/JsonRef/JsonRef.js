...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">JsonRef</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="JsonRef.fromJson" class="callable">
          <span class="name"><a href="../unself_model/JsonRef/JsonRef.fromJson">JsonRef.fromJson</a></span><span class="signature">(<span class="parameter" id="fromJson-param-data"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">data</span></span>)</span>
        </dt>
        <dd>
          Creates a <a href="../unself_model/JsonRef">JsonRef</a> from Json map
            <div class="constructor-modifier features">factory</div>
        </dd>
        <dt id="JsonRef.ref" class="callable">
          <span class="name"><a href="../unself_model/JsonRef/JsonRef.ref">JsonRef.ref</a></span><span class="signature">(<span class="parameter" id="ref-param-name"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">name</span></span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <section class="summary offset-anchor" id="instance-methods">
    <h2>Methods</h2>
    <dl class="callables">
        <dt id="getScheme" class="callable">
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">JsonRef class</li>
</ol>
