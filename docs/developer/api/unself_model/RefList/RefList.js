...
<h1><span class="kind-class">RefList</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="RefList" class="callable">
          <span class="name"><a href="../unself_model/RefList/RefList.constructor">RefList</a></span><span class="signature">(<span class="parameter" id="-param-name"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">name</span></span>)</span>
        </dt>
        <dd>
        ...
        <dt id="RefList.fromJson" class="callable">
          <span class="name"><a href="../unself_model/RefList/RefList.fromJson">RefList.fromJson</a></span><span class="signature">(<span class="parameter" id="fromJson-param-json"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">json</span></span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../unself_model/RefList/copyWith">copyWith</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_model/RefList/name">name</a></span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_model/RefList#constructors">Constructors</a></li>
          <li><a href="../unself_model/RefList/RefList.constructor">RefList</a></li>
          <li><a href="../unself_model/RefList/RefList.fromJson">fromJson</a></li>


        <li class="section-title">
          <a href="../unself_model/RefList#instance-properties">Properties</a>
        </li>
          <li><a href="../unself_model/RefList/copyWith">copyWith</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li><a href="../unself_model/RefList/name">name</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li class="inherited"><a href="../unself_model/JsonRefList/schema">schema</a></li>

        <li class="section-title inherited"><a href="../unself_model/RefList#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../unself_model/RefList#operators">Operators</a></li>
