...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ArchiveSchemaPart</span> class 
...
<section class="desc markdown">
  <p>ArchiveSchemaPart description</p>
</section>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ArchiveSchemaPart.fromJson" class="callable">
          <span class="name"><a href="../unself_model/ArchiveSchemaPart/ArchiveSchemaPart.fromJson">ArchiveSchemaPart.fromJson</a></span><span class="signature">(<span class="parameter" id="fromJson-param-data"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">data</span></span>)</span>
        </dt>
        <dd>
          Creates a <a href="../unself_model/ArchiveSchemaPart">ArchiveSchemaPart</a> from Json map
            <div class="constructor-modifier features">factory</div>
        </dd>
        <dt id="ArchiveSchemaPart.json" class="callable">
          <span class="name"><a href="../unself_model/ArchiveSchemaPart/ArchiveSchemaPart.json">ArchiveSchemaPart.json</a></span><span class="signature">(<span class="parameter" id="json-param-id">{<span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">id</span>, </span><span class="parameter" id="json-param-part"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">part</span>, </span><span class="parameter" id="json-param-schema"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unself_model/JsonSchema">JsonSchema</a></span>&gt;</span></span> <span class="parameter-name">schema</span>, </span><span class="parameter" id="json-param-extra"><span>@<a href="../unself_model/JsonExtra">JsonExtra</a>()</span> <span>@<a href="https://pub.dev/documentation/freezed_annotation/2.2.0/freezed_annotation/Default-class.html">Default</a>({})</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">extra</span>}</span>)</span>
        </dt>
        <dd>
        ...
        <dt id="ArchiveSchemaPart.zipJson" class="callable">
          <span class="name"><a href="../unself_model/ArchiveSchemaPart/ArchiveSchemaPart.zipJson">ArchiveSchemaPart.zipJson</a></span><span class="signature">(<span class="parameter" id="zipJson-param-id">{<span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">id</span>, </span><span class="parameter" id="zipJson-param-part"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">part</span>, </span><span class="parameter" id="zipJson-param-schema"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unself_model/JsonSchema">JsonSchema</a></span>&gt;</span></span> <span class="parameter-name">schema</span>, </span><span class="parameter" id="zipJson-param-extra"><span>@<a href="../unself_model/JsonExtra">JsonExtra</a>()</span> <span>@<a href="https://pub.dev/documentation/freezed_annotation/2.2.0/freezed_annotation/Default-class.html">Default</a>({})</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">extra</span>}</span>)</span>
        </dt>
        <dd>
          ArchiveSchemaPart description
            <div class="constructor-modifier features">const</div>
  ...
  <span class="name"><a href="../unself_model/ArchiveSchemaPart/copyWith">copyWith</a></span>
  <span class="signature">→ \$ArchiveSchemaPartCopyWith<span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unself_model/ArchiveSchemaPart">ArchiveSchemaPart</a></span>&gt;</span></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_model/ArchiveSchemaPart/extra">extra</a></span>
...
<dd class="inherited">
  <a href="../unself_model/ArchiveSchemaPart/extra">extra</a> is a map of additional properties.
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_model/ArchiveSchemaPart/id">id</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 

</dt>
<dd class="inherited">
  <a href="../unself_model/ArchiveSchemaPart/id">id</a> is unself unique identifier for the ArchiveSchemaPart.
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>

</dd>

        <dt id="part" class="property inherited">
  <span class="name"><a href="../unself_model/ArchiveSchemaPart/part">part</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_model/ArchiveSchemaPart/schema">schema</a></span>
...
<dd class="inherited">
  <a href="../unself_model/ArchiveSchemaPart/schema">schema</a> is a list of <code>JsonSchema</code>s.
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ArchiveSchemaPart class</li>
</ol>
