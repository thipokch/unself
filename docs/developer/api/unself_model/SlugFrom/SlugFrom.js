...
<h1><span class="kind-class">SlugFrom</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="SlugFrom" class="callable">
          <span class="name"><a href="../unself_model/SlugFrom/SlugFrom.constructor">SlugFrom</a></span><span class="signature">(<span class="parameter" id="-param-name"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">name</span></span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../unself_model/SlugFrom/copyWith">copyWith</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unself_model/SlugFrom/name">name</a></span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unself_model/SlugFrom#constructors">Constructors</a></li>
          <li><a href="../unself_model/SlugFrom/SlugFrom.constructor">SlugFrom</a></li>
          <li><a href="../unself_model/SlugFrom/SlugFrom.fromJson">fromJson</a></li>


        <li class="section-title">
          <a href="../unself_model/SlugFrom#instance-properties">Properties</a>
        </li>
          <li><a href="../unself_model/SlugFrom/copyWith">copyWith</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li><a href="../unself_model/SlugFrom/name">name</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title inherited"><a href="../unself_model/SlugFrom#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../unself_model/SlugFrom#operators">Operators</a></li>
