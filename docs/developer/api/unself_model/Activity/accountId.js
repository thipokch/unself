...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-property">accountId</span> property 
...
<section class="desc markdown">
  <p><a href="../../unself_model/Activity/accountId">accountId</a> is the source node.</p>
</section>


<section class="summary source-code" id="source">
  <h2><span>Implementation</span></h2>
  <pre class="language-dart"><code class="language-dart">String get accountId =&gt; throw _privateConstructorUsedError;</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">accountId property</li>
</ol>
