  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="JsonVersionConstraint" class="callable">
          <span class="name"><a href="../un_model_converter/JsonVersionConstraint/JsonVersionConstraint.constructor">JsonVersionConstraint</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_model_converter/JsonVersionConstraint/fromJson">fromJson</a></span><span class="signature">(<wbr><span class="parameter" id="fromJson-param-_"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">_</span></span>)
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_model_converter/JsonVersionConstraint/toJson">toJson</a></span><span class="signature">(<wbr><span class="parameter" id="toJson-param-_"><span class="type-annotation"><a href="https://pub.dev/documentation/pub_semver/2.1.3/pub_semver/VersionConstraint-class.html">VersionConstraint</a></span> <span class="parameter-name">_</span></span>)
