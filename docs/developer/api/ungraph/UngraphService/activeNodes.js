...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-property">activeNodes</span> property 
...
<section class="multi-line-signature">
  ...
  <span class="name ">activeNodes</span>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">int get activeNodes =&gt; _nodes.length;</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">activeNodes property</li>
</ol>
