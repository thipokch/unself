...
<span class="name ">dispose</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="dispose-param-instanceSlug"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">instanceSlug</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Future&lt;void&gt; dispose(String instanceSlug) async {
