...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">IEdge</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="IEdge" class="callable">
          <span class="name"><a href="../un_model/IEdge/IEdge.constructor">IEdge</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_model/IEdge/id">id</a></span>
...
<dd>
  ...
  <span class="name"><a href="../un_model/IEdge/properties">properties</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_model/IEdge/type">type</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">IEdge abstract class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_model/IEdge#constructors">Constructors</a></li>
          <li><a href="../un_model/IEdge/IEdge.constructor">IEdge</a></li>


        <li class="section-title">
          <a href="../un_model/IEdge#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li><a href="../un_model/IEdge/id">id</a></li>
          <li><a href="../un_model/IEdge/properties">properties</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li><a href="../un_model/IEdge/type">type</a></li>

        <li class="section-title inherited"><a href="../un_model/IEdge#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../un_model/IEdge#operators">Operators</a></li>
