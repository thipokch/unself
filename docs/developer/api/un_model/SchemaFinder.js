...
<h1><span class="kind-typedef">SchemaFinder</span> typedef 
    ...
    <section class="multi-line-signature">
     ...
     <span class="returntype"><a href="../un_model/JsonSchema">JsonSchema</a> Function<span class="signature">(<span class="parameter" id="param-name"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">name</span></span>)</span></span>
