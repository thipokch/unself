...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">JsonModule</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="JsonModule" class="callable">
          <span class="name"><a href="../un_model/JsonModule/JsonModule.constructor">JsonModule</a></span><span class="signature">(<span class="parameter" id="-param-id">{<span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">id</span>, </span><span class="parameter" id="-param-name"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">name</span>, </span><span class="parameter" id="-param-fileMatcher"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Pattern-class.html">Pattern</a></span> <span class="parameter-name">fileMatcher</span>, </span><span class="parameter" id="-param-schema"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Iterable-class.html">Iterable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../un_model/JsonSchema">JsonSchema</a></span>&gt;</span></span> <span class="parameter-name">schema</span>, </span><span class="parameter" id="-param-load"><span>required</span> <span class="type-annotation"><a href="../un_model/LoadSpec">LoadSpec</a></span> <span class="parameter-name">load</span>}</span>)</span>
        </dt>
        <dd>
        ...
        <dt id="JsonModule.fromJson" class="callable">
          <span class="name"><a href="../un_model/JsonModule/JsonModule.fromJson">JsonModule.fromJson</a></span><span class="signature">(<span class="parameter" id="fromJson-param-json"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">json</span></span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../un_model/JsonModule/copyWith">copyWith</a></span>
  <span class="signature">→ _\$\$JsonModuleCopyWith<span class="signature">&lt;<wbr><span class="type-parameter">_\$JsonModule</span>&gt;</span></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_model/JsonModule/fileMatcher">fileMatcher</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_model/JsonModule/id">id</a></span>
...
<dd>
  ...
  <span class="name"><a href="../un_model/JsonModule/load">load</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_model/JsonModule/name">name</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_model/JsonModule/schema">schema</a></span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">JsonModule abstract class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_model/JsonModule#constructors">Constructors</a></li>
          <li><a href="../un_model/JsonModule/JsonModule.constructor">JsonModule</a></li>
          <li><a href="../un_model/JsonModule/JsonModule.fromJson">fromJson</a></li>


        <li class="section-title">
          <a href="../un_model/JsonModule#instance-properties">Properties</a>
        </li>
          <li><a href="../un_model/JsonModule/copyWith">copyWith</a></li>
          <li class="inherited"><a href="../un_model/ModuleSpec/extractSpec">extractSpec</a></li>
          <li><a href="../un_model/JsonModule/fileMatcher">fileMatcher</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li><a href="../un_model/JsonModule/id">id</a></li>
          <li><a href="../un_model/JsonModule/load">load</a></li>
          <li class="inherited"><a href="../un_model/ModuleSpec/loadSpec">loadSpec</a></li>
          <li><a href="../un_model/JsonModule/name">name</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li><a href="../un_model/JsonModule/schema">schema</a></li>
          <li class="inherited"><a href="../un_model/ModuleSpec/transformSpec">transformSpec</a></li>

        <li class="section-title inherited"><a href="../un_model/JsonModule#instance-methods">Methods</a></li>
        ...
        <li class="section-title inherited"><a href="../un_model/JsonModule#operators">Operators</a></li>
