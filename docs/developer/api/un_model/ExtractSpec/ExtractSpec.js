...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ExtractSpec</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ExtractSpec.fromJson" class="callable">
          <span class="name"><a href="../un_model/ExtractSpec/ExtractSpec.fromJson">ExtractSpec.fromJson</a></span><span class="signature">(<span class="parameter" id="fromJson-param-json"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">json</span></span>)</span>
        </dt>
        <dd>
          
            <div class="constructor-modifier features">factory</div>
        </dd>
        <dt id="ExtractSpec.json" class="callable">
          <span class="name"><a href="../un_model/ExtractSpec/ExtractSpec.json">ExtractSpec.json</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ExtractSpec class</li>
</ol>
