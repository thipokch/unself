...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">ModuleSpec</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="ModuleSpec.custom" class="callable">
          <span class="name"><a href="../un_model/ModuleSpec/ModuleSpec.custom">ModuleSpec.custom</a></span><span class="signature">(<span class="parameter" id="custom-param-id">{<span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">id</span>, </span><span class="parameter" id="custom-param-name"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">name</span>, </span><span class="parameter" id="custom-param-fileMatcher"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Pattern-class.html">Pattern</a></span> <span class="parameter-name">fileMatcher</span>, </span><span class="parameter" id="custom-param-extract"><span>required</span> <span class="type-annotation"><a href="../un_model/ExtractSpec">ExtractSpec</a></span> <span class="parameter-name">extract</span>, </span><span class="parameter" id="custom-param-transform"><span>required</span> <span class="type-annotation"><a href="../un_model/TransformSpec">TransformSpec</a></span> <span class="parameter-name">transform</span>, </span><span class="parameter" id="custom-param-load"><span>required</span> <span class="type-annotation"><a href="../un_model/LoadSpec">LoadSpec</a></span> <span class="parameter-name">load</span>}</span>)</span>
        </dt>
        <dd>
        ...
        <dt id="ModuleSpec.fromJson" class="callable">
          <span class="name"><a href="../un_model/ModuleSpec/ModuleSpec.fromJson">ModuleSpec.fromJson</a></span><span class="signature">(<span class="parameter" id="fromJson-param-json"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">json</span></span>)</span>
        </dt>
        <dd>
          
            <div class="constructor-modifier features">factory</div>
        </dd>
        <dt id="ModuleSpec.json" class="callable">
          <span class="name"><a href="../un_model/ModuleSpec/ModuleSpec.json">ModuleSpec.json</a></span><span class="signature">(<span class="parameter" id="json-param-id">{<span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">id</span>, </span><span class="parameter" id="json-param-name"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">name</span>, </span><span class="parameter" id="json-param-fileMatcher"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Pattern-class.html">Pattern</a></span> <span class="parameter-name">fileMatcher</span>, </span><span class="parameter" id="json-param-schema"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Iterable-class.html">Iterable</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../un_model/JsonSchema">JsonSchema</a></span>&gt;</span></span> <span class="parameter-name">schema</span>, </span><span class="parameter" id="json-param-load"><span>required</span> <span class="type-annotation"><a href="../un_model/LoadSpec">LoadSpec</a></span> <span class="parameter-name">load</span>}</span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../un_model/ModuleSpec/copyWith">copyWith</a></span>
  <span class="signature">→ \$ModuleSpecCopyWith<span class="signature">&lt;<wbr><span class="type-parameter"><a href="../un_model/ModuleSpec">ModuleSpec</a></span>&gt;</span></span> 
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
        ...
        <dt id="extractSpec" class="property">
...
<dd>
  ...
  <div class="features"><span class="feature">read-only</span></div>
        ...
        <dt id="fileMatcher" class="property inherited">
  <span class="name"><a href="../un_model/ModuleSpec/fileMatcher">fileMatcher</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_model/ModuleSpec/id">id</a></span>
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
        ...
        <dt id="load" class="property inherited">
  <span class="name"><a href="../un_model/ModuleSpec/load">load</a></span>
...
<dd>
  ...
  <span class="name"><a href="../un_model/ModuleSpec/name">name</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 
...
<dd class="inherited">
  ...
  <div class="features"><span class="feature">read-only</span><span class="feature">inherited</span></div>
        ...
        <dt id="transformSpec" class="property">
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">ModuleSpec class</li>
</ol>
