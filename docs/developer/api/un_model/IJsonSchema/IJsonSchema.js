...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">IJsonSchema</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="IJsonSchema" class="callable">
          <span class="name"><a href="../un_model/IJsonSchema/IJsonSchema.constructor">IJsonSchema</a></span><span class="signature">()</span>
        </dt>
        <dd>
          
            <div class="constructor-modifier features">const</div>
        </dd>
        <dt id="IJsonSchema.fromJson" class="callable">
          <span class="name"><a href="../un_model/IJsonSchema/IJsonSchema.fromJson">IJsonSchema.fromJson</a></span><span class="signature">(<span class="parameter" id="fromJson-param-json"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">json</span></span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_model/IJsonSchema/toJson">toJson</a></span><span class="signature">(<wbr>)
...
<dd class="inherited">
  ...
  <section class="summary offset-anchor" id="static-methods">
    ...
    <dl class="callables">
        <dt id="structFromJson" class="callable">
  <span class="name"><a href="../un_model/IJsonSchema/structFromJson">structFromJson</a></span><span class="signature">(<wbr><span class="parameter" id="structFromJson-param-json"><span class="type-annotation">dynamic</span> <span class="parameter-name">json</span></span>)
    <span class="returntype parameter">→ dynamic</span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">IJsonSchema abstract class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_model/IJsonSchema#constructors">Constructors</a></li>
          <li><a href="../un_model/IJsonSchema/IJsonSchema.constructor">IJsonSchema</a></li>
          <li><a href="../un_model/IJsonSchema/IJsonSchema.fromJson">fromJson</a></li>


        <li class="section-title inherited">
          <a href="../un_model/IJsonSchema#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../un_model/IJsonSchema#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li><a href="../un_model/IJsonSchema/toJson">toJson</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../un_model/IJsonSchema#operators">Operators</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/operator_equals.html">operator ==</a></li>



        <li class="section-title"><a href="../un_model/IJsonSchema#static-methods">Static methods</a></li>
          <li><a href="../un_model/IJsonSchema/structFromJson">structFromJson</a></li>
