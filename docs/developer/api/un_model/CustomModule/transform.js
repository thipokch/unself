...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-property">transform</span> property 
...
<section class="multi-line-signature">
  ...
  <span class="returntype"><a href="../../un_model/TransformSpec">TransformSpec</a></span>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">TransformSpec get transform;</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">transform property</li>
</ol>
