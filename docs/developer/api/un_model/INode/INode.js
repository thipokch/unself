...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">INode</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="INode" class="callable">
          <span class="name"><a href="../un_model/INode/INode.constructor">INode</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_model/INode/id">id</a></span>
...
<dd>
  ...
  <span class="name"><a href="../un_model/INode/labels">labels</a></span>
...
<dd>
  ...
  <div class="features"><span class="feature">read-only</span></div>
        ...
        <dt id="properties" class="property">
  <span class="name"><a href="../un_model/INode/properties">properties</a></span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">INode abstract class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_model/INode#constructors">Constructors</a></li>
          <li><a href="../un_model/INode/INode.constructor">INode</a></li>


        <li class="section-title">
          <a href="../un_model/INode#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li><a href="../un_model/INode/id">id</a></li>
          <li><a href="../un_model/INode/labels">labels</a></li>
          <li><a href="../un_model/INode/properties">properties</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title inherited"><a href="../un_model/INode#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../un_model/INode#operators">Operators</a></li>
