...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">PropSpec</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="PropSpec" class="callable">
          <span class="name"><a href="../un_model/PropSpec/PropSpec.constructor">PropSpec</a></span><span class="signature">(<span class="parameter" id="-param-name">{<span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">name</span>, </span><span class="parameter" id="-param-description"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">description</span>, </span><span class="parameter" id="-param-type"><span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">type</span>}</span>)</span>
        </dt>
        <dd>
        ...
        <dt id="PropSpec.fromJson" class="callable">
          <span class="name"><a href="../un_model/PropSpec/PropSpec.fromJson">PropSpec.fromJson</a></span><span class="signature">(<span class="parameter" id="fromJson-param-json"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Map-class.html">Map</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>, <span class="type-parameter">dynamic</span>&gt;</span></span> <span class="parameter-name">json</span></span>)</span>
        </dt>
        <dd>
  ...
  <span class="name"><a href="../un_model/PropSpec/copyWith">copyWith</a></span>
  <span class="signature">→ \$PropSpecCopyWith<span class="signature">&lt;<wbr><span class="type-parameter"><a href="../un_model/PropSpec">PropSpec</a></span>&gt;</span></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_model/PropSpec/description">description</a></span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_model/PropSpec/name">name</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_model/PropSpec/type">type</a></span>
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="../un_model/PropSpec/toJson">toJson</a></span><span class="signature">(<wbr>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">PropSpec class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../un_model/PropSpec#constructors">Constructors</a></li>
          <li><a href="../un_model/PropSpec/PropSpec.constructor">PropSpec</a></li>
          <li><a href="../un_model/PropSpec/PropSpec.fromJson">fromJson</a></li>


        <li class="section-title inherited">
          <a href="../un_model/PropSpec#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="../un_model/PropSpec/copyWith">copyWith</a></li>
          <li class="inherited"><a href="../un_model/PropSpec/description">description</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="../un_model/PropSpec/name">name</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>
          <li class="inherited"><a href="../un_model/PropSpec/type">type</a></li>

        <li class="section-title inherited"><a href="../un_model/PropSpec#instance-methods">Methods</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li class="inherited"><a href="../un_model/PropSpec/toJson">toJson</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>

        <li class="section-title inherited"><a href="../un_model/PropSpec#operators">Operators</a></li>
