...
<span class="name ">mapOrNull</span>&lt;<wbr><span class="type-parameter">TResult extends Object?</span>&gt;(<wbr><ol class="parameter-list"><li><span class="parameter" id="mapOrNull-param-ref">{<span class="type-annotation">TResult?</span> <span class="parameter-name">ref</span>(<ol class="parameter-list"><li><span class="parameter" id="param-value"><span class="type-annotation"><a href="../../un_model/Ref">Ref</a></span> <span class="parameter-name">value</span></span></li>
</ol>
)?, </span></li>
<li><span class="parameter" id="mapOrNull-param-union"><span class="type-annotation">TResult?</span> <span class="parameter-name">union</span>(<ol class="parameter-list"><li><span class="parameter" id="param-value"><span class="type-annotation"><a href="../../un_model/Union">Union</a></span> <span class="parameter-name">value</span></span></li>
</ol>
)?}</span></li>
</ol>)
