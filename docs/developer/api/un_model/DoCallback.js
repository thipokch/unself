...
<h1><span class="kind-typedef">DoCallback</span> typedef 
    ...
    <section class="multi-line-signature">
     ...
     <span class="returntype">dynamic Function<span class="signature">(<span class="parameter" id="param-json"><span class="type-annotation">dynamic</span> <span class="parameter-name">json</span>, </span><span class="parameter" id="param-schema"><span class="type-annotation"><a href="../un_model/JsonRef">JsonRef</a></span> <span class="parameter-name">schema</span></span>)</span></span>
