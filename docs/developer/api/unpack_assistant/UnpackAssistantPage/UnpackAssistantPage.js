...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">UnpackAssistantPage</span> class 
...
<section class="desc markdown">
  <p>A description for UnpackAssistantPage</p>
</section>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="UnpackAssistantPage" class="callable">
          <span class="name"><a href="../unpack_assistant/UnpackAssistantPage/UnpackAssistantPage.constructor">UnpackAssistantPage</a></span><span class="signature">(<span class="parameter" id="-param-key">{<span class="type-annotation"><a href="https://api.flutter.dev/flutter/foundation/Key-class.html">Key</a>?</span> <span class="parameter-name">key</span>}</span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unpack_assistant/UnpackAssistantPage/build">build</a></span><span class="signature">(<wbr><span class="parameter" id="build-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">UnpackAssistantPage class</li>
</ol>
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unpack_assistant/UnpackAssistantPage#constructors">Constructors</a></li>
          <li><a href="../unpack_assistant/UnpackAssistantPage/UnpackAssistantPage.constructor">UnpackAssistantPage</a></li>


        <li class="section-title inherited">
          <a href="../unpack_assistant/UnpackAssistantPage#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/widgets/Widget/key.html">key</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title"><a href="../unpack_assistant/UnpackAssistantPage#instance-methods">Methods</a></li>
          <li><a href="../unpack_assistant/UnpackAssistantPage/build">build</a></li>
        ...
        <li class="section-title inherited"><a href="../unpack_assistant/UnpackAssistantPage#operators">Operators</a></li>
