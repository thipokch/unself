...
<li><span class="parameter" id="whenOrNull-param-selectArchive"><span class="type-annotation">TResult?</span> <span class="parameter-name">selectArchive</span>(<ol class="parameter-list"><li><span class="parameter" id="param-xFile"><span class="type-annotation"><a href="https://pub.dev/documentation/cross_file/0.3.3+4/cross_file/XFile-class.html">XFile</a></span> <span class="parameter-name">xFile</span></span></li>
</ol>
)?, </span></li>
