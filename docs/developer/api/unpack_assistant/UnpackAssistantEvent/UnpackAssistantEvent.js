...
<section class="desc markdown">
  <p><a href="../unpack_assistant/UnpackAssistantEvent">UnpackAssistantEvent</a> are the events that the <a href="../unpack_assistant/UnpackAssistantBloc">UnpackAssistantBloc</a> can
respond to.</p>
</section>
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="UnpackAssistantEvent.selectApp" class="callable">
          <span class="name"><a href="../unpack_assistant/UnpackAssistantEvent/UnpackAssistantEvent.selectApp">UnpackAssistantEvent.selectApp</a></span><span class="signature">(<span class="parameter" id="selectApp-param-app">{<span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">app</span>}</span>)</span>
        </dt>
        <dd>
        ...
        <dt id="UnpackAssistantEvent.selectData" class="callable">
          <span class="name"><a href="../unpack_assistant/UnpackAssistantEvent/UnpackAssistantEvent.selectData">UnpackAssistantEvent.selectData</a></span><span class="signature">(<span class="parameter" id="selectData-param-data">{<span>required</span> <span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span>&gt;</span></span> <span class="parameter-name">data</span>}</span>)</span>
        </dt>
        <dd>
        ...
        <dt id="UnpackAssistantEvent.start" class="callable">
          <span class="name"><a href="../unpack_assistant/UnpackAssistantEvent/UnpackAssistantEvent.start">UnpackAssistantEvent.start</a></span><span class="signature">()</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unpack_assistant/UnpackAssistantEvent/map">map</a></span><span class="signature">&lt;<wbr><span class="type-parameter">TResult extends <a href="https://api.flutter.dev/flutter/dart-core/Object-class.html">Object</a>?</span>&gt;</span><span class="signature">(<wbr><span class="parameter" id="map-param-selectApp">{<span>required</span> <span class="type-annotation">TResult</span> <span class="parameter-name">selectApp</span>(<span class="parameter" id="param-value"><span class="type-annotation">_SelectApp</span> <span class="parameter-name">value</span></span>), </span><span class="parameter" id="map-param-selectArchive"><span>required</span> <span class="type-annotation">TResult</span> <span class="parameter-name">selectArchive</span>(<span class="parameter" id="param-value"><span class="type-annotation">_SelectArchive</span> <span class="parameter-name">value</span></span>), </span><span class="parameter" id="map-param-selectData"><span>required</span> <span class="type-annotation">TResult</span> <span class="parameter-name">selectData</span>(<span class="parameter" id="param-value"><span class="type-annotation">_SelectData</span> <span class="parameter-name">value</span></span>), </span><span class="parameter" id="map-param-start"><span>required</span> <span class="type-annotation">TResult</span> <span class="parameter-name">start</span>(<span class="parameter" id="param-value"><span class="type-annotation">_Start</span> <span class="parameter-name">value</span></span>)}</span>)
...
<dd class="inherited">
  ...
  <span class="name"><a href="../unpack_assistant/UnpackAssistantEvent/maybeMap">maybeMap</a></span><span class="signature">&lt;<wbr><span class="type-parameter">TResult extends <a href="https://api.flutter.dev/flutter/dart-core/Object-class.html">Object</a>?</span>&gt;</span><span class="signature">(<wbr><span class="parameter" id="maybeMap-param-selectApp">{<span class="type-annotation">TResult</span> <span class="parameter-name">selectApp</span>(<span class="parameter" id="param-value"><span class="type-annotation">_SelectApp</span> <span class="parameter-name">value</span></span>)?, </span><span class="parameter" id="maybeMap-param-selectArchive"><span class="type-annotation">TResult</span> <span class="parameter-name">selectArchive</span>(<span class="parameter" id="param-value"><span class="type-annotation">_SelectArchive</span> <span class="parameter-name">value</span></span>)?, </span><span class="parameter" id="maybeMap-param-selectData"><span class="type-annotation">TResult</span> <span class="parameter-name">selectData</span>(<span class="parameter" id="param-value"><span class="type-annotation">_SelectData</span> <span class="parameter-name">value</span></span>)?, </span><span class="parameter" id="maybeMap-param-start"><span class="type-annotation">TResult</span> <span class="parameter-name">start</span>(<span class="parameter" id="param-value"><span class="type-annotation">_Start</span> <span class="parameter-name">value</span></span>)?, </span><span class="parameter" id="maybeMap-param-orElse"><span>required</span> <span class="type-annotation">TResult</span> <span class="parameter-name">orElse</span>()}</span>)
    <span class="returntype parameter">→ TResult</span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unpack_assistant/UnpackAssistantEvent#constructors">Constructors</a></li>
          <li><a href="../unpack_assistant/UnpackAssistantEvent/UnpackAssistantEvent.selectApp">selectApp</a></li>
          <li><a href="../unpack_assistant/UnpackAssistantEvent/UnpackAssistantEvent.selectArchive">selectArchive</a></li>
          <li><a href="../unpack_assistant/UnpackAssistantEvent/UnpackAssistantEvent.selectData">selectData</a></li>
          <li><a href="../unpack_assistant/UnpackAssistantEvent/UnpackAssistantEvent.start">start</a></li>


        <li class="section-title inherited">
          <a href="../unpack_assistant/UnpackAssistantEvent#instance-properties">Properties</a>
        </li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/hashCode.html">hashCode</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html">runtimeType</a></li>

        <li class="section-title inherited"><a href="../unpack_assistant/UnpackAssistantEvent#instance-methods">Methods</a></li>
          <li class="inherited"><a href="../unpack_assistant/UnpackAssistantEvent/map">map</a></li>
          <li class="inherited"><a href="../unpack_assistant/UnpackAssistantEvent/mapOrNull">mapOrNull</a></li>
          <li class="inherited"><a href="../unpack_assistant/UnpackAssistantEvent/maybeMap">maybeMap</a></li>
          <li class="inherited"><a href="../unpack_assistant/UnpackAssistantEvent/maybeWhen">maybeWhen</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/noSuchMethod.html">noSuchMethod</a></li>
          <li class="inherited"><a href="https://api.flutter.dev/flutter/dart-core/Object/toString.html">toString</a></li>
          <li class="inherited"><a href="../unpack_assistant/UnpackAssistantEvent/when">when</a></li>
          <li class="inherited"><a href="../unpack_assistant/UnpackAssistantEvent/whenOrNull">whenOrNull</a></li>

        <li class="section-title inherited"><a href="../unpack_assistant/UnpackAssistantEvent#operators">Operators</a></li>
