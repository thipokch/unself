...
<span class="name ">onEvent</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="onEvent-param-event"><span class="type-annotation"><a href="../../unpack_assistant/UnpackAssistantEvent">UnpackAssistantEvent</a></span> <span class="parameter-name">event</span></span></li>
</ol>)
