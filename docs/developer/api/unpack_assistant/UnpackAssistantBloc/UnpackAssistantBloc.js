...
<section class="desc markdown">
  <p><a href="../unpack_assistant/UnpackAssistantBloc">UnpackAssistantBloc</a> is responsible for helping the user importing or
  ...
  <dd>
    <ul class="gt-separated dark clazz-relationships">
      <li><a href="https://api.flutter.dev/flutter/dart-core/Object-class.html">Object</a></li>
        <li><a href="https://pub.dev/documentation/bloc/8.1.0/bloc/BlocBase-class.html">BlocBase</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unpack_assistant/UnpackAssistantState">UnpackAssistantState</a></span>&gt;</span></li>
        <li><a href="https://pub.dev/documentation/bloc/8.1.0/bloc/Bloc-class.html">Bloc</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unpack_assistant/UnpackAssistantEvent">UnpackAssistantEvent</a></span>, <span class="type-parameter"><a href="../unpack_assistant/UnpackAssistantState">UnpackAssistantState</a></span>&gt;</span></li>
...
<dd class="inherited">
  ...
  <span class="signature">→ <a href="../unpack_assistant/UnpackAssistantState">UnpackAssistantState</a></span> 
...
<dd class="inherited">
  ...
  <span class="signature">→ <a href="https://api.flutter.dev/flutter/dart-async/Stream-class.html">Stream</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unpack_assistant/UnpackAssistantState">UnpackAssistantState</a></span>&gt;</span></span> 
...
<dd class="inherited">
  ...
  <span class="name"><a href="https://pub.dev/documentation/bloc/8.1.0/bloc/Bloc/add.html">add</a></span><span class="signature">(<wbr><span class="parameter" id="add-param-event"><span class="type-annotation"><a href="../unpack_assistant/UnpackAssistantEvent">UnpackAssistantEvent</a></span> <span class="parameter-name">event</span></span>)
...
<dd class="inherited">
  Reports an <code>error</code> which triggers <a href="../unpack_assistant/UnpackAssistantBloc/onError">onError</a> with an optional <a href="https://api.flutter.dev/flutter/dart-core/StackTrace-class.html">StackTrace</a>.
  <div class="features"><span class="feature">inherited</span></div>
...
processed, the <a href="https://pub.dev/documentation/bloc/8.1.0/bloc/Bloc-class.html">Bloc</a> will finish processing the pending <code>events</code>.
  ...
  <span class="name"><a href="https://pub.dev/documentation/bloc/8.1.0/bloc/Bloc/emit.html">emit</a></span><span class="signature">(<wbr><span class="parameter" id="emit-param-state"><span class="type-annotation"><a href="../unpack_assistant/UnpackAssistantState">UnpackAssistantState</a></span> <span class="parameter-name">state</span></span>)
    <span class="returntype parameter">→ void</span>
  </span>
...
There should only ever be one event handler per event type <code>E</code>.
  ...
  <span class="name"><a href="https://pub.dev/documentation/bloc/8.1.0/bloc/BlocBase/onChange.html">onChange</a></span><span class="signature">(<wbr><span class="parameter" id="onChange-param-change"><span class="type-annotation"><a href="https://pub.dev/documentation/bloc/8.1.0/bloc/Change-class.html">Change</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unpack_assistant/UnpackAssistantState">UnpackAssistantState</a></span>&gt;</span></span> <span class="parameter-name">change</span></span>)
    <span class="returntype parameter">→ void</span>
  </span>
...
<a href="https://pub.dev/documentation/bloc/8.1.0/bloc/BlocBase/onChange.html">onChange</a> is a great spot to add logging/analytics for a specific <code>cubit</code>.
  ...
  <span class="name"><a href="../unpack_assistant/UnpackAssistantBloc/onError">onError</a></span><span class="signature">(<wbr><span class="parameter" id="onError-param-error"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Object-class.html">Object</a></span> <span class="parameter-name">error</span>, </span><span class="parameter" id="onError-param-stackTrace"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/StackTrace-class.html">StackTrace</a></span> <span class="parameter-name">stackTrace</span></span>)
    <span class="returntype parameter">→ void</span>
  </span>
...
<dd>
  ...
  <span class="name"><a href="../unpack_assistant/UnpackAssistantBloc/onEvent">onEvent</a></span><span class="signature">(<wbr><span class="parameter" id="onEvent-param-event"><span class="type-annotation"><a href="../unpack_assistant/UnpackAssistantEvent">UnpackAssistantEvent</a></span> <span class="parameter-name">event</span></span>)
    <span class="returntype parameter">→ void</span>
  </span>
...
A great spot to add logging/analytics at the individual <a href="https://pub.dev/documentation/bloc/8.1.0/bloc/Bloc-class.html">Bloc</a> level.
  ...
  <span class="name"><a href="https://pub.dev/documentation/bloc/8.1.0/bloc/Bloc/onTransition.html">onTransition</a></span><span class="signature">(<wbr><span class="parameter" id="onTransition-param-transition"><span class="type-annotation"><a href="https://pub.dev/documentation/bloc/8.1.0/bloc/Transition-class.html">Transition</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../unpack_assistant/UnpackAssistantEvent">UnpackAssistantEvent</a></span>, <span class="type-parameter"><a href="../unpack_assistant/UnpackAssistantState">UnpackAssistantState</a></span>&gt;</span></span> <span class="parameter-name">transition</span></span>)
    <span class="returntype parameter">→ void</span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"><a href="../unpack_assistant/UnpackAssistantBloc#constructors">Constructors</a></li>
          <li><a href="../unpack_assistant/UnpackAssistantBloc/UnpackAssistantBloc.constructor">UnpackAssistantBloc</a></li>


        <li class="section-title inherited">
          <a href="../unpack_assistant/UnpackAssistantBloc#instance-properties">Properties</a>
        </li>
        ...
        <li class="section-title"><a href="../unpack_assistant/UnpackAssistantBloc#instance-methods">Methods</a></li>
          ...
          <li><a href="../unpack_assistant/UnpackAssistantBloc/onError">onError</a></li>
          <li><a href="../unpack_assistant/UnpackAssistantBloc/onEvent">onEvent</a></li>
        ...
        <li class="section-title inherited"><a href="../unpack_assistant/UnpackAssistantBloc#operators">Operators</a></li>
