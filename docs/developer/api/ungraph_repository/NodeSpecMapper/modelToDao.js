...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">modelToDao</span> static method 
...
<span class="returntype">NodeDao</span>
<span class="name ">modelToDao</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="modelToDao-param-model"><span class="type-annotation">NodeSpec</span> <span class="parameter-name">model</span>, </span></li>
<li><span class="parameter" id="modelToDao-param-db">[<span class="type-annotation">UngraphDatabase?</span> <span class="parameter-name">db</span>]</span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">static NodeDao modelToDao(NodeSpec model, [UngraphDatabase? db]) =&gt;
    NodeDao(modelToTable(model), db);</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">modelToDao static method</li>
</ol>
