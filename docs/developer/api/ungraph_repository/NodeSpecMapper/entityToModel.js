...
<span class="returntype">NodeSpec</span>
<span class="name ">entityToModel</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="entityToModel-param-data"><span class="type-annotation">NodeSpecData</span> <span class="parameter-name">data</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">static NodeSpec entityToModel(NodeSpecData data) =&gt; NodeSpec(
      id: data.id,
      slugged: data.slug,
      name: data.name,
