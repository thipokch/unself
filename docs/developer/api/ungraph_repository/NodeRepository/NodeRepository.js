...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-class">NodeRepository</span> class 
  ...
  <section class="summary offset-anchor" id="constructors">
    ...
    <dl class="constructor-summary-list">
        <dt id="NodeRepository" class="callable">
          <span class="name"><a href="../ungraph_repository/NodeRepository/NodeRepository.constructor">NodeRepository</a></span><span class="signature">(<span class="parameter" id="-param-spec"><span class="type-annotation">NodeSpec</span> <span class="parameter-name">spec</span>, </span><span class="parameter" id="-param-_dao"><span class="type-annotation">NodeDao</span> <span class="parameter-name">_dao</span></span>)</span>
        </dt>
        <dd>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_repository/NodeRepository/spec">spec</a></span>
  <span class="signature">→ NodeSpec</span> 
...
<dd>
  ...
  <span class="name"><a href="../ungraph_repository/NodeRepository/getAll">getAll</a></span><span class="signature">(<wbr>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter">Node</span>&gt;</span></span>&gt;</span></span>
  </span>
...
<dd class="inherited">
  ...
  <span class="name"><a href="../ungraph_repository/NodeRepository/put">put</a></span><span class="signature">(<wbr><span class="parameter" id="put-param-node"><span class="type-annotation">Node</span> <span class="parameter-name">node</span></span>)
    <span class="returntype parameter">→ <a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter">Node</span>&gt;</span></span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">NodeRepository class</li>
</ol>
