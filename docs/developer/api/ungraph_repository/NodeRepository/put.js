...
<span class="returntype"><a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter">Node</span>&gt;</span></span>
<span class="name ">put</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="put-param-node"><span class="type-annotation">Node</span> <span class="parameter-name">node</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Future&lt;Node&gt; put(Node node) =&gt;
    _dao.put(NodeMapper.modelToEntity(node)).then(NodeMapper.entityToModel);</code></pre>
</section>
