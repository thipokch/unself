...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-constructor">EdgeRepository</span> constructor 
    <a href="https://dart.dev/null-safety" class="feature feature-null-safety" title="Supports the null safety language feature.">Null safety</a>
</h1></div>

    <section class="multi-line-signature">
      const
      <span class="name ">EdgeRepository</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="-param-spec"><span class="type-annotation">EdgeSpec</span> <span class="parameter-name">spec</span>, </span></li>
<li><span class="parameter" id="-param-_dao"><span class="type-annotation">EdgeDao</span> <span class="parameter-name">_dao</span></span></li>
</ol>)
    </section>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">const EdgeRepository(this.spec, this._dao);</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">EdgeRepository const constructor</li>
</ol>
