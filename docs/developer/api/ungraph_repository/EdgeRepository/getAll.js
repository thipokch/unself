...
<span class="returntype"><a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter">Edge</span>&gt;</span></span>&gt;</span></span>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Future&lt;List&lt;Edge&gt;&gt; getAll() =&gt;
    _dao.getAll().then((list) =&gt; list.map(EdgeMapper.entityToModel).toList());</code></pre>
</section>
