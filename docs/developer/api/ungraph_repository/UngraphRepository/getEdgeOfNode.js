...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">getEdgeOfNode</span> method 
...
<span class="name ">getEdgeOfNode</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="getEdgeOfNode-param-slugs"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">slugs</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Future&lt;Iterable&lt;String&gt;&gt; getEdgeOfNode(String slugs) =&gt;
    _db.edgeSpecDao.getAllByNode(slugs);</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">getEdgeOfNode method</li>
</ol>
