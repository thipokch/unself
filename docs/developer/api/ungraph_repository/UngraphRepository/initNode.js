...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">initNode</span> method 
...
<span class="returntype"><a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="../../ungraph_repository/NodeRepository">NodeRepository</a></span>&gt;</span></span>
<span class="name ">initNode</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="initNode-param-specSlug"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/String-class.html">String</a></span> <span class="parameter-name">specSlug</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Future&lt;NodeRepository&gt; initNode(String specSlug) async {
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">initNode method</li>
</ol>
