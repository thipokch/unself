...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">registerNode</span> method 
...
<span class="returntype"><a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter">NodeSpecData</span>&gt;</span></span>
<span class="name ">registerNode</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="registerNode-param-spec"><span class="type-annotation">NodeSpec</span> <span class="parameter-name">spec</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Future&lt;NodeSpecData&gt; registerNode(NodeSpec spec) =&gt;
    _db.nodeSpecDao.put(NodeSpecMapper.modelToEntity(spec));</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">registerNode method</li>
</ol>
