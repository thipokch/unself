...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">registerEdge</span> method 
...
<span class="returntype"><a href="https://api.flutter.dev/flutter/dart-async/Future-class.html">Future</a><span class="signature">&lt;<wbr><span class="type-parameter">EdgeSpecData</span>&gt;</span></span>
<span class="name ">registerEdge</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="registerEdge-param-spec"><span class="type-annotation">EdgeSpec</span> <span class="parameter-name">spec</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">Future&lt;EdgeSpecData&gt; registerEdge(EdgeSpec spec) =&gt;
    _db.edgeSpecDao.put(EdgeSpecMapper.modelToEntity(spec));</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">registerEdge method</li>
</ol>
