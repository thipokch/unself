...
<span class="returntype">EdgeTable</span>
<span class="name ">modelToTable</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="modelToTable-param-model"><span class="type-annotation">EdgeSpec</span> <span class="parameter-name">model</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">static EdgeTable modelToTable(EdgeSpec model) =&gt; EdgeTable(
      model.id!,
      model.slug,
