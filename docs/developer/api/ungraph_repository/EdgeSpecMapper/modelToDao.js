...
<span class="returntype">EdgeDao</span>
<span class="name ">modelToDao</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="modelToDao-param-model"><span class="type-annotation">EdgeSpec</span> <span class="parameter-name">model</span>, </span></li>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">static EdgeDao modelToDao(EdgeSpec model, [UngraphDatabase? db]) =&gt;
    EdgeDao(modelToTable(model), db);</code></pre>
</section>
