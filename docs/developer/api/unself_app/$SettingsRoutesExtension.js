...
<div id="dartdoc-main-content" class="main-content">
    <div>
<h1><span class="kind-class">\$SettingsRoutesExtension</span> extension 
  ...
  <span class="name"><a href="../unself_app/\$SettingsRoutesExtension/location">location</a></span>
...
<dd>
  ...
  <span class="name"><a href="../unself_app/\$SettingsRoutesExtension/go">go</a></span><span class="signature">(<wbr><span class="parameter" id="go-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<dd>
  ...
  <span class="name"><a href="../unself_app/\$SettingsRoutesExtension/push">push</a></span><span class="signature">(<wbr><span class="parameter" id="push-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
    <span class="returntype parameter">→ void</span>
  </span>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">\$SettingsRoutesExtension extension</li>
</ol>
...
<div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"> <a href="../unself_app/\$SettingsRoutesExtension#instance-properties">Properties</a></li>
          <li><a href="../unself_app/\$SettingsRoutesExtension/location">location</a></li>

        <li class="section-title"><a href="../unself_app/\$SettingsRoutesExtension#instance-methods">Methods</a></li>
          <li><a href="../unself_app/\$SettingsRoutesExtension/go">go</a></li>
          <li><a href="../unself_app/\$SettingsRoutesExtension/push">push</a></li>
