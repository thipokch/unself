...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-top-level-property">\$appRoutes</span> top-level property 
...
<section class="multi-line-signature">
  ...
  <span class="returntype"><a href="https://api.flutter.dev/flutter/dart-core/List-class.html">List</a><span class="signature">&lt;<wbr><span class="type-parameter"><a href="https://pub.dev/documentation/go_router/6.0.1/go_router/GoRoute-class.html">GoRoute</a></span>&gt;</span></span>
  <span class="name ">\$appRoutes</span>
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">List&lt;GoRoute&gt; get \$appRoutes =&gt; [
      \$unpackRoutes,
      \$settingsRoutes,
    ];</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">\$appRoutes property</li>
</ol>
