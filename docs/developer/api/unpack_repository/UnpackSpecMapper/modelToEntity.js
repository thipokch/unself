...
<span class="returntype">UnpackSpecCompanion</span>
<span class="name ">modelToEntity</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="modelToEntity-param-model"><span class="type-annotation">UnpackSpec</span> <span class="parameter-name">model</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">static UnpackSpecCompanion modelToEntity(UnpackSpec model) =&gt;
