...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">getStateById</span> method 
...
Future&lt;UnpackState&gt; getStateById(String id) =&gt;
    _db.unpackStateDao.get(id).then(UnpackStateMapper.entityToModel);</code></pre>
</section>
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">getStateById method</li>
</ol>
