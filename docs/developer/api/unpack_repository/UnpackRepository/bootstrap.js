...
export default function RawHtml() {
  ...
  <div id="dartdoc-main-content" class="main-content">
      <div>
<h1><span class="kind-method">bootstrap</span> static method 
...
<span class="name ">bootstrap</span>(<wbr><ol class="parameter-list"><li><span class="parameter" id="bootstrap-param-db"><span class="type-annotation">UnDatabase</span> <span class="parameter-name">db</span>, </span></li>
<li><span class="parameter" id="bootstrap-param-specs"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/dart-core/Iterable-class.html">Iterable</a><span class="signature">&lt;<wbr><span class="type-parameter">UnpackSpec</span>&gt;</span></span> <span class="parameter-name">specs</span></span></li>
</ol>)
...
<section class="summary source-code" id="source">
  ...
  <pre class="language-dart"><code class="language-dart">static Future&lt;void&gt; bootstrap(
  UnDatabase db,
...
<ol class="breadcrumbs gt-separated dark hidden-l" id="sidebar-nav">
  ...
  <li class="self-crumb">bootstrap static method</li>
</ol>
