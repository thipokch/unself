...
<h1><span class="kind-class">\$LicenseListRouteExtension</span> extension 
  ...
  <span class="name"><a href="../un_app/\$LicenseListRouteExtension/location">location</a></span>
...
<dd>
  ...
  <span class="name"><a href="../un_app/\$LicenseListRouteExtension/go">go</a></span><span class="signature">(<wbr><span class="parameter" id="go-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
...
<dd>
  ...
  <span class="name"><a href="../un_app/\$LicenseListRouteExtension/push">push</a></span><span class="signature">(<wbr><span class="parameter" id="push-param-context"><span class="type-annotation"><a href="https://api.flutter.dev/flutter/widgets/BuildContext-class.html">BuildContext</a></span> <span class="parameter-name">context</span></span>)
    <span class="returntype parameter">→ void</span>
  </span>
...
<div id="dartdoc-sidebar-right" class="sidebar sidebar-offcanvas-right">
    <ol>
        ...
        <li class="section-title"> <a href="../un_app/\$LicenseListRouteExtension#instance-properties">Properties</a></li>
          <li><a href="../un_app/\$LicenseListRouteExtension/location">location</a></li>

        <li class="section-title"><a href="../un_app/\$LicenseListRouteExtension#instance-methods">Methods</a></li>
          <li><a href="../un_app/\$LicenseListRouteExtension/go">go</a></li>
          <li><a href="../un_app/\$LicenseListRouteExtension/push">push</a></li>
